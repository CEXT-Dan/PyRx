...
public:
    ...
    AcGePoint3d             GetLeader1Point() const;
    void                    SetLeader1Point(const AcGePoint3d& val) const;
    AcGePoint3d             GetLeader2Point() const;
    void                    SetLeader2Point(const AcGePoint3d& val) const;
    bool                    GetIsPartial() const;
    void                    SetIsPartial(bool val) const;
    double                  GetArcStartParam() const;
    void                    SetArcStartParam(double val) const;
    double                  GetArcEndParam() const;
    void                    SetArcEndParam(double val) const;
    bool                    GetHasLeader() const;
    void                    SetHasLeader(bool val) const;
