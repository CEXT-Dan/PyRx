...
public:
    ...
    void                    setCurrentLayout1(const std::string& newname) const;
    void                    setCurrentLayout2(const std::string& newname, PyDbDatabase& pDb) const;
    void                    setCurrentLayoutId(const PyDbObjectId& layoutId) const;
    std::string             getActiveLayoutName1(bool allowModel) const;
    std::string             getActiveLayoutName2(bool allowModel, PyDbDatabase& pDb) const;
    PyDbObjectId            getActiveLayoutBTRId1() const;
    PyDbObjectId            getActiveLayoutBTRId2(const PyDbDatabase& pDb) const;
    PyDbObjectId            findLayoutNamed1(const std::string& name) const;
    PyDbObjectId            findLayoutNamed2(const std::string& name, const PyDbDatabase& pDb) const;
    bool                    layoutExists1(const std::string& name) const;
    bool                    layoutExists2(const std::string& name, const PyDbDatabase& pDb) const;
    void                    copyLayout1(const std::string& copyname, const std::string& newname) const;
    void                    copyLayout2(const std::string& copyname, const std::string& newname, const PyDbDatabase& pDb) const;
    void                    deleteLayout1(const std::string& delname) const;
    void                    deleteLayout2(const std::string& delname, PyDbDatabase& pDb) const;
    boost::python::tuple    createLayout1(const std::string& newname) const;
    boost::python::tuple    createLayout2(const std::string& newname, PyDbDatabase& pDb) const;
    void                    renameLayout1(const std::string& oldname, const std::string& newname) const;
    void                    renameLayout2(const std::string& oldname, const std::string& newname, PyDbDatabase& pDb) const;
    void                    cloneLayout1(PyDbLayout& pLBTR, const std::string& newname) const;
    void                    cloneLayout2(PyDbLayout& pLBTR, const std::string& newname, int newTabOrder, PyDbDatabase& pDb) const;
    PyDbObjectId            getNonRectVPIdFromClipId(PyDbObjectId& clipId) const;
    bool                    isVpnumClipped1(int index) const;
    bool                    isVpnumClipped2(int index, const PyDbDatabase& pDb) const;
    int                     countLayouts1() const;
    int                     countLayouts2(PyDbDatabase& pDb) const;

    boost::python::dict     getLayouts1() const;
    boost::python::dict     getLayouts2(PyDbDatabase& pDb) const;
