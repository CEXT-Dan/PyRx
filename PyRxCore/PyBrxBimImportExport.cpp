...
void makePyBrxIfcImportOptionsWrapper()
{
    ...
    class_<PyBrxIfcImportOptions>("IfcImportOptions")
        ...
        .def("importIfcFile", &PyBrxIfcImportOptions::importIfcFile2, DS.SARGS({ "db: PyDb.Database", "filename: str", "options: PyBrxIfc.IfcImportOptions=None" })).staticmethod("importIfcFile")
