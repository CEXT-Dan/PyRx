...
public:
    ...
    void                transformBy(const AcGeMatrix2d& xfm) const;
    void                translateBy(const AcGeVector2d& translateVec) const;
    void                rotateBy1(double angle) const;
    void                rotateBy2(double angle, const AcGePoint2d& origin) const;
    void                mirror(const PyGeLine2d& plane) const;
    void                scaleBy1(double scaleFactor) const;
    void                scaleBy2(double scaleFactor, const AcGePoint2d& wrtPoint) const;
