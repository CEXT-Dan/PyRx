...
public:
    ...
    void                setBlockTableRecordId(int row, int col, const PyDbObjectId& val, bool autoScale) const;
    ...
    std::string         blockAttributeValue(int row, int col, const PyDbObjectId& val) const;
    void                setBlockAttributeValue(int row, int col, const PyDbObjectId& id, const std::string& val) const;
