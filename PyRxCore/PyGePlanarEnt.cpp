...
void makePyGePlanarEntWrapper()
{
    ...
    class_<PyGePlanarEnt, bases<PyGeSurface>>("PlanarEnt", boost::python::no_init)
        ...
        .def("intersectWith", &PyGePlanarEnt::intersectWith2, DS.ARGS({ "other: PyGe.LinearEnt3d", "tol: PyGe.Tol=None" }))
        .def("closestPointToLinearEnt", &PyGePlanarEnt::closestPointToLinearEnt1)
        .def("closestPointToLinearEnt", &PyGePlanarEnt::closestPointToLinearEnt2, DS.ARGS({ "other: PyGe.LinearEnt3d", "tol: PyGe.Tol=None" }))
        .def("closestPointToPlanarEnt", &PyGePlanarEnt::closestPointToPlanarEnt1)
        .def("closestPointToPlanarEnt", &PyGePlanarEnt::closestPointToPlanarEnt2, DS.ARGS({ "other: PyGe.PlanarEnt", "tol: PyGe.Tol=None" }))
        ...
        .def("isParallelTo", &PyGePlanarEnt::isParallelTo4, DS.ARGS({ "other: PyGe.LinearEnt3d|PyGe.PlanarEnt", "tol: PyGe.Tol=None" }))
        ...
        .def("isPerpendicularTo", &PyGePlanarEnt::isPerpendicularTo4, DS.ARGS({ "other: PyGe.LinearEnt3d|PyGe.PlanarEnt", "tol: PyGe.Tol=None" }))
        .def("isCoplanarTo", &PyGePlanarEnt::isCoplanarTo1)
        .def("isCoplanarTo", &PyGePlanarEnt::isCoplanarTo2, DS.ARGS({ "other: PyGe.PlanarEnt", "tol: PyGe.Tol=None" }))
