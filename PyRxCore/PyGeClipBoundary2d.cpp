...
void makePyGeClipBoundary2dWrapper()
{
    ...
    class_<PyGeClipBoundary2d, bases<PyGeEntity2d>>("ClipBoundary2d")
        ...
        .def("clipPolygon", &PyGeClipBoundary2d::clipPolygon, DS.ARGS({ "rawVertices: list[PyGe.Point2d]" }))
        .def("clipPolyline", &PyGeClipBoundary2d::clipPolyline, DS.ARGS({ "rawVertices: list[PyGe.Point2d]" }))
