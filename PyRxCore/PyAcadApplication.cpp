...
void makePyAcadBlockWrapper()
{
    ...
    class_<PyAcadBlock, bases<PyAcadObject>>("AcadBlock", boost::python::no_init)
        ...
        .def("add3DMesh", &PyAcadBlock::add3DMesh, DS.ARGS({ "M:int","N:int","points:Iterable[PyGe.Point3d]" }))
        .def("add3DPoly", &PyAcadBlock::add3DPoly, DS.ARGS({ "points:Iterable[PyGe.Point3d]" }))
        ...
        .def("addLeader", &PyAcadBlock::addLeader, DS.ARGS({ "points:Iterable[PyGe.Point3d]","annotation:PyAx.AcadEntity","leaderType:PyAx.AcLeaderType" }))
        ...
        .def("addLightWeightPolyline", &PyAcadBlock::addLightWeightPolyline, DS.ARGS({ "points:Iterable[PyGe.Point2d]" }))
        .def("addPolyline", &PyAcadBlock::addPolyline, DS.ARGS({ "points:Iterable[PyGe.Point3d]" }))
        ...
        .def("addSpline", &PyAcadBlock::addSpline, DS.ARGS({ "points:Iterable[PyGe.Point3d]", "startTangent:PyGe.Vector3d","endTangent:PyGe.Vector3d" }))
        ...
        .def("addPolyfaceMesh", &PyAcadBlock::addPolyfaceMesh, DS.ARGS({ "points:Iterable[PyGe.Point3d]", "faces:Iterable[int]" }))
        .def("addMLine", &PyAcadBlock::addMLine, DS.ARGS({ "points:Iterable[PyGe.Point3d]" }))
        ...
        .def("addMLeader", &PyAcadBlock::addMLeader, DS.ARGS({ "points:Iterable[PyGe.Point3d]" }))
