...
void makePyAcadGroupWrapper()
{
    ...
    class_<PyAcadGroup, bases<PyAcadObject>>("AcadGroup", boost::python::no_init)
        ...
        .def("appendItems", &PyAcadGroup::appendItems, DS.ARGS({ "val:Collection[PyAx.AcadEntity]" }))
        .def("removeItems", &PyAcadGroup::removeItems, DS.ARGS({ "val:Collection[PyAx.AcadEntity]" }))
...
void makePyAcadSelectionSetWrapper()
{
    ...
    class_<PyAcadSelectionSet>("AcadSelectionSet", boost::python::no_init)
        ...
        .def("selectAll", &PyAcadSelectionSet::selectAll2, DS.ARGS({ "filter:Collection[tuple[int,Any]]=None" }))
        .def("selectOnScreen", &PyAcadSelectionSet::selectOnScreen1)
        .def("selectOnScreen", &PyAcadSelectionSet::selectOnScreen2, DS.ARGS({ "filter:Collection[tuple[int,Any]]=None" }))
        .def("selectWindow", &PyAcadSelectionSet::selectWindow1)
        .def("selectWindow", &PyAcadSelectionSet::selectWindow2, DS.ARGS({ "pt1:PyGe.Point3d", "pt2:PyGe.Point3d", "filter:Collection[tuple[int,Any]]=None" }))
        .def("selectCrossing", &PyAcadSelectionSet::selectCrossing1)
        .def("selectCrossing", &PyAcadSelectionSet::selectCrossing2, DS.ARGS({ "pt1:PyGe.Point3d", "pt2:PyGe.Point3d", "filter:Collection[tuple[int,Any]]=None" }))
        .def("selectFence", &PyAcadSelectionSet::selectFence1)
        .def("selectFence", &PyAcadSelectionSet::selectFence2, DS.ARGS({ "pts:Collection[PyGe.Point3d]", "filter:Collection[tuple[int,Any]]=None" }))
        .def("selectWindowPolygon", &PyAcadSelectionSet::selectWindowPolygon1)
        .def("selectWindowPolygon", &PyAcadSelectionSet::selectWindowPolygon2, DS.ARGS({ "pts:Collection[PyGe.Point3d]", "filter:Collection[tuple[int,Any]]=None" }))
        .def("selectCrossingPolygon", &PyAcadSelectionSet::selectCrossingPolygon1)
        .def("selectCrossingPolygon", &PyAcadSelectionSet::selectCrossingPolygon2, DS.ARGS({ "pts:Collection[PyGe.Point3d]", "filter:Collection[tuple[int,Any]]=None" }))
        .def("selectLast", &PyAcadSelectionSet::selectLast, DS.ARGS())
        .def("selectAtPoint", &PyAcadSelectionSet::selectAtPoint1)
        .def("selectAtPoint", &PyAcadSelectionSet::selectAtPoint2, DS.ARGS({ "pt1:PyGe.Point3d", "filter:Collection[tuple[int,Any]]=None" }))
