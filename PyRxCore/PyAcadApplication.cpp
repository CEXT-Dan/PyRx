...
void makePyAcadBlockWrapper()
{
    ...
    class_<PyAcadBlock, bases<PyAcadObject>>("AcadBlock", boost::python::no_init)
        ...
        .def("addArc", &PyAcadBlock::addArc, DS.ARGS({ "center:PyGe.Point3d","radius:float","startAngle:float","endAngle:float" }))
        ...
        .def("addCircle", &PyAcadBlock::addCircle, DS.ARGS({ "center:PyGe.Point3d","radius:float" }))
        .def("addCone", &PyAcadBlock::addCone, DS.ARGS({ "center:PyGe.Point3d","baseRadius:float","height:float" }))
        .def("addCylinder", &PyAcadBlock::addCylinder, DS.ARGS({ "center:PyGe.Point3d","radius:float","height:float" }))
...
void makePyAcadUtilityWrapper()
{
    ...
    class_<PyAcadUtility>("AcadUtility", boost::python::no_init)
        ...
        .def("isRemoteFile", &PyAcadUtility::isRemoteFile, DS.ARGS({ "localFile:str" }))
