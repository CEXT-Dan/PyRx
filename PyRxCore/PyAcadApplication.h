...
public:
    ...
    //PyAcadBlockReference    import(const std::string& path, const AcGePoint3d& InsertionPoint, double ScaleFactor);
    //void                       xxport(const std::string& fileName, const std::string& extension, const PyAcadSelectionSet& sset);
