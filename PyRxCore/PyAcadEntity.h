...
public:
    ...
    void                    setLeaderLineColor(const PyAcadAcCmColor& val);
    std::string             leaderLinetype() const;
    void                    setLeaderLinetype(const std::string& val);
    ...
    void                    setContentBlockName(const std::string& val);
    ...
    void                    setTextStyleName(const std::string& val);
    ...
    void                    setBlockAttributeValue(const PyDbObjectId& id, const std::string& val);
