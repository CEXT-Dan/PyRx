...
public:
    ...
    void            transformBy(const AcGeMatrix3d& xfm) const;
    void            translateBy(const AcGeVector3d& translateVec) const;
    void            rotateBy1(double angle, const AcGeVector3d& vec) const;
    void            rotateBy2(double angle, const AcGeVector3d& vec, const AcGePoint3d& wrtPoint) const;
    void            mirror(const PyGePlane& plane) const;
    void            scaleBy1(double scaleFactor) const;
    void            scaleBy2(double scaleFactor, const AcGePoint3d& wrtPoint) const;
