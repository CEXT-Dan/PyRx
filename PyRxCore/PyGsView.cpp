...
void makePyGsViewWrapper()
{
    ...
    class_<PyGsView>("GsView", boost::python::no_init)
        ...
        .def("setView", &PyGsView::setView2, DS.ARGS({ "pos: PyGe.Point3d", "target: PyGe.Point3d", "upVector: PyGe.Vector3d","fWidth: float","fHeight: float"," PyGs.ViewProjection = PyGs.ViewProjection.kParallel" }))
