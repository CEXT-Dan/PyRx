...
void makePyAcadTableWrapper()
{
    ...
    class_<PyAcadTable, bases<PyAcadEntity>>("AcadTable", boost::python::no_init)
        ...
        .def("setRowHeight", &PyAcadTable::setRowHeight1)
        .def("setRowHeight", &PyAcadTable::setRowHeight2, DS.OVRL(setRowHeightOverloads))
        ...
        .def("mergeCells", &PyAcadTable::mergeCells, DS.ARGS({ "minRow:int","maxRow:int", "minCol:int","maxCol:int" }))
        ...
        .def("select", &PyAcadTable::select, DS.ARGS({ "wpt:PyGe.Point3d","wvwVec:PyGe.Vector3d","wvwxVec:PyGe.Vector3d","wxaper:float" ,"wyaper:float" ,"allowOutside:bool" }))
        ...
        .def("customData", &PyAcadTable::customData, DS.ARGS({ "row:int","col:int","key:str" }))
        ...
        .def("columnName", &PyAcadTable::columnName, DS.ARGS({ "col:int" }))
