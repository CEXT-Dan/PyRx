...
void makePyGeEntity3dWrapper()
{
    ...
    class_<PyGeEntity3d>("Entity3d", boost::python::no_init)
        ...
        .def("isEqualTo", &PyGeEntity3d::isEqualTo2, DS.ARGS({ "val : PyGe.Entity3d","tol : PyGe.Tol=None" }, 12046))
        ...
        .def("isOn", &PyGeEntity3d::isOn2, DS.ARGS({ "pt : PyGe.Point3d","tol : PyGe.Tol=default"  }, 12048))
