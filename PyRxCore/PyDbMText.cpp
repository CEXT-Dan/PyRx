...
void makePyDbMTextWrapper()
{
    ...
    class_<PyDbMText, bases<PyDbEntity>>("MText")
        ...
        .def("setLocation", &PyDbMText::setLocation, DS.ARGS({ "point : PyGe.Point3d" }, 6916))
        .def("normal", &PyDbMText::normal, DS.ARGS(6887))
        .def("setNormal", &PyDbMText::setNormal, DS.ARGS({ "vector : PyGe.Vector3d" }, 6917))
        .def("direction", &PyDbMText::direction, DS.ARGS(6859))
        .def("setDirection", &PyDbMText::setDirection, DS.ARGS({ "vector : PyGe.Vector3d" }, 6909))
        .def("rotation", &PyDbMText::rotation, DS.ARGS(6893))
        .def("setRotation", &PyDbMText::setRotation, DS.ARGS({ "angle : float" }, 6918))
        .def("width", &PyDbMText::width, DS.ARGS(6939))
        .def("setWidth", &PyDbMText::setWidth, DS.ARGS({ "width : float" }, 6925))
        ...
        .def("setTextStyle", &PyDbMText::setTextStyle, DS.ARGS({ "styleId : PyDb.ObjectId" }, 6922))
        .def("textHeight", &PyDbMText::textHeight, DS.ARGS(6932))
        .def("setTextHeight", &PyDbMText::setTextHeight, DS.ARGS({ "height : float" }, 6921))
        .def("attachment", &PyDbMText::attachment, DS.ARGS(6847))
        .def("setAttachment", &PyDbMText::setAttachment, DS.ARGS({ "attachment_point : PyDb.MTextAttachmentPoint" }, 6894))
        .def("setAttachmentMovingLocation", &PyDbMText::setAttachmentMovingLocation, DS.ARGS({ "attachment_point : PyDb.MTextAttachmentPoint" }, 6895))
        .def("flowDirection", &PyDbMText::flowDirection, DS.ARGS(6861))
        .def("setFlowDirection", &PyDbMText::setFlowDirection, DS.ARGS({ "flowDirection : PyDb.MTextFlowDirection" }, 6912))
        .def("contents", &PyDbMText::contents, DS.ARGS(6854))
        .def("setContents", &PyDbMText::setContents, DS.ARGS({ "text : str" }, 6907))
        .def("contentsRTF", &PyDbMText::contentsRTF, DS.ARGS(6855))
        .def("setContentsRTF", &PyDbMText::setContentsRTF, DS.ARGS({ "rtfText : str" }, 6908))
        ...
        .def("hitTest", &PyDbMText::hitTest, DS.ARGS({ "hit_point : PyGe.Point3d" }, 6880))
        .def("setLineSpacingStyle", &PyDbMText::setLineSpacingStyle, DS.ARGS({ "style : PyDb.LineSpacingStyle" }, 6915))
        .def("lineSpacingStyle", &PyDbMText::lineSpacingStyle, DS.ARGS(6884))
        .def("setLineSpacingFactor", &PyDbMText::setLineSpacingFactor, DS.ARGS({ "factor : float" }, 6914))
        ...
        .def("setBackgroundFill", &PyDbMText::setBackgroundFill, DS.ARGS({ "enabled : bool" }, 6896))
        .def("getBackgroundFillColor", &PyDbMText::getBackgroundFillColor, DS.ARGS(6864))
        .def("setBackgroundFillColor", &PyDbMText::setBackgroundFillColor, DS.ARGS({ "color : PyDb.Color" }, 6897))
        .def("getBackgroundScaleFactor", &PyDbMText::getBackgroundScaleFactor, DS.ARGS(6865))
        .def("setBackgroundScaleFactor", &PyDbMText::setBackgroundScaleFactor, DS.ARGS({ "scale : float" }, 6898))
        .def("getBackgroundTransparency", &PyDbMText::getBackgroundTransparency, DS.ARGS(6866))
        .def("setBackgroundTransparency", &PyDbMText::setBackgroundTransparency, DS.ARGS({ "transp : PyDb.Transparency" }, 6899))
        .def("useBackgroundColorOn", &PyDbMText::useBackgroundColorOn, DS.ARGS(6937))
        .def("setUseBackgroundColor", &PyDbMText::setUseBackgroundColor, DS.ARGS({ "enabled : bool" }, 6923))
        ...
        .def("setColumnType", &PyDbMText::setColumnType, DS.ARGS({ "columnType : PyDb.MTextColumnType" }, 6905))
        .def("getColumnAutoHeight", &PyDbMText::getColumnAutoHeight, DS.ARGS(6869))
        .def("setColumnAutoHeight", &PyDbMText::setColumnAutoHeight, DS.ARGS({ "auto : bool" }, 6900))
        .def("getColumnCount", &PyDbMText::getColumnCount, DS.ARGS(6900))
        .def("setColumnCount", &PyDbMText::setColumnCount, DS.ARGS({ "count : int" }, 6901))
        .def("getColumnWidth", &PyDbMText::getColumnWidth, DS.ARGS(6875))
        .def("setColumnWidth", &PyDbMText::setColumnWidth, DS.ARGS({ "width : float" }, 6906))
        .def("getColumnGutterWidth", &PyDbMText::getColumnGutterWidth, DS.ARGS(6872))
        .def("setColumnGutterWidth", &PyDbMText::setColumnGutterWidth, DS.ARGS({ "width : float" }, 6903))
        .def("getColumnFlowReversed", &PyDbMText::getColumnFlowReversed, DS.ARGS(6871))
        .def("setColumnFlowReversed", &PyDbMText::setColumnFlowReversed, DS.ARGS({ "reversed : bool" }, 6902))
        .def("getColumnHeight", &PyDbMText::getColumnHeight, DS.ARGS({ "index : int" }, 6873))
        .def("setColumnHeight", &PyDbMText::setColumnHeight, DS.ARGS({ "index : int", "height : float" }, 6904))
        .def("convertFieldToText", &PyDbMText::convertFieldToText, DS.ARGS(6856))
        .def("height", &PyDbMText::height, DS.ARGS(6878))
        .def("setHeight", &PyDbMText::setHeight, DS.ARGS({ "height : float" }, 6913))
...
void makePyDbTextWrapper()
{
    ...
    class_<PyDbText, bases<PyDbEntity>>("Text")
        .def(init<>())
        .def(init<const AcGePoint3d&, const std::string&>())
        .def(init<const AcGePoint3d&, const std::string&, PyDbObjectId&, double, double>())
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode, bool>(DS.CTOR(ctords)))
        .def("position", &PyDbText::position, DS.ARGS(9744))
        .def("setPosition", &PyDbText::setPosition, DS.ARGS({ "point : PyGe.Point3d" }, 9754))
        .def("alignmentPoint", &PyDbText::alignmentPoint, DS.ARGS(9727))
        .def("setAlignmentPoint", &PyDbText::setAlignmentPoint, DS.ARGS({ "alignmentPoint : PyGe.Point3d" }, 9747))
        .def("isDefaultAlignment", &PyDbText::isDefaultAlignment, DS.ARGS(9735))
        .def("normal", &PyDbText::normal, DS.ARGS(9742))
        .def("setNormal", &PyDbText::setNormal, DS.ARGS({ "normal : PyGe.Vector3d" }, 9752))
        .def("direction", &PyDbText::direction, DS.ARGS(6859))
        .def("thickness", &PyDbText::thickness, DS.ARGS(9765))
        .def("setThickness", &PyDbText::setThickness, DS.ARGS({ "thickness : float" }, 9758))
        .def("oblique", &PyDbText::oblique, DS.ARGS(9743))
        .def("setOblique", &PyDbText::setOblique, DS.ARGS({ "angle : float" }, 9753))
        .def("rotation", &PyDbText::rotation, DS.ARGS(9746))
        .def("setRotation", &PyDbText::setRotation, DS.ARGS({ "rotation : float" }, 9755))
        .def("height", &PyDbText::height, DS.ARGS(9732))
        .def("setHeight", &PyDbText::setHeight, DS.ARGS({ "height : float" }, 9749))
        .def("widthFactor", &PyDbText::widthFactor, DS.ARGS(9767))
        .def("setWidthFactor", &PyDbText::setWidthFactor, DS.ARGS({ "factor : float" }, 9760))
        .def("textString", &PyDbText::textString, DS.ARGS(9762))
        .def("setTextString", &PyDbText::setTextString, DS.ARGS({ "text : str" }, 9756))
        .def("textStyle", &PyDbText::textStyle, DS.ARGS(9764))
        .def("setTextStyle", &PyDbText::setTextStyle, DS.ARGS({ "styleId : PyDb.ObjectId" }, 9757))
        .def("isMirroredInX", &PyDbText::isMirroredInX, DS.ARGS(9736))
        .def("mirrorInX", &PyDbText::mirrorInX, DS.ARGS({ "mirrorInX : bool" }, 9740))
        .def("isMirroredInY", &PyDbText::isMirroredInY, DS.ARGS(9737))
        .def("mirrorInY", &PyDbText::mirrorInY, DS.ARGS({ "mirrorInY : bool" }, 9741))
        .def("horizontalMode", &PyDbText::horizontalMode, DS.ARGS(9734))
        .def("setHorizontalMode", &PyDbText::setHorizontalMode, DS.ARGS({ "mode : PyDb.TextHorzMode" }, 9750))
        .def("verticalMode", &PyDbText::verticalMode, DS.ARGS(9766))
        .def("setVerticalMode", &PyDbText::setVerticalMode, DS.ARGS({ "mode : PyDb.TextVertMode" }, 9759))
        .def("correctSpelling", &PyDbText::correctSpelling, DS.ARGS(9729))
        .def("adjustAlignment", &PyDbText::adjustAlignment, DS.ARGS({ "database : PyDb.Database" }, 9726))
        .def("convertFieldToText", &PyDbText::convertFieldToText, DS.ARGS(9728))
        .def("hitTest", &PyDbText::hitTest, DS.ARGS({ "hitTest : PyGe.Point3d" }, 9733))
        .def("getBoundingPoints", &PyDbText::getBoundingPoints, DS.ARGS(9730))
        .def("justification", &PyDbText::justification, DS.ARGS(9739))
        .def("setJustification", &PyDbText::setJustification, DS.ARGS({ "align : PyDb.TextAlignment" }, 9751))
...
void makePyDbAttributeDefinitionWrapper()
{
    ...
    class_<PyDbAttributeDefinition, bases<PyDbText>>("AttributeDefinition")
        ...
        .def("setPrompt", &PyDbAttributeDefinition::setPrompt, DS.ARGS({ "text : str" }, 2404))
        .def("tag", &PyDbAttributeDefinition::tag, DS.ARGS(2408))
        .def("setTag", &PyDbAttributeDefinition::setTag, DS.ARGS({ "value : str" }, 2405))
        .def("isInvisible", &PyDbAttributeDefinition::isInvisible, DS.ARGS(2390))
        .def("setInvisible", &PyDbAttributeDefinition::setInvisible, DS.ARGS({ "flag : bool" }, 2399))
        .def("isConstant", &PyDbAttributeDefinition::isConstant, DS.ARGS(2389))
        .def("setConstant", &PyDbAttributeDefinition::setConstant, DS.ARGS({ "flag : bool" }, 2397))
        .def("isVerifiable", &PyDbAttributeDefinition::isVerifiable, DS.ARGS(2393))
        .def("setVerifiable", &PyDbAttributeDefinition::setVerifiable, DS.ARGS({ "flag : bool" }, 2406))
        .def("isPreset", &PyDbAttributeDefinition::isPreset, DS.ARGS(2392))
        .def("setPreset", &PyDbAttributeDefinition::setPreset, DS.ARGS({ "flag : bool" }, 2403))
        .def("fieldLength", &PyDbAttributeDefinition::fieldLength, DS.ARGS(2386))
        .def("setFieldLength", &PyDbAttributeDefinition::setFieldLength, DS.ARGS({ "length : int" }, 2398))
        .def("adjustAlignment", &PyDbAttributeDefinition::adjustAlignment, DS.ARGS({ "database : PyDb.Database" }, 2384))
        .def("lockPositionInBlock", &PyDbAttributeDefinition::lockPositionInBlock, DS.ARGS(2394))
        .def("setLockPositionInBlock", &PyDbAttributeDefinition::setLockPositionInBlock, DS.ARGS({ "flag : bool" }, 2400))
        .def("isMTextAttributeDefinition", &PyDbAttributeDefinition::isMTextAttributeDefinition, DS.ARGS(2391))
        .def("convertIntoMTextAttributeDefinition", &PyDbAttributeDefinition::convertIntoMTextAttributeDefinition, DS.ARGS({ "flag : bool" }, 2385))
        ...
        .def("setMTextAttributeDefinition", &PyDbAttributeDefinition::setMTextAttributeDefinition, DS.ARGS({ "mtext : PyDb.MText" }, 2401))
...
#elif defined(_GRXTARGET270) || defined(_ZRXTARGET270)  
...
void makePyDbAttributeWrapper()
{
    ...
    class_<PyDbAttribute, bases<PyDbText>>("AttributeReference")
        ...
        .def("setTag", &PyDbAttribute::setTag, DS.ARGS({ "value : str" }, 2430))
        .def("isInvisible", &PyDbAttribute::isInvisible, DS.ARGS(2418))
        .def("setInvisible", &PyDbAttribute::setInvisible, DS.ARGS({ "flag : bool" }, 2426))
        ...
        .def("setFieldLength", &PyDbAttribute::setFieldLength, DS.ARGS({ "length : int" }, 2425))
        ...
        .def("setLockPositionInBlock", &PyDbAttribute::setLockPositionInBlock, DS.ARGS({ "flag : bool" }, 2427))
        ...
        .def("setMTextAttribute", &PyDbAttribute::setMTextAttribute, DS.ARGS({ "mtext : PyDb.MText" }, 2428))
        .def("convertIntoMTextAttribute", &PyDbAttribute::convertIntoMTextAttribute, DS.ARGS({ "flag : bool" }, 2413))
