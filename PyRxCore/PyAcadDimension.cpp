...
void makePyAcadDimAngularWrapper()
{
    ...
    class_<PyAcadDimAngular, bases<PyAcadDimension>>("AcadDimAngular", boost::python::no_init)
        .def("extLine1StartPoint", &PyAcadDimAngular::setExtLine1StartPoint, DS.ARGS())
        .def("setExtLine1StartPoint", &PyAcadDimAngular::setExtLine1StartPoint, DS.ARGS({ "val: PyGe.GePoint3d" }))
        .def("extLine1EndPoint", &PyAcadDimAngular::extLine1EndPoint, DS.ARGS())
        .def("setExtLine1EndPoint", &PyAcadDimAngular::setExtLine1EndPoint, DS.ARGS({ "val: PyGe.GePoint3d" }))
        .def("extLine2StartPoint", &PyAcadDimAngular::extLine2StartPoint, DS.ARGS())
        .def("setExtLine2StartPoint", &PyAcadDimAngular::setExtLine2StartPoint, DS.ARGS({ "val: PyGe.GePoint3d" }))
        .def("extLine2EndPoint", &PyAcadDimAngular::extLine2EndPoint, DS.ARGS())
        .def("setExtLine2EndPoint", &PyAcadDimAngular::setExtLine2EndPoint, DS.ARGS({ "val: PyGe.GePoint3d" }))
        .def("angleFormat", &PyAcadDimAngular::angleFormat, DS.ARGS())
        .def("setAngleFormat", &PyAcadDimAngular::setAngleFormat, DS.ARGS({ "val: PyAx.AcAngleUnits" }))
        .def("dimensionLineColor", &PyAcadDimAngular::dimensionLineColor, DS.ARGS())
        .def("setDimensionLineColor", &PyAcadDimAngular::setDimensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("extensionLineColor", &PyAcadDimAngular::extensionLineColor, DS.ARGS())
        .def("setExtensionLineColor", &PyAcadDimAngular::setExtensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("extensionLineExtend", &PyAcadDimAngular::extensionLineExtend, DS.ARGS())
        .def("setExtensionLineExtend", &PyAcadDimAngular::setExtensionLineExtend, DS.ARGS({ "val: float" }))
        .def("fit", &PyAcadDimAngular::fit, DS.ARGS())
        .def("setFit", &PyAcadDimAngular::setFit, DS.ARGS({ "val: PyAx.AcDimFit" }))
        .def("horizontalTextPosition", &PyAcadDimAngular::horizontalTextPosition, DS.ARGS())
        .def("setHorizontalTextPosition", &PyAcadDimAngular::setHorizontalTextPosition, DS.ARGS({ "val: PyAx.AcDimHorizontalJustification" }))
        .def("extensionLineWeight", &PyAcadDimAngular::extensionLineWeight, DS.ARGS())
        .def("setExtensionLineWeight", &PyAcadDimAngular::setExtensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("dimLine1Suppress", &PyAcadDimAngular::dimLine1Suppress, DS.ARGS())
        .def("setDimLine1Suppress", &PyAcadDimAngular::setDimLine1Suppress, DS.ARGS({ "val: bool" }))
        .def("dimLine2Suppress", &PyAcadDimAngular::dimLine2Suppress, DS.ARGS())
        .def("setDimLine2Suppress", &PyAcadDimAngular::setDimLine2Suppress, DS.ARGS({ "val: bool" }))
        .def("extLine1Suppress", &PyAcadDimAngular::extLine1Suppress, DS.ARGS())
        .def("setExtLine1Suppress", &PyAcadDimAngular::setExtLine1Suppress, DS.ARGS({ "val: bool" }))
        .def("extLine2Suppress", &PyAcadDimAngular::extLine2Suppress, DS.ARGS())
        .def("setExtLine2Suppress", &PyAcadDimAngular::setExtLine2Suppress, DS.ARGS({ "val: bool" }))
        .def("dimLineInside", &PyAcadDimAngular::dimLineInside, DS.ARGS())
        .def("setDimLineInside", &PyAcadDimAngular::setDimLineInside, DS.ARGS({ "val: bool" }))
        .def("textInsideAlign", &PyAcadDimAngular::textInsideAlign, DS.ARGS())
        .def("setTextInsideAlign", &PyAcadDimAngular::setTextInsideAlign, DS.ARGS({ "val: bool" }))
        .def("textInside", &PyAcadDimAngular::textInside, DS.ARGS())
        .def("setTextInside", &PyAcadDimAngular::setTextInside, DS.ARGS({ "val: bool" }))
        .def("forceLineInside", &PyAcadDimAngular::forceLineInside, DS.ARGS())
        .def("setForceLineInside", &PyAcadDimAngular::setForceLineInside, DS.ARGS({ "val: bool" }))
        .def("textOutsideAlign", &PyAcadDimAngular::textOutsideAlign, DS.ARGS())
        .def("setTextOutsideAlign", &PyAcadDimAngular::setTextOutsideAlign, DS.ARGS({ "val: bool" }))
        .def("textPrecision", &PyAcadDimAngular::textPrecision, DS.ARGS())
        .def("setTextPrecision", &PyAcadDimAngular::setTextPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("extensionLineOffset", &PyAcadDimAngular::extensionLineOffset, DS.ARGS())
        .def("setExtensionLineOffset", &PyAcadDimAngular::setExtensionLineOffset, DS.ARGS({ "val: float" }))
        .def("dimensionLineWeight", &PyAcadDimAngular::dimensionLineWeight, DS.ARGS())
        .def("setDimensionLineWeight", &PyAcadDimAngular::setDimensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("arrowheadSize", &PyAcadDimAngular::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDimAngular::setArrowheadSize, DS.ARGS({ "val: float" }))
        .def("arrowhead1Type", &PyAcadDimAngular::arrowhead1Type, DS.ARGS())
        .def("setArrowhead1Type", &PyAcadDimAngular::setArrowhead1Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("arrowhead2Type", &PyAcadDimAngular::arrowhead2Type, DS.ARGS())
        .def("setArrowhead2Type", &PyAcadDimAngular::setArrowhead2Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("measurement", &PyAcadDimAngular::measurement, DS.ARGS())
        .def("arrowhead1Block", &PyAcadDimAngular::arrowhead1Block, DS.ARGS())
        .def("setArrowhead1Block", &PyAcadDimAngular::setArrowhead1Block, DS.ARGS({ "val: str" }))
        .def("arrowhead2Block", &PyAcadDimAngular::arrowhead2Block, DS.ARGS())
        .def("setArrowhead2Block", &PyAcadDimAngular::setArrowhead2Block, DS.ARGS({ "val: str" }))
        .def("dimensionLinetype", &PyAcadDimAngular::dimensionLinetype, DS.ARGS())
        .def("setDimensionLinetype", &PyAcadDimAngular::setDimensionLinetype, DS.ARGS({ "val: str" }))
        .def("extLine1Linetype", &PyAcadDimAngular::extLine1Linetype, DS.ARGS())
        .def("setExtLine1Linetype", &PyAcadDimAngular::setExtLine1Linetype, DS.ARGS({ "val: str" }))
        .def("extLine2Linetype", &PyAcadDimAngular::extLine2Linetype, DS.ARGS())
        .def("setExtLine2Linetype", &PyAcadDimAngular::setExtLine2Linetype, DS.ARGS({ "val: str" }))
        .def("extLineFixedLenSuppress", &PyAcadDimAngular::extLineFixedLenSuppress, DS.ARGS())
        .def("setExtLineFixedLenSuppress", &PyAcadDimAngular::setExtLineFixedLenSuppress, DS.ARGS({ "val: bool" }))
        .def("extLineFixedLen", &PyAcadDimAngular::extLineFixedLen, DS.ARGS())
        .def("setExtLineFixedLen", &PyAcadDimAngular::setExtLineFixedLen, DS.ARGS({ "val: float" }))
        .def("dimConstrForm", &PyAcadDimAngular::dimConstrForm, DS.ARGS())
        .def("setDimConstrForm", &PyAcadDimAngular::setDimConstrForm, DS.ARGS({ "val: bool" }))
        .def("dimConstrReference", &PyAcadDimAngular::dimConstrReference, DS.ARGS())
        .def("setDimConstrReference", &PyAcadDimAngular::setDimConstrReference, DS.ARGS({ "val: bool" }))
        .def("dimConstrName", &PyAcadDimAngular::dimConstrName, DS.ARGS())
        .def("setDimConstrName", &PyAcadDimAngular::setDimConstrName, DS.ARGS({ "val: str" }))
        .def("dimConstrExpression", &PyAcadDimAngular::dimConstrExpression, DS.ARGS())
        .def("setDimConstrExpression", &PyAcadDimAngular::setDimConstrExpression, DS.ARGS({ "val: str" }))
        .def("dimConstrValue", &PyAcadDimAngular::dimConstrValue, DS.ARGS())
        .def("setDimConstrValue", &PyAcadDimAngular::setDimConstrValue, DS.ARGS({ "val: str" }))
        .def("dimConstrDesc", &PyAcadDimAngular::dimConstrDesc, DS.ARGS())
        .def("setDimConstrDesc", &PyAcadDimAngular::setDimConstrDesc, DS.ARGS({ "val: str" }))
...
void makePyAcadDimDiametricWrapper()
{
    ...
    class_<PyAcadDimDiametric, bases<PyAcadDimension>>("AcadDimDiametric", boost::python::no_init)
        .def("setLeaderLength", &PyAcadDimDiametric::setLeaderLength, DS.ARGS({ "val: float" }))
        .def("altUnits", &PyAcadDimDiametric::altUnits, DS.ARGS())
        .def("setAltUnits", &PyAcadDimDiametric::setAltUnits, DS.ARGS({ "val: bool" }))
        .def("altUnitsPrecision", &PyAcadDimDiametric::altUnitsPrecision, DS.ARGS())
        .def("setAltUnitsPrecision", &PyAcadDimDiametric::setAltUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsScale", &PyAcadDimDiametric::altUnitsScale, DS.ARGS())
        .def("setAltUnitsScale", &PyAcadDimDiametric::setAltUnitsScale, DS.ARGS({ "val: bool" }))
        .def("altTolerancePrecision", &PyAcadDimDiametric::altTolerancePrecision, DS.ARGS())
        .def("setAltTolerancePrecision", &PyAcadDimDiametric::setAltTolerancePrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsFormat", &PyAcadDimDiametric::altUnitsFormat, DS.ARGS())
        .def("setAltUnitsFormat", &PyAcadDimDiametric::setAltUnitsFormat, DS.ARGS({ "val: PyAx.AcDimUnits" }))
        .def("altTextPrefix", &PyAcadDimDiametric::altTextPrefix, DS.ARGS())
        .def("setAltTextPrefix", &PyAcadDimDiametric::setAltTextPrefix, DS.ARGS({ "val: str" }))
        .def("altTextSuffix", &PyAcadDimDiametric::altTextSuffix, DS.ARGS())
        .def("setAltTextSuffix", &PyAcadDimDiametric::setAltTextSuffix, DS.ARGS({ "val: str" }))
        .def("dimensionLineColor", &PyAcadDimDiametric::dimensionLineColor, DS.ARGS())
        .def("setDimensionLineColor", &PyAcadDimDiametric::setDimensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("primaryUnitsPrecision", &PyAcadDimDiametric::primaryUnitsPrecision, DS.ARGS())
        .def("setPrimaryUnitsPrecision", &PyAcadDimDiametric::setPrimaryUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("fractionFormat", &PyAcadDimDiametric::fractionFormat, DS.ARGS())
        .def("setFractionFormat", &PyAcadDimDiametric::setFractionFormat, DS.ARGS({ "val: PyAx.AcDimFractionType" }))
        .def("fit", &PyAcadDimDiametric::fit, DS.ARGS())
        .def("setFit", &PyAcadDimDiametric::setFit, DS.ARGS({ "val: PyAx.AcDimFit" }))
        .def("linearScaleFactor", &PyAcadDimDiametric::linearScaleFactor, DS.ARGS())
        .def("setLinearScaleFactor", &PyAcadDimDiametric::setLinearScaleFactor, DS.ARGS({ "val: float" }))
        .def("unitsFormat", &PyAcadDimDiametric::unitsFormat, DS.ARGS())
        .def("setUnitsFormat", &PyAcadDimDiametric::setUnitsFormat, DS.ARGS({ "val: AcDimLUnits" }))
        .def("roundDistance", &PyAcadDimDiametric::roundDistance, DS.ARGS())
        .def("setRoundDistance", &PyAcadDimDiametric::setRoundDistance, DS.ARGS({ "val: float" }))
        .def("dimLine1Suppress", &PyAcadDimDiametric::dimLine1Suppress, DS.ARGS())
        .def("setDimLine1Suppress", &PyAcadDimDiametric::setDimLine1Suppress, DS.ARGS({ "val: bool" }))
        .def("dimLine2Suppress", &PyAcadDimDiametric::dimLine2Suppress, DS.ARGS())
        .def("setDimLine2Suppress", &PyAcadDimDiametric::setDimLine2Suppress, DS.ARGS({ "val: bool" }))
        .def("textInsideAlign", &PyAcadDimDiametric::textInsideAlign, DS.ARGS())
        .def("setTextInsideAlign", &PyAcadDimDiametric::setTextInsideAlign, DS.ARGS({ "val: bool" }))
        .def("textInside", &PyAcadDimDiametric::textInside, DS.ARGS())
        .def("setTextInside", &PyAcadDimDiametric::setTextInside, DS.ARGS({ "val: bool" }))
        .def("forceLineInside", &PyAcadDimDiametric::forceLineInside, DS.ARGS())
        .def("setForceLineInside", &PyAcadDimDiametric::setForceLineInside, DS.ARGS({ "val: bool" }))
        .def("textOutsideAlign", &PyAcadDimDiametric::textOutsideAlign, DS.ARGS())
        .def("setTextOutsideAlign", &PyAcadDimDiametric::setTextOutsideAlign, DS.ARGS({ "val: bool" }))
        .def("centerType", &PyAcadDimDiametric::centerType, DS.ARGS())
        .def("setCenterType", &PyAcadDimDiametric::setCenterType, DS.ARGS({ "val: PyAx.AcDimCenterType" }))
        .def("centerMarkSize", &PyAcadDimDiametric::centerMarkSize, DS.ARGS())
        .def("setCenterMarkSize", &PyAcadDimDiametric::setCenterMarkSize, DS.ARGS({ "val: float" }))
        .def("altSuppressLeadingZeros", &PyAcadDimDiametric::altSuppressLeadingZeros, DS.ARGS())
        .def("setAltSuppressLeadingZeros", &PyAcadDimDiametric::setAltSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressTrailingZeros", &PyAcadDimDiametric::altSuppressTrailingZeros, DS.ARGS())
        .def("setAltSuppressTrailingZeros", &PyAcadDimDiametric::setAltSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroFeet", &PyAcadDimDiametric::altSuppressZeroFeet, DS.ARGS())
        .def("setAltSuppressZeroFeet", &PyAcadDimDiametric::setAltSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroInches", &PyAcadDimDiametric::altSuppressZeroInches, DS.ARGS())
        .def("setAltSuppressZeroInches", &PyAcadDimDiametric::setAltSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressLeadingZeros", &PyAcadDimDiametric::altToleranceSuppressLeadingZeros, DS.ARGS())
        .def("setAltToleranceSuppressLeadingZeros", &PyAcadDimDiametric::setAltToleranceSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressTrailingZeros", &PyAcadDimDiametric::altToleranceSuppressTrailingZeros, DS.ARGS())
        .def("setAltToleranceSuppressTrailingZeros", &PyAcadDimDiametric::setAltToleranceSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroFeet", &PyAcadDimDiametric::altToleranceSuppressZeroFeet, DS.ARGS())
        .def("setAltToleranceSuppressZeroFeet", &PyAcadDimDiametric::setAltToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroInches", &PyAcadDimDiametric::altToleranceSuppressZeroInches, DS.ARGS())
        .def("setAltToleranceSuppressZeroInches", &PyAcadDimDiametric::setAltToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("suppressZeroFeet", &PyAcadDimDiametric::suppressZeroFeet, DS.ARGS())
        .def("setSuppressZeroFeet", &PyAcadDimDiametric::setSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("suppressZeroInches", &PyAcadDimDiametric::suppressZeroInches, DS.ARGS())
        .def("setSuppressZeroInches", &PyAcadDimDiametric::setSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroFeet", &PyAcadDimDiametric::toleranceSuppressZeroFeet, DS.ARGS())
        .def("setToleranceSuppressZeroFeet", &PyAcadDimDiametric::setToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroInches", &PyAcadDimDiametric::toleranceSuppressZeroInches, DS.ARGS())
        .def("setToleranceSuppressZeroInches", &PyAcadDimDiametric::setToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("dimensionLineWeight", &PyAcadDimDiametric::dimensionLineWeight, DS.ARGS())
        .def("setDimensionLineWeight", &PyAcadDimDiametric::setDimensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("arrowheadSize", &PyAcadDimDiametric::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDimDiametric::setArrowheadSize, DS.ARGS({ "val: float" }))
        .def("arrowhead1Type", &PyAcadDimDiametric::arrowhead1Type, DS.ARGS())
        .def("setArrowhead1Type", &PyAcadDimDiametric::setArrowhead1Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("arrowhead2Type", &PyAcadDimDiametric::arrowhead2Type, DS.ARGS())
        .def("setArrowhead2Type", &PyAcadDimDiametric::setArrowhead2Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("measurement", &PyAcadDimDiametric::measurement, DS.ARGS())
        .def("arrowhead1Block", &PyAcadDimDiametric::arrowhead1Block, DS.ARGS())
        .def("setArrowhead1Block", &PyAcadDimDiametric::setArrowhead1Block, DS.ARGS({ "val: str" }))
        .def("arrowhead2Block", &PyAcadDimDiametric::arrowhead2Block, DS.ARGS())
        .def("setArrowhead2Block", &PyAcadDimDiametric::setArrowhead2Block, DS.ARGS({ "val: str" }))
        .def("dimensionLinetype", &PyAcadDimDiametric::dimensionLinetype, DS.ARGS())
        .def("setDimensionLinetype", &PyAcadDimDiametric::setDimensionLinetype, DS.ARGS({ "val: str" }))
        .def("dimConstrForm", &PyAcadDimDiametric::dimConstrForm, DS.ARGS())
        .def("setDimConstrForm", &PyAcadDimDiametric::setDimConstrForm, DS.ARGS({ "val: bool" }))
        .def("dimConstrReference", &PyAcadDimDiametric::dimConstrReference, DS.ARGS())
        .def("setDimConstrReference", &PyAcadDimDiametric::setDimConstrReference, DS.ARGS({ "val: bool" }))
        .def("dimConstrName", &PyAcadDimDiametric::dimConstrName, DS.ARGS())
        .def("setDimConstrName", &PyAcadDimDiametric::setDimConstrName, DS.ARGS({ "val: str" }))
        .def("dimConstrExpression", &PyAcadDimDiametric::dimConstrExpression, DS.ARGS())
        .def("setDimConstrExpression", &PyAcadDimDiametric::setDimConstrExpression, DS.ARGS({ "val: str" }))
        .def("dimConstrValue", &PyAcadDimDiametric::dimConstrValue, DS.ARGS())
        .def("setDimConstrValue", &PyAcadDimDiametric::setDimConstrValue, DS.ARGS({ "val: str" }))
        .def("dimConstrDesc", &PyAcadDimDiametric::dimConstrDesc, DS.ARGS())
        .def("setDimConstrDesc", &PyAcadDimDiametric::setDimConstrDesc, DS.ARGS({ "val: str" }))
...
void makePyAcadDimRotatedWrapper()
{
    ...
    class_<PyAcadDimRotated, bases<PyAcadDimension>>("AcadDimRotated", boost::python::no_init)
        ...
        .def("setAltUnits", &PyAcadDimRotated::setAltUnits, DS.ARGS({ "val: bool" }))
        .def("altUnitsPrecision", &PyAcadDimRotated::altUnitsPrecision, DS.ARGS())
        .def("setAltUnitsPrecision", &PyAcadDimRotated::setAltUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsScale", &PyAcadDimRotated::altUnitsScale, DS.ARGS())
        .def("setAltUnitsScale", &PyAcadDimRotated::setAltUnitsScale, DS.ARGS({ "val: float" }))
        .def("altRoundDistance", &PyAcadDimRotated::altRoundDistance, DS.ARGS())
        .def("setAltRoundDistance", &PyAcadDimRotated::setAltRoundDistance, DS.ARGS({ "val: float" }))
        .def("altTolerancePrecision", &PyAcadDimRotated::altTolerancePrecision, DS.ARGS())
        .def("setAltTolerancePrecision", &PyAcadDimRotated::setAltTolerancePrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsFormat", &PyAcadDimRotated::altUnitsFormat, DS.ARGS())
        .def("setAltUnitsFormat", &PyAcadDimRotated::setAltUnitsFormat, DS.ARGS({ "val: PyAx.AcDimUnits" }))
        .def("altTextPrefix", &PyAcadDimRotated::altTextPrefix, DS.ARGS())
        .def("setAltTextPrefix", &PyAcadDimRotated::setAltTextPrefix, DS.ARGS({ "val: str" }))
        .def("altTextSuffix", &PyAcadDimRotated::altTextSuffix, DS.ARGS())
        .def("setAltTextSuffix", &PyAcadDimRotated::setAltTextSuffix, DS.ARGS({ "val: str" }))
        .def("dimensionLineColor", &PyAcadDimRotated::dimensionLineColor, DS.ARGS())
        .def("setDimensionLineColor", &PyAcadDimRotated::setDimensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("extensionLineColor", &PyAcadDimRotated::extensionLineColor, DS.ARGS())
        .def("setExtensionLineColor", &PyAcadDimRotated::setExtensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("primaryUnitsPrecision", &PyAcadDimRotated::primaryUnitsPrecision, DS.ARGS())
        .def("setPrimaryUnitsPrecision", &PyAcadDimRotated::setPrimaryUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("dimensionLineExtend", &PyAcadDimRotated::dimensionLineExtend, DS.ARGS())
        .def("setDimensionLineExtend", &PyAcadDimRotated::setDimensionLineExtend, DS.ARGS({ "val: float" }))
        .def("extensionLineExtend", &PyAcadDimRotated::extensionLineExtend, DS.ARGS())
        .def("setExtensionLineExtend", &PyAcadDimRotated::setExtensionLineExtend, DS.ARGS({ "val: float" }))
        .def("fit", &PyAcadDimRotated::fit, DS.ARGS())
        .def("setFit", &PyAcadDimRotated::setFit, DS.ARGS({ "val: PyAx.AcDimFit" }))
        .def("fractionFormat", &PyAcadDimRotated::fractionFormat, DS.ARGS())
        .def("setFractionFormat", &PyAcadDimRotated::setFractionFormat, DS.ARGS({ "val: PyAx.AcDimFractionType" }))
        .def("horizontalTextPosition", &PyAcadDimRotated::horizontalTextPosition, DS.ARGS())
        .def("setHorizontalTextPosition", &PyAcadDimRotated::setHorizontalTextPosition, DS.ARGS({ "val: PyAx.AcDimHorizontalJustification" }))
        .def("linearScaleFactor", &PyAcadDimRotated::linearScaleFactor, DS.ARGS())
        .def("setLinearScaleFactor", &PyAcadDimRotated::setLinearScaleFactor, DS.ARGS({ "val: float" }))
        .def("unitsFormat", &PyAcadDimRotated::unitsFormat, DS.ARGS())
        .def("setUnitsFormat", &PyAcadDimRotated::setUnitsFormat, DS.ARGS({ "val: PyAx.AcDimLUnits" }))
        .def("extensionLineWeight", &PyAcadDimRotated::extensionLineWeight, DS.ARGS())
        .def("setExtensionLineWeight", &PyAcadDimRotated::setExtensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("roundDistance", &PyAcadDimRotated::roundDistance, DS.ARGS())
        .def("setRoundDistance", &PyAcadDimRotated::setRoundDistance, DS.ARGS({ "val: float" }))
        .def("dimLine1Suppress", &PyAcadDimRotated::dimLine1Suppress, DS.ARGS())
        .def("setDimLine1Suppress", &PyAcadDimRotated::setDimLine1Suppress, DS.ARGS({ "val: bool" }))
        .def("dimLine2Suppress", &PyAcadDimRotated::dimLine2Suppress, DS.ARGS())
        .def("setDimLine2Suppress", &PyAcadDimRotated::setDimLine2Suppress, DS.ARGS({ "val: bool" }))
        .def("extLine1Suppress", &PyAcadDimRotated::extLine1Suppress, DS.ARGS())
        .def("setExtLine1Suppress", &PyAcadDimRotated::setExtLine1Suppress, DS.ARGS({ "val: bool" }))
        .def("extLine2Suppress", &PyAcadDimRotated::extLine2Suppress, DS.ARGS())
        .def("setExtLine2Suppress", &PyAcadDimRotated::setExtLine2Suppress, DS.ARGS({ "val: bool" }))
        .def("dimLineInside", &PyAcadDimRotated::dimLineInside, DS.ARGS())
        .def("setDimLineInside", &PyAcadDimRotated::setDimLineInside, DS.ARGS({ "val: bool" }))
        .def("textInsideAlign", &PyAcadDimRotated::textInsideAlign, DS.ARGS())
        .def("setTextInsideAlign", &PyAcadDimRotated::setTextInsideAlign, DS.ARGS({ "val: bool" }))
        .def("textInside", &PyAcadDimRotated::textInside, DS.ARGS())
        .def("setTextInside", &PyAcadDimRotated::setTextInside, DS.ARGS({ "val: bool" }))
        .def("forceLineInside", &PyAcadDimRotated::forceLineInside, DS.ARGS())
        .def("setForceLineInside", &PyAcadDimRotated::setForceLineInside, DS.ARGS({ "val: bool" }))
        .def("textOutsideAlign", &PyAcadDimRotated::textOutsideAlign, DS.ARGS())
        .def("setTextOutsideAlign", &PyAcadDimRotated::setTextOutsideAlign, DS.ARGS({ "val: bool" }))
        .def("extensionLineOffset", &PyAcadDimRotated::extensionLineOffset, DS.ARGS())
        .def("setExtensionLineOffset", &PyAcadDimRotated::setExtensionLineOffset, DS.ARGS({ "val: float" }))
        .def("altSuppressLeadingZeros", &PyAcadDimRotated::altSuppressLeadingZeros, DS.ARGS())
        .def("setAltSuppressLeadingZeros", &PyAcadDimRotated::setAltSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressTrailingZeros", &PyAcadDimRotated::altSuppressTrailingZeros, DS.ARGS())
        .def("setAltSuppressTrailingZeros", &PyAcadDimRotated::setAltSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroFeet", &PyAcadDimRotated::altSuppressZeroFeet, DS.ARGS())
        .def("setAltSuppressZeroFeet", &PyAcadDimRotated::setAltSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroInches", &PyAcadDimRotated::altSuppressZeroInches, DS.ARGS())
        .def("setAltSuppressZeroInches", &PyAcadDimRotated::setAltSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressLeadingZeros", &PyAcadDimRotated::altToleranceSuppressLeadingZeros, DS.ARGS())
        .def("setAltToleranceSuppressLeadingZeros", &PyAcadDimRotated::setAltToleranceSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressTrailingZeros", &PyAcadDimRotated::altToleranceSuppressTrailingZeros, DS.ARGS())
        .def("setAltToleranceSuppressTrailingZeros", &PyAcadDimRotated::setAltToleranceSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroFeet", &PyAcadDimRotated::altToleranceSuppressZeroFeet, DS.ARGS())
        .def("setAltToleranceSuppressZeroFeet", &PyAcadDimRotated::setAltToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroInches", &PyAcadDimRotated::altToleranceSuppressZeroInches, DS.ARGS())
        .def("setAltToleranceSuppressZeroInches", &PyAcadDimRotated::setAltToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("suppressZeroFeet", &PyAcadDimRotated::suppressZeroFeet, DS.ARGS())
        .def("setSuppressZeroFeet", &PyAcadDimRotated::setSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("suppressZeroInches", &PyAcadDimRotated::suppressZeroInches, DS.ARGS())
        .def("setSuppressZeroInches", &PyAcadDimRotated::setSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroFeet", &PyAcadDimRotated::toleranceSuppressZeroFeet, DS.ARGS())
        .def("setToleranceSuppressZeroFeet", &PyAcadDimRotated::setToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroInches", &PyAcadDimRotated::toleranceSuppressZeroInches, DS.ARGS())
        .def("setToleranceSuppressZeroInches", &PyAcadDimRotated::setToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("dimensionLineWeight", &PyAcadDimRotated::dimensionLineWeight, DS.ARGS())
        .def("setDimensionLineWeight", &PyAcadDimRotated::setDimensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("arrowheadSize", &PyAcadDimRotated::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDimRotated::setArrowheadSize, DS.ARGS({ "val: float" }))
        .def("arrowhead1Type", &PyAcadDimRotated::arrowhead1Type, DS.ARGS())
        .def("setArrowhead1Type", &PyAcadDimRotated::setArrowhead1Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("arrowhead2Type", &PyAcadDimRotated::arrowhead2Type, DS.ARGS())
        .def("setArrowhead2Type", &PyAcadDimRotated::setArrowhead2Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("measurement", &PyAcadDimRotated::measurement, DS.ARGS())
        .def("arrowhead1Block", &PyAcadDimRotated::arrowhead1Block, DS.ARGS())
        .def("setArrowhead1Block", &PyAcadDimRotated::setArrowhead1Block, DS.ARGS({ "val: str" }))
        .def("arrowhead2Block", &PyAcadDimRotated::arrowhead2Block, DS.ARGS())
        .def("setArrowhead2Block", &PyAcadDimRotated::setArrowhead2Block, DS.ARGS({ "val: str" }))
        .def("dimensionLinetype", &PyAcadDimRotated::dimensionLinetype, DS.ARGS())
        .def("setDimensionLinetype", &PyAcadDimRotated::setDimensionLinetype, DS.ARGS({ "val: str" }))
        .def("extLine1Linetype", &PyAcadDimRotated::extLine1Linetype, DS.ARGS())
        .def("setExtLine1Linetype", &PyAcadDimRotated::setExtLine1Linetype, DS.ARGS({ "val: str" }))
        .def("extLine2Linetype", &PyAcadDimRotated::extLine2Linetype, DS.ARGS())
        .def("setExtLine2Linetype", &PyAcadDimRotated::setExtLine2Linetype, DS.ARGS({ "val: str" }))
        .def("extLineFixedLenSuppress", &PyAcadDimRotated::extLineFixedLenSuppress, DS.ARGS())
        .def("setExtLineFixedLenSuppress", &PyAcadDimRotated::setExtLineFixedLenSuppress, DS.ARGS({ "val: bool" }))
        .def("extLineFixedLen", &PyAcadDimRotated::extLineFixedLen, DS.ARGS())
        .def("setExtLineFixedLen", &PyAcadDimRotated::setExtLineFixedLen, DS.ARGS({ "val: float" }))
        .def("dimConstrForm", &PyAcadDimRotated::dimConstrForm, DS.ARGS())
        .def("setDimConstrForm", &PyAcadDimRotated::setDimConstrForm, DS.ARGS({ "val: bool" }))
        .def("dimConstrReference", &PyAcadDimRotated::dimConstrReference, DS.ARGS())
        .def("setDimConstrReference", &PyAcadDimRotated::setDimConstrReference, DS.ARGS({ "val: bool" }))
        .def("dimConstrName", &PyAcadDimRotated::dimConstrName, DS.ARGS())
        .def("setDimConstrName", &PyAcadDimRotated::setDimConstrName, DS.ARGS({ "val: str" }))
        .def("dimConstrExpression", &PyAcadDimRotated::dimConstrExpression, DS.ARGS())
        .def("setDimConstrExpression", &PyAcadDimRotated::setDimConstrExpression, DS.ARGS({ "val: str" }))
        .def("dimConstrDesc", &PyAcadDimRotated::dimConstrDesc, DS.ARGS())
        .def("setDimConstrValue", &PyAcadDimRotated::setDimConstrValue, DS.ARGS({ "val: str" }))
        .def("dimConstrValue", &PyAcadDimRotated::dimConstrValue, DS.ARGS())
        .def("setDimConstrDesc", &PyAcadDimRotated::setDimConstrDesc, DS.ARGS({ "val: str" }))
        .def("subUnitsSuffix", &PyAcadDimRotated::subUnitsSuffix, DS.ARGS())
        .def("setSubUnitsSuffix", &PyAcadDimRotated::setSubUnitsSuffix, DS.ARGS({ "val: str" }))
        .def("subUnitsFactor", &PyAcadDimRotated::subUnitsFactor, DS.ARGS())
        .def("setSubUnitsFactor", &PyAcadDimRotated::setSubUnitsFactor, DS.ARGS({ "val: float" }))
        .def("altSubUnitsSuffix", &PyAcadDimRotated::altSubUnitsSuffix, DS.ARGS())
        .def("setAltSubUnitsSuffix", &PyAcadDimRotated::setAltSubUnitsSuffix, DS.ARGS({ "val: str" }))
        .def("altSubUnitsFactor", &PyAcadDimRotated::altSubUnitsFactor, DS.ARGS())
        .def("setAltSubUnitsFactor", &PyAcadDimRotated::setAltSubUnitsFactor, DS.ARGS({ "val: float" }))
...
void makePyAcadDimOrdinateWrapper()
{
    ...
    class_<PyAcadDimOrdinate, bases<PyAcadDimension>>("AcadDimOrdinate", boost::python::no_init)
        ...
        .def("setAltUnits", &PyAcadDimOrdinate::setAltUnits, DS.ARGS({ "val: bool" }))
        .def("altUnitsPrecision", &PyAcadDimOrdinate::altUnitsPrecision, DS.ARGS())
        .def("setAltUnitsPrecision", &PyAcadDimOrdinate::setAltUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsScale", &PyAcadDimOrdinate::altUnitsScale, DS.ARGS())
        .def("setAltUnitsScale", &PyAcadDimOrdinate::setAltUnitsScale, DS.ARGS({ "val: float" }))
        .def("altRoundDistance", &PyAcadDimOrdinate::altRoundDistance, DS.ARGS())
        .def("setAltRoundDistance", &PyAcadDimOrdinate::setAltRoundDistance, DS.ARGS({ "val: float" }))
        .def("altTolerancePrecision", &PyAcadDimOrdinate::altTolerancePrecision, DS.ARGS())
        .def("setAltTolerancePrecision", &PyAcadDimOrdinate::setAltTolerancePrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsFormat", &PyAcadDimOrdinate::altUnitsFormat, DS.ARGS())
        .def("setAltUnitsFormat", &PyAcadDimOrdinate::setAltUnitsFormat, DS.ARGS({ "val: PyAx.AcDimUnits" }))
        .def("altTextPrefix", &PyAcadDimOrdinate::altTextPrefix, DS.ARGS())
        .def("setAltTextPrefix", &PyAcadDimOrdinate::setAltTextPrefix, DS.ARGS({ "val: str" }))
        .def("altTextSuffix", &PyAcadDimOrdinate::altTextSuffix, DS.ARGS())
        .def("setAltTextSuffix", &PyAcadDimOrdinate::setAltTextSuffix, DS.ARGS({ "val: str" }))
        .def("extensionLineColor", &PyAcadDimOrdinate::extensionLineColor, DS.ARGS())
        .def("setExtensionLineColor", &PyAcadDimOrdinate::setExtensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("primaryUnitsPrecision", &PyAcadDimOrdinate::primaryUnitsPrecision, DS.ARGS())
        .def("setPrimaryUnitsPrecision", &PyAcadDimOrdinate::setPrimaryUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("fractionFormat", &PyAcadDimOrdinate::fractionFormat, DS.ARGS())
        .def("setFractionFormat", &PyAcadDimOrdinate::setFractionFormat, DS.ARGS({ "val: PyAx.AcDimFractionType" }))
        .def("linearScaleFactor", &PyAcadDimOrdinate::linearScaleFactor, DS.ARGS())
        .def("setLinearScaleFactor", &PyAcadDimOrdinate::setLinearScaleFactor, DS.ARGS({ "val: float" }))
        .def("unitsFormat", &PyAcadDimOrdinate::unitsFormat, DS.ARGS())
        .def("setUnitsFormat", &PyAcadDimOrdinate::setUnitsFormat, DS.ARGS({ "val: PyAx.AcDimLUnits" }))
        .def("extensionLineWeight", &PyAcadDimOrdinate::extensionLineWeight, DS.ARGS())
        .def("setExtensionLineWeight", &PyAcadDimOrdinate::setExtensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("roundDistance", &PyAcadDimOrdinate::roundDistance, DS.ARGS())
        .def("setRoundDistance", &PyAcadDimOrdinate::setRoundDistance, DS.ARGS({ "val: float" }))
        .def("extensionLineOffset", &PyAcadDimOrdinate::extensionLineOffset, DS.ARGS())
        .def("setExtensionLineOffset", &PyAcadDimOrdinate::setExtensionLineOffset, DS.ARGS({ "val: float" }))
        .def("altSuppressLeadingZeros", &PyAcadDimOrdinate::altSuppressLeadingZeros, DS.ARGS())
        .def("setAltSuppressLeadingZeros", &PyAcadDimOrdinate::setAltSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressTrailingZeros", &PyAcadDimOrdinate::altSuppressTrailingZeros, DS.ARGS())
        .def("setAltSuppressTrailingZeros", &PyAcadDimOrdinate::setAltSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroFeet", &PyAcadDimOrdinate::altSuppressZeroFeet, DS.ARGS())
        .def("setAltSuppressZeroFeet", &PyAcadDimOrdinate::setAltSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroInches", &PyAcadDimOrdinate::altSuppressZeroInches, DS.ARGS())
        .def("setAltSuppressZeroInches", &PyAcadDimOrdinate::setAltSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressLeadingZeros", &PyAcadDimOrdinate::altToleranceSuppressLeadingZeros, DS.ARGS())
        .def("setAltToleranceSuppressLeadingZeros", &PyAcadDimOrdinate::setAltToleranceSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressTrailingZeros", &PyAcadDimOrdinate::altToleranceSuppressTrailingZeros, DS.ARGS())
        .def("setAltToleranceSuppressTrailingZeros", &PyAcadDimOrdinate::setAltToleranceSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroFeet", &PyAcadDimOrdinate::altToleranceSuppressZeroFeet, DS.ARGS())
        .def("setAltToleranceSuppressZeroFeet", &PyAcadDimOrdinate::setAltToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroInches", &PyAcadDimOrdinate::altToleranceSuppressZeroInches, DS.ARGS())
        .def("setAltToleranceSuppressZeroInches", &PyAcadDimOrdinate::setAltToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("suppressZeroFeet", &PyAcadDimOrdinate::suppressZeroFeet, DS.ARGS())
        .def("setSuppressZeroFeet", &PyAcadDimOrdinate::setSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("suppressZeroInches", &PyAcadDimOrdinate::suppressZeroInches, DS.ARGS())
        .def("setSuppressZeroInches", &PyAcadDimOrdinate::setSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroFeet", &PyAcadDimOrdinate::toleranceSuppressZeroFeet, DS.ARGS())
        .def("setToleranceSuppressZeroFeet", &PyAcadDimOrdinate::setToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroInches", &PyAcadDimOrdinate::toleranceSuppressZeroInches, DS.ARGS())
        .def("setToleranceSuppressZeroInches", &PyAcadDimOrdinate::setToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("arrowheadSize", &PyAcadDimOrdinate::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDimOrdinate::setArrowheadSize, DS.ARGS({ "val: float" }))
        ...
        .def("setExtLineFixedLenSuppress", &PyAcadDimOrdinate::setExtLineFixedLenSuppress, DS.ARGS({ "val: bool" }))
        .def("extLineFixedLen", &PyAcadDimOrdinate::extLineFixedLen, DS.ARGS())
        .def("setExtLineFixedLen", &PyAcadDimOrdinate::setExtLineFixedLen, DS.ARGS({ "val: bool" }))
        .def("subUnitsSuffix", &PyAcadDimOrdinate::subUnitsSuffix, DS.ARGS())
        .def("setSubUnitsSuffix", &PyAcadDimOrdinate::setSubUnitsSuffix, DS.ARGS({ "val: str" }))
        .def("subUnitsFactor", &PyAcadDimOrdinate::subUnitsFactor, DS.ARGS())
        .def("setSubUnitsFactor", &PyAcadDimOrdinate::setSubUnitsFactor, DS.ARGS({ "val: float" }))
        .def("altSubUnitsSuffix", &PyAcadDimOrdinate::altSubUnitsSuffix, DS.ARGS())
        .def("setAltSubUnitsSuffix", &PyAcadDimOrdinate::setAltSubUnitsSuffix, DS.ARGS({ "val: str" }))
        .def("altSubUnitsFactor", &PyAcadDimOrdinate::altSubUnitsFactor, DS.ARGS())
        .def("setAltSubUnitsFactor", &PyAcadDimOrdinate::setAltSubUnitsFactor, DS.ARGS({ "val: float" }))
...
void makePyAcadDimRadialWrapper()
{
    ...
    class_<PyAcadDimRadial, bases<PyAcadDimension>>("AcadDimRadial", boost::python::no_init)
        .def("setLeaderLength", &PyAcadDimRadial::setLeaderLength, DS.ARGS({ "val: float" }))
        .def("altUnits", &PyAcadDimRadial::altUnits, DS.ARGS())
        .def("setAltUnits", &PyAcadDimRadial::setAltUnits, DS.ARGS({ "val: bool" }))
        .def("altUnitsPrecision", &PyAcadDimRadial::altUnitsPrecision, DS.ARGS())
        .def("setAltUnitsPrecision", &PyAcadDimRadial::setAltUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsScale", &PyAcadDimRadial::altUnitsScale, DS.ARGS())
        .def("setAltUnitsScale", &PyAcadDimRadial::setAltUnitsScale, DS.ARGS({ "val: float" }))
        .def("altRoundDistance", &PyAcadDimRadial::altRoundDistance, DS.ARGS())
        .def("setAltRoundDistance", &PyAcadDimRadial::setAltRoundDistance, DS.ARGS({ "val: float" }))
        .def("altTolerancePrecision", &PyAcadDimRadial::altTolerancePrecision, DS.ARGS())
        .def("setAltTolerancePrecision", &PyAcadDimRadial::setAltTolerancePrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("altUnitsFormat", &PyAcadDimRadial::altUnitsFormat, DS.ARGS())
        .def("setAltUnitsFormat", &PyAcadDimRadial::setAltUnitsFormat, DS.ARGS({ "val: PyAx.AcDimUnits" }))
        .def("altTextPrefix", &PyAcadDimRadial::altTextPrefix, DS.ARGS())
        .def("setAltTextPrefix", &PyAcadDimRadial::setAltTextPrefix, DS.ARGS({ "val: str" }))
        .def("altTextSuffix", &PyAcadDimRadial::altTextSuffix, DS.ARGS())
        .def("setAltTextSuffix", &PyAcadDimRadial::setAltTextSuffix, DS.ARGS({ "val: str" }))
        .def("centerType", &PyAcadDimRadial::centerType, DS.ARGS())
        .def("setCenterType", &PyAcadDimRadial::setCenterType, DS.ARGS({ "val: PyAx.AcDimCenterType" }))
        .def("centerMarkSize", &PyAcadDimRadial::centerMarkSize, DS.ARGS())
        .def("setCenterMarkSize", &PyAcadDimRadial::setCenterMarkSize, DS.ARGS({ "val: float" }))
        .def("dimensionLineColor", &PyAcadDimRadial::dimensionLineColor, DS.ARGS())
        .def("setDimensionLineColor", &PyAcadDimRadial::setDimensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("primaryUnitsPrecision", &PyAcadDimRadial::primaryUnitsPrecision, DS.ARGS())
        .def("setPrimaryUnitsPrecision", &PyAcadDimRadial::setPrimaryUnitsPrecision, DS.ARGS({ "val: PyAx.AcDimPrecision" }))
        .def("fractionFormat", &PyAcadDimRadial::fractionFormat, DS.ARGS())
        .def("setFractionFormat", &PyAcadDimRadial::setFractionFormat, DS.ARGS({ "val: PyAx.AcDimFractionType" }))
        .def("fit", &PyAcadDimRadial::fit, DS.ARGS())
        .def("setFit", &PyAcadDimRadial::setFit, DS.ARGS({ "val: PyAx.AcDimFit" }))
        .def("linearScaleFactor", &PyAcadDimRadial::linearScaleFactor, DS.ARGS())
        .def("setLinearScaleFactor", &PyAcadDimRadial::setLinearScaleFactor, DS.ARGS({ "val: float" }))
        .def("unitsFormat", &PyAcadDimRadial::unitsFormat, DS.ARGS())
        .def("setUnitsFormat", &PyAcadDimRadial::setUnitsFormat, DS.ARGS({ "val: PyAx.AcDimLUnits" }))
        .def("roundDistance", &PyAcadDimRadial::roundDistance, DS.ARGS())
        .def("setRoundDistance", &PyAcadDimRadial::setRoundDistance, DS.ARGS({ "val: float" }))
        .def("dimLineSuppress", &PyAcadDimRadial::dimLineSuppress, DS.ARGS())
        .def("setDimLineSuppress", &PyAcadDimRadial::setDimLineSuppress, DS.ARGS({ "val: bool" }))
        .def("textInsideAlign", &PyAcadDimRadial::textInsideAlign, DS.ARGS())
        .def("setTextInsideAlign", &PyAcadDimRadial::setTextInsideAlign, DS.ARGS({ "val: bool" }))
        .def("textInside", &PyAcadDimRadial::textInside, DS.ARGS())
        .def("setTextInside", &PyAcadDimRadial::setTextInside, DS.ARGS({ "val: bool" }))
        .def("forceLineInside", &PyAcadDimRadial::forceLineInside, DS.ARGS())
        .def("setForceLineInside", &PyAcadDimRadial::setForceLineInside, DS.ARGS({ "val: bool" }))
        .def("textOutsideAlign", &PyAcadDimRadial::textOutsideAlign, DS.ARGS())
        .def("setTextOutsideAlign", &PyAcadDimRadial::setTextOutsideAlign, DS.ARGS({ "val: bool" }))
        .def("altSuppressLeadingZeros", &PyAcadDimRadial::altSuppressLeadingZeros, DS.ARGS())
        .def("setAltSuppressLeadingZeros", &PyAcadDimRadial::setAltSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressTrailingZeros", &PyAcadDimRadial::altSuppressTrailingZeros, DS.ARGS())
        .def("setAltSuppressTrailingZeros", &PyAcadDimRadial::setAltSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroFeet", &PyAcadDimRadial::altSuppressZeroFeet, DS.ARGS())
        .def("setAltSuppressZeroFeet", &PyAcadDimRadial::setAltSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altSuppressZeroInches", &PyAcadDimRadial::altSuppressZeroInches, DS.ARGS())
        .def("setAltSuppressZeroInches", &PyAcadDimRadial::setAltSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressLeadingZeros", &PyAcadDimRadial::altToleranceSuppressLeadingZeros, DS.ARGS())
        .def("setAltToleranceSuppressLeadingZeros", &PyAcadDimRadial::setAltToleranceSuppressLeadingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressTrailingZeros", &PyAcadDimRadial::altToleranceSuppressTrailingZeros, DS.ARGS())
        .def("setAltToleranceSuppressTrailingZeros", &PyAcadDimRadial::setAltToleranceSuppressTrailingZeros, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroFeet", &PyAcadDimRadial::altToleranceSuppressZeroFeet, DS.ARGS())
        .def("setAltToleranceSuppressZeroFeet", &PyAcadDimRadial::setAltToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("altToleranceSuppressZeroInches", &PyAcadDimRadial::altToleranceSuppressZeroInches, DS.ARGS())
        .def("setAltToleranceSuppressZeroInches", &PyAcadDimRadial::setAltToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("suppressZeroFeet", &PyAcadDimRadial::suppressZeroFeet, DS.ARGS())
        .def("setSuppressZeroFeet", &PyAcadDimRadial::setSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("suppressZeroInches", &PyAcadDimRadial::suppressZeroInches, DS.ARGS())
        .def("setSuppressZeroInches", &PyAcadDimRadial::setSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroFeet", &PyAcadDimRadial::toleranceSuppressZeroFeet, DS.ARGS())
        .def("setToleranceSuppressZeroFeet", &PyAcadDimRadial::setToleranceSuppressZeroFeet, DS.ARGS({ "val: bool" }))
        .def("toleranceSuppressZeroInches", &PyAcadDimRadial::toleranceSuppressZeroInches, DS.ARGS())
        .def("setToleranceSuppressZeroInches", &PyAcadDimRadial::setToleranceSuppressZeroInches, DS.ARGS({ "val: bool" }))
        .def("dimensionLineWeight", &PyAcadDimRadial::dimensionLineWeight, DS.ARGS())
        .def("setDimensionLineWeight", &PyAcadDimRadial::setDimensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("arrowheadSize", &PyAcadDimRadial::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDimRadial::setArrowheadSize, DS.ARGS({ "val: float" }))
        .def("arrowheadType", &PyAcadDimRadial::arrowheadType, DS.ARGS())
        .def("setArrowheadType", &PyAcadDimRadial::setArrowheadType, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("measurement", &PyAcadDimRadial::measurement, DS.ARGS())
        .def("arrowheadBlock", &PyAcadDimRadial::arrowheadBlock, DS.ARGS())
        .def("setArrowheadBlock", &PyAcadDimRadial::setArrowheadBlock, DS.ARGS({ "val: str" }))
        .def("dimensionLinetype", &PyAcadDimRadial::dimensionLinetype, DS.ARGS())
        .def("setDimensionLinetype", &PyAcadDimRadial::setDimensionLinetype, DS.ARGS({ "val: str" }))
        .def("dimConstrForm", &PyAcadDimRadial::dimConstrForm, DS.ARGS())
        .def("setDimConstrForm", &PyAcadDimRadial::setDimConstrForm, DS.ARGS({ "val: bool" }))
        .def("dimConstrReference", &PyAcadDimRadial::dimConstrReference, DS.ARGS())
        .def("setDimConstrReference", &PyAcadDimRadial::setDimConstrReference, DS.ARGS({ "val: bool" }))
        .def("dimConstrName", &PyAcadDimRadial::dimConstrName, DS.ARGS())
        .def("setDimConstrName", &PyAcadDimRadial::setDimConstrName, DS.ARGS({ "val: str" }))
        .def("dimConstrExpression", &PyAcadDimRadial::dimConstrExpression, DS.ARGS())
        .def("setDimConstrExpression", &PyAcadDimRadial::setDimConstrExpression, DS.ARGS({ "val: str" }))
        .def("dimConstrValue", &PyAcadDimRadial::dimConstrValue, DS.ARGS())
        .def("setDimConstrValue", &PyAcadDimRadial::setDimConstrValue, DS.ARGS({ "val: str" }))
        .def("dimConstrDesc", &PyAcadDimRadial::dimConstrDesc, DS.ARGS())
        .def("setDimConstrDesc", &PyAcadDimRadial::setDimConstrDesc, DS.ARGS({ "val: str" }))
...
void makePyAcadDim3PointAngularWrapper()
{
    ...
    class_<PyAcadDim3PointAngular, bases<PyAcadDimension>>("AcadDim3PointAngular", boost::python::no_init)
        ...
        .def("setExtLine1EndPoint", &PyAcadDim3PointAngular::setExtLine1EndPoint, DS.ARGS({ "val: PyGe.Point3d" }))
        .def("extLine2EndPoint", &PyAcadDim3PointAngular::extLine2EndPoint, DS.ARGS())
        .def("setExtLine2EndPoint", &PyAcadDim3PointAngular::setExtLine2EndPoint, DS.ARGS({ "val: PyGe.Point3d" }))
        .def("angleVertex", &PyAcadDim3PointAngular::angleVertex, DS.ARGS())
        .def("setAngleVertex", &PyAcadDim3PointAngular::setAngleVertex, DS.ARGS({ "val: PyGe.Point3d" }))
        .def("textPrecision", &PyAcadDim3PointAngular::textPrecision, DS.ARGS())
        .def("setTextPrecision", &PyAcadDim3PointAngular::setTextPrecision, DS.ARGS({ "val: PyAx.AcDimPrecisionint3d" }))
        .def("angleFormat", &PyAcadDim3PointAngular::angleFormat, DS.ARGS())
        .def("setAngleFormat", &PyAcadDim3PointAngular::setAngleFormat, DS.ARGS({ "val: PyAx.AngleUnits" }))
        .def("dimensionLineColor", &PyAcadDim3PointAngular::dimensionLineColor, DS.ARGS())
        .def("setDimensionLineColor", &PyAcadDim3PointAngular::setDimensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("extensionLineColor", &PyAcadDim3PointAngular::extensionLineColor, DS.ARGS())
        .def("setExtensionLineColor", &PyAcadDim3PointAngular::setExtensionLineColor, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("extensionLineExtend", &PyAcadDim3PointAngular::extensionLineExtend, DS.ARGS())
        .def("setExtensionLineExtend", &PyAcadDim3PointAngular::setExtensionLineExtend, DS.ARGS({ "val: PyAx.AcColor" }))
        .def("fit", &PyAcadDim3PointAngular::fit, DS.ARGS())
        .def("setFit", &PyAcadDim3PointAngular::setFit, DS.ARGS({ "val: PyAx.AcDimFit" }))
        .def("horizontalTextPosition", &PyAcadDim3PointAngular::horizontalTextPosition, DS.ARGS())
        .def("setHorizontalTextPosition", &PyAcadDim3PointAngular::setHorizontalTextPosition, DS.ARGS({ "val: PyAx.AcDimHorizontalJustification" }))
        .def("extensionLineWeight", &PyAcadDim3PointAngular::extensionLineWeight, DS.ARGS())
        .def("setExtensionLineWeight", &PyAcadDim3PointAngular::setExtensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("dimLine1Suppress", &PyAcadDim3PointAngular::dimLine1Suppress, DS.ARGS())
        .def("setDimLine1Suppress", &PyAcadDim3PointAngular::setDimLine1Suppress, DS.ARGS({ "val: bool" }))
        .def("dimLine2Suppress", &PyAcadDim3PointAngular::dimLine2Suppress, DS.ARGS())
        .def("setDimLine2Suppress", &PyAcadDim3PointAngular::setDimLine2Suppress, DS.ARGS({ "val: bool" }))
        .def("extLine1Suppress", &PyAcadDim3PointAngular::extLine1Suppress, DS.ARGS())
        .def("setExtLine1Suppress", &PyAcadDim3PointAngular::setExtLine1Suppress, DS.ARGS({ "val: bool" }))
        .def("extLine2Suppress", &PyAcadDim3PointAngular::extLine2Suppress, DS.ARGS())
        .def("setExtLine2Suppress", &PyAcadDim3PointAngular::setExtLine2Suppress, DS.ARGS({ "val: bool" }))
        .def("dimLineInside", &PyAcadDim3PointAngular::dimLineInside, DS.ARGS())
        .def("setDimLineInside", &PyAcadDim3PointAngular::setDimLineInside, DS.ARGS({ "val: bool" }))
        .def("textInsideAlign", &PyAcadDim3PointAngular::textInsideAlign, DS.ARGS())
        .def("setTextInsideAlign", &PyAcadDim3PointAngular::setTextInsideAlign, DS.ARGS({ "val: bool" }))
        .def("textInside", &PyAcadDim3PointAngular::textInside, DS.ARGS())
        .def("setTextInside", &PyAcadDim3PointAngular::setTextInside, DS.ARGS({ "val: bool" }))
        .def("forceLineInside", &PyAcadDim3PointAngular::forceLineInside, DS.ARGS())
        .def("setForceLineInside", &PyAcadDim3PointAngular::setForceLineInside, DS.ARGS({ "val: bool" }))
        .def("textOutsideAlign", &PyAcadDim3PointAngular::textOutsideAlign, DS.ARGS())
        .def("setTextOutsideAlign", &PyAcadDim3PointAngular::setTextOutsideAlign, DS.ARGS({ "val: bool" }))
        .def("extensionLineOffset", &PyAcadDim3PointAngular::extensionLineOffset, DS.ARGS())
        .def("setExtensionLineOffset", &PyAcadDim3PointAngular::setExtensionLineOffset, DS.ARGS({ "val: float" }))
        .def("dimensionLineWeight", &PyAcadDim3PointAngular::dimensionLineWeight, DS.ARGS())
        .def("setDimensionLineWeight", &PyAcadDim3PointAngular::setDimensionLineWeight, DS.ARGS({ "val: PyAx.AcLineWeight" }))
        .def("arrowheadSize", &PyAcadDim3PointAngular::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDim3PointAngular::setArrowheadSize, DS.ARGS({ "val: float" }))
        .def("arrowhead1Type", &PyAcadDim3PointAngular::arrowhead1Type, DS.ARGS())
        .def("setArrowhead1Type", &PyAcadDim3PointAngular::setArrowhead1Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        .def("arrowhead2Type", &PyAcadDim3PointAngular::arrowhead2Type, DS.ARGS())
        .def("setArrowhead2Type", &PyAcadDim3PointAngular::setArrowhead2Type, DS.ARGS({ "val: PyAx.AcDimArrowheadType" }))
        ...
        .def("setArrowhead1Block", &PyAcadDim3PointAngular::setArrowhead1Block, DS.ARGS({ "val: str" }))
        .def("arrowhead2Block", &PyAcadDim3PointAngular::arrowhead2Block, DS.ARGS())
        .def("setArrowhead2Block", &PyAcadDim3PointAngular::setArrowhead2Block, DS.ARGS({ "val: str" }))
        .def("dimensionLinetype", &PyAcadDim3PointAngular::dimensionLinetype, DS.ARGS())
        .def("setDimensionLinetype", &PyAcadDim3PointAngular::setDimensionLinetype, DS.ARGS({ "val: str" }))
        .def("extLine1Linetype", &PyAcadDim3PointAngular::extLine1Linetype, DS.ARGS())
        .def("setExtLine1Linetype", &PyAcadDim3PointAngular::setExtLine1Linetype, DS.ARGS({ "val: str" }))
        .def("extLine2Linetype", &PyAcadDim3PointAngular::extLine2Linetype, DS.ARGS())
        .def("setExtLine2Linetype", &PyAcadDim3PointAngular::setExtLine2Linetype, DS.ARGS({ "val: str" }))
        .def("dimConstrName", &PyAcadDim3PointAngular::dimConstrName, DS.ARGS())
        .def("setDimConstrName", &PyAcadDim3PointAngular::setDimConstrName, DS.ARGS({ "val: str" }))
        .def("dimConstrExpression", &PyAcadDim3PointAngular::dimConstrExpression, DS.ARGS())
        .def("setDimConstrExpression", &PyAcadDim3PointAngular::setDimConstrExpression, DS.ARGS({ "val: str" }))
        .def("dimConstrValue", &PyAcadDim3PointAngular::dimConstrValue, DS.ARGS())
        .def("setDimConstrValue", &PyAcadDim3PointAngular::setDimConstrValue, DS.ARGS({ "val: str" }))
        .def("dimConstrDesc", &PyAcadDim3PointAngular::dimConstrDesc, DS.ARGS())
        .def("setDimConstrDesc", &PyAcadDim3PointAngular::setDimConstrDesc, DS.ARGS({ "val: str" }))
        .def("extLineFixedLenSuppress", &PyAcadDim3PointAngular::extLineFixedLenSuppress, DS.ARGS())
        .def("setExtLineFixedLenSuppress", &PyAcadDim3PointAngular::setExtLineFixedLenSuppress, DS.ARGS({ "val: bool" }))
        .def("extLineFixedLen", &PyAcadDim3PointAngular::extLineFixedLen, DS.ARGS())
        .def("setExtLineFixedLen", &PyAcadDim3PointAngular::setExtLineFixedLen, DS.ARGS({ "val: float" }))
        .def("dimConstrForm", &PyAcadDim3PointAngular::dimConstrForm, DS.ARGS())
        .def("setDimConstrForm", &PyAcadDim3PointAngular::setDimConstrForm, DS.ARGS({ "val: bool" }))
        .def("dimConstrReference", &PyAcadDim3PointAngular::dimConstrReference, DS.ARGS())
        .def("setDimConstrReference", &PyAcadDim3PointAngular::setDimConstrReference, DS.ARGS({ "val: bool" }))
...
void makePyAcadDimArcLengthWrapper()
{
    ...
    class_<PyAcadDimArcLength, bases<PyAcadDimension>>("AcadDimArcLength", boost::python::no_init)
        ...
        .def("setAltUnits", &PyAcadDimArcLength::setAltUnits, DS.ARGS({ "val:bool" }))
        .def("altUnitsPrecision", &PyAcadDimArcLength::altUnitsPrecision, DS.ARGS())
        .def("setAltUnitsPrecision", &PyAcadDimArcLength::setAltUnitsPrecision, DS.ARGS({ "val:PyAx.AcDimPrecision" }))
        .def("altUnitsScale", &PyAcadDimArcLength::altUnitsScale, DS.ARGS())
        .def("setAltUnitsScale", &PyAcadDimArcLength::setAltUnitsScale, DS.ARGS({ "val:float" }))
        .def("altRoundDistance", &PyAcadDimArcLength::altRoundDistance, DS.ARGS())
        .def("setAltRoundDistance", &PyAcadDimArcLength::setAltRoundDistance, DS.ARGS({ "val:float" }))
        .def("altTolerancePrecision", &PyAcadDimArcLength::altTolerancePrecision, DS.ARGS())
        .def("setAltTolerancePrecision", &PyAcadDimArcLength::setAltTolerancePrecision, DS.ARGS({ "val:PyAx.AcDimPrecision" }))
        .def("altUnitsFormat", &PyAcadDimArcLength::altUnitsFormat, DS.ARGS())
        .def("setAltUnitsFormat", &PyAcadDimArcLength::setAltUnitsFormat, DS.ARGS({ "val:PyAx.AcDimUnits" }))
        .def("altTextPrefix", &PyAcadDimArcLength::altTextPrefix, DS.ARGS())
        .def("setAltTextPrefix", &PyAcadDimArcLength::setAltTextPrefix, DS.ARGS({ "val:str" }))
        .def("altTextSuffix", &PyAcadDimArcLength::altTextSuffix, DS.ARGS())
        .def("setAltTextSuffix", &PyAcadDimArcLength::setAltTextSuffix, DS.ARGS({ "val:str" }))
        .def("dimensionLineColor", &PyAcadDimArcLength::dimensionLineColor, DS.ARGS())
        .def("setDimensionLineColor", &PyAcadDimArcLength::setDimensionLineColor, DS.ARGS({ "val:PyAx.AcColor" }))
        .def("extensionLineColor", &PyAcadDimArcLength::extensionLineColor, DS.ARGS())
        .def("setExtensionLineColor", &PyAcadDimArcLength::setExtensionLineColor, DS.ARGS({ "val:PyAx.AcColor" }))
        .def("primaryUnitsPrecision", &PyAcadDimArcLength::primaryUnitsPrecision, DS.ARGS())
        .def("setPrimaryUnitsPrecision", &PyAcadDimArcLength::setPrimaryUnitsPrecision, DS.ARGS({ "val:PyAx.AcDimPrecision" }))
        .def("dimensionLineExtend", &PyAcadDimArcLength::dimensionLineExtend, DS.ARGS())
        .def("setDimensionLineExtend", &PyAcadDimArcLength::setDimensionLineExtend, DS.ARGS({ "val: float" }))
        .def("extensionLineExtend", &PyAcadDimArcLength::extensionLineExtend, DS.ARGS())
        .def("setExtensionLineExtend", &PyAcadDimArcLength::setExtensionLineExtend, DS.ARGS({ "val: float" }))
        .def("fit", &PyAcadDimArcLength::fit, DS.ARGS())
        .def("setFit", &PyAcadDimArcLength::setFit, DS.ARGS({ "val: PyAx.AcDimFit" }))
        .def("fractionFormat", &PyAcadDimArcLength::fractionFormat, DS.ARGS())
        .def("setFractionFormat", &PyAcadDimArcLength::setFractionFormat, DS.ARGS({ "val: PyAx.AcDimFractionType" }))
        .def("horizontalTextPosition", &PyAcadDimArcLength::horizontalTextPosition, DS.ARGS())
        .def("setHorizontalTextPosition", &PyAcadDimArcLength::setHorizontalTextPosition, DS.ARGS({ "val: PyAx.AcDimHorizontalJustification" }))
        .def("linearScaleFactor", &PyAcadDimArcLength::linearScaleFactor, DS.ARGS())
        .def("setLinearScaleFactor", &PyAcadDimArcLength::setLinearScaleFactor, DS.ARGS({ "val:float" }))
        .def("unitsFormat", &PyAcadDimArcLength::unitsFormat, DS.ARGS())
        .def("setUnitsFormat", &PyAcadDimArcLength::setUnitsFormat, DS.ARGS({ "val:PyAx.AcDimLUnits" }))
        .def("extensionLineWeight", &PyAcadDimArcLength::extensionLineWeight, DS.ARGS())
        .def("setExtensionLineWeight", &PyAcadDimArcLength::setExtensionLineWeight, DS.ARGS({ "val:PyAx.AcLineWeight" }))
        .def("roundDistance", &PyAcadDimArcLength::roundDistance, DS.ARGS())
        .def("setRoundDistance", &PyAcadDimArcLength::setRoundDistance, DS.ARGS({ "val:float" }))
        .def("dimLine1Suppress", &PyAcadDimArcLength::dimLine1Suppress, DS.ARGS())
        .def("setDimLine1Suppress", &PyAcadDimArcLength::setDimLine1Suppress, DS.ARGS({ "val:bool" }))
        .def("dimLine2Suppress", &PyAcadDimArcLength::dimLine2Suppress, DS.ARGS())
        .def("setDimLine2Suppress", &PyAcadDimArcLength::setDimLine2Suppress, DS.ARGS({ "val:bool" }))
        .def("extLine1Suppress", &PyAcadDimArcLength::extLine1Suppress, DS.ARGS())
        .def("setExtLine1Suppress", &PyAcadDimArcLength::setExtLine1Suppress, DS.ARGS({ "val:bool" }))
        .def("extLine2Suppress", &PyAcadDimArcLength::extLine2Suppress, DS.ARGS())
        .def("setExtLine2Suppress", &PyAcadDimArcLength::setExtLine2Suppress, DS.ARGS({ "val:bool" }))
        .def("dimLineInside", &PyAcadDimArcLength::dimLineInside, DS.ARGS())
        .def("setDimLineInside", &PyAcadDimArcLength::setDimLineInside, DS.ARGS({ "val:bool" }))
        .def("textInsideAlign", &PyAcadDimArcLength::textInsideAlign, DS.ARGS())
        .def("setTextInsideAlign", &PyAcadDimArcLength::setTextInsideAlign, DS.ARGS({ "val:bool" }))
        .def("textInside", &PyAcadDimArcLength::textInside, DS.ARGS())
        .def("setTextInside", &PyAcadDimArcLength::setTextInside, DS.ARGS({ "val:bool" }))
        .def("forceLineInside", &PyAcadDimArcLength::forceLineInside, DS.ARGS())
        .def("setForceLineInside", &PyAcadDimArcLength::setForceLineInside, DS.ARGS({ "val:bool" }))
        .def("textOutsideAlign", &PyAcadDimArcLength::textOutsideAlign, DS.ARGS())
        .def("setTextOutsideAlign", &PyAcadDimArcLength::setTextOutsideAlign, DS.ARGS({ "val:bool" }))
        .def("extensionLineOffset", &PyAcadDimArcLength::extensionLineOffset, DS.ARGS())
        .def("setExtensionLineOffset", &PyAcadDimArcLength::setExtensionLineOffset, DS.ARGS({ "val:float" }))
        .def("altSuppressLeadingZeros", &PyAcadDimArcLength::altSuppressLeadingZeros, DS.ARGS())
        .def("setAltSuppressLeadingZeros", &PyAcadDimArcLength::setAltSuppressLeadingZeros, DS.ARGS({ "val:bool" }))
        .def("altSuppressTrailingZeros", &PyAcadDimArcLength::altSuppressTrailingZeros, DS.ARGS())
        .def("setAltSuppressTrailingZeros", &PyAcadDimArcLength::setAltSuppressTrailingZeros, DS.ARGS({ "val:bool" }))
        .def("altSuppressZeroFeet", &PyAcadDimArcLength::altSuppressZeroFeet, DS.ARGS())
        .def("setAltSuppressZeroFeet", &PyAcadDimArcLength::setAltSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("altSuppressZeroInches", &PyAcadDimArcLength::altSuppressZeroInches, DS.ARGS())
        .def("setAltSuppressZeroInches", &PyAcadDimArcLength::setAltSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressLeadingZeros", &PyAcadDimArcLength::altToleranceSuppressLeadingZeros, DS.ARGS())
        .def("setAltToleranceSuppressLeadingZeros", &PyAcadDimArcLength::setAltToleranceSuppressLeadingZeros, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressTrailingZeros", &PyAcadDimArcLength::altToleranceSuppressTrailingZeros, DS.ARGS())
        .def("setAltToleranceSuppressTrailingZeros", &PyAcadDimArcLength::setAltToleranceSuppressTrailingZeros, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressZeroFeet", &PyAcadDimArcLength::altToleranceSuppressZeroFeet, DS.ARGS())
        .def("setAltToleranceSuppressZeroFeet", &PyAcadDimArcLength::setAltToleranceSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressZeroInches", &PyAcadDimArcLength::altToleranceSuppressZeroInches, DS.ARGS())
        .def("setAltToleranceSuppressZeroInches", &PyAcadDimArcLength::setAltToleranceSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("suppressZeroFeet", &PyAcadDimArcLength::suppressZeroFeet, DS.ARGS())
        .def("setSuppressZeroFeet", &PyAcadDimArcLength::setSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("suppressZeroInches", &PyAcadDimArcLength::suppressZeroInches, DS.ARGS())
        .def("setSuppressZeroInches", &PyAcadDimArcLength::setSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("toleranceSuppressZeroFeet", &PyAcadDimArcLength::toleranceSuppressZeroFeet, DS.ARGS())
        .def("setToleranceSuppressZeroFeet", &PyAcadDimArcLength::setToleranceSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("toleranceSuppressZeroInches", &PyAcadDimArcLength::toleranceSuppressZeroInches, DS.ARGS())
        .def("setToleranceSuppressZeroInches", &PyAcadDimArcLength::setToleranceSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("dimensionLineWeight", &PyAcadDimArcLength::dimensionLineWeight, DS.ARGS())
        .def("setDimensionLineWeight", &PyAcadDimArcLength::setDimensionLineWeight, DS.ARGS({ "val:PyAx.AcLineWeight" }))
        .def("arrowheadSize", &PyAcadDimArcLength::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDimArcLength::setArrowheadSize, DS.ARGS({ "val:float" }))
        .def("arrowhead1Type", &PyAcadDimArcLength::arrowhead1Type, DS.ARGS())
        .def("setArrowhead1Type", &PyAcadDimArcLength::setArrowhead1Type, DS.ARGS({ "val:PyAx.AcDimArrowheadType" }))
        .def("arrowhead2Type", &PyAcadDimArcLength::arrowhead2Type, DS.ARGS())
        .def("setArrowhead2Type", &PyAcadDimArcLength::setArrowhead2Type, DS.ARGS({ "val:PyAx.AcDimArrowheadType" }))
        .def("measurement", &PyAcadDimArcLength::measurement, DS.ARGS())
        .def("arrowhead1Block", &PyAcadDimArcLength::arrowhead1Block, DS.ARGS())
        .def("setArrowhead1Block", &PyAcadDimArcLength::setArrowhead1Block, DS.ARGS({ "val:str" }))
        .def("arrowhead2Block", &PyAcadDimArcLength::arrowhead2Block, DS.ARGS())
        .def("setArrowhead2Block", &PyAcadDimArcLength::setArrowhead2Block, DS.ARGS({ "val:str" }))
        .def("dimensionLinetype", &PyAcadDimArcLength::dimensionLinetype, DS.ARGS())
        .def("setDimensionLinetype", &PyAcadDimArcLength::setDimensionLinetype, DS.ARGS({ "val:str" }))
        .def("extLine1Linetype", &PyAcadDimArcLength::extLine1Linetype, DS.ARGS())
        .def("setExtLine1Linetype", &PyAcadDimArcLength::setExtLine1Linetype, DS.ARGS({ "val:str" }))
        .def("extLine2Linetype", &PyAcadDimArcLength::extLine2Linetype, DS.ARGS())
        .def("setExtLine2Linetype", &PyAcadDimArcLength::setExtLine2Linetype, DS.ARGS({ "val:str" }))
        .def("subUnitsSuffix", &PyAcadDimArcLength::subUnitsSuffix, DS.ARGS())
        .def("setSubUnitsSuffix", &PyAcadDimArcLength::setSubUnitsSuffix, DS.ARGS({ "val:str" }))
        .def("altSubUnitsSuffix", &PyAcadDimArcLength::altSubUnitsSuffix, DS.ARGS())
        .def("setAltSubUnitsSuffix", &PyAcadDimArcLength::setAltSubUnitsSuffix, DS.ARGS({ "val:str" }))
        .def("extLineFixedLenSuppress", &PyAcadDimArcLength::extLineFixedLenSuppress, DS.ARGS())
        .def("setExtLineFixedLenSuppress", &PyAcadDimArcLength::setExtLineFixedLenSuppress, DS.ARGS({ "val:bool" }))
        .def("extLineFixedLen", &PyAcadDimArcLength::extLineFixedLen, DS.ARGS())
        .def("setExtLineFixedLen", &PyAcadDimArcLength::setExtLineFixedLen, DS.ARGS({ "val:float" }))
        .def("subUnitsFactor", &PyAcadDimArcLength::subUnitsFactor, DS.ARGS())
        .def("setSubUnitsFactor", &PyAcadDimArcLength::setSubUnitsFactor, DS.ARGS({ "val:float" }))
        .def("altSubUnitsFactor", &PyAcadDimArcLength::altSubUnitsFactor, DS.ARGS())
        .def("setAltSubUnitsFactor", &PyAcadDimArcLength::setAltSubUnitsFactor, DS.ARGS({ "val:float" }))
        .def("arcPoint", &PyAcadDimArcLength::arcPoint, DS.ARGS())
        .def("setArcPoint", &PyAcadDimArcLength::setArcPoint, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("extLine1Point", &PyAcadDimArcLength::extLine1Point, DS.ARGS())
        .def("setExtLine1Point", &PyAcadDimArcLength::setExtLine1Point, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("extLine2Point", &PyAcadDimArcLength::extLine2Point, DS.ARGS())
        .def("setExtLine2Point", &PyAcadDimArcLength::setExtLine2Point, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("centerPoint", &PyAcadDimArcLength::centerPoint, DS.ARGS())
        .def("setCenterPoint", &PyAcadDimArcLength::setCenterPoint, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("leader1Point", &PyAcadDimArcLength::leader1Point, DS.ARGS())
        .def("setLeader1Point", &PyAcadDimArcLength::setLeader1Point, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("leader2Point", &PyAcadDimArcLength::leader2Point, DS.ARGS())
        .def("setLeader2Point", &PyAcadDimArcLength::setLeader2Point, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("isPartial", &PyAcadDimArcLength::isPartial, DS.ARGS())
        .def("setIsPartial", &PyAcadDimArcLength::setIsPartial, DS.ARGS({ "val:bool" }))
        .def("arcStartParam", &PyAcadDimArcLength::arcStartParam, DS.ARGS())
        .def("setArcStartParam", &PyAcadDimArcLength::setArcStartParam, DS.ARGS({ "val:float" }))
        .def("arcEndParam", &PyAcadDimArcLength::arcEndParam, DS.ARGS())
        .def("setArcEndParam", &PyAcadDimArcLength::setArcEndParam, DS.ARGS({ "val:float" }))
        .def("hasLeader", &PyAcadDimArcLength::hasLeader, DS.ARGS())
        .def("setHasLeader", &PyAcadDimArcLength::setHasLeader, DS.ARGS({ "val:bool" }))
        .def("symbolPosition", &PyAcadDimArcLength::symbolPosition, DS.ARGS())
        .def("setSymbolPosition", &PyAcadDimArcLength::setSymbolPosition, DS.ARGS({ "val:PyAx.AcDimArcLengthSymbol" }))
...
void makePyAcadDimRadialLargeWrapper()
{
    ...
    class_<PyAcadDimRadialLarge, bases<PyAcadDimension>>("AcadDimRadialLarge", boost::python::no_init)
        ...
        .def("setAltUnits", &PyAcadDimRadialLarge::setAltUnits, DS.ARGS({ "val:bool" }))
        .def("altUnitsPrecision", &PyAcadDimRadialLarge::altUnitsPrecision, DS.ARGS())
        .def("setAltUnitsPrecision", &PyAcadDimRadialLarge::setAltUnitsPrecision, DS.ARGS({ "val:PyAx.AcDimPrecision" }))
        .def("altUnitsScale", &PyAcadDimRadialLarge::altUnitsScale, DS.ARGS())
        .def("setAltUnitsScale", &PyAcadDimRadialLarge::setAltUnitsScale, DS.ARGS({ "val:float" }))
        .def("altRoundDistance", &PyAcadDimRadialLarge::altRoundDistance, DS.ARGS())
        .def("setAltRoundDistance", &PyAcadDimRadialLarge::setAltRoundDistance, DS.ARGS({ "val:float" }))
        .def("altTolerancePrecision", &PyAcadDimRadialLarge::altTolerancePrecision, DS.ARGS())
        .def("setAltTolerancePrecision", &PyAcadDimRadialLarge::setAltTolerancePrecision, DS.ARGS({ "val:PyAx.AcDimPrecision" }))
        .def("altUnitsFormat", &PyAcadDimRadialLarge::altUnitsFormat, DS.ARGS())
        .def("setAltUnitsFormat", &PyAcadDimRadialLarge::setAltUnitsFormat, DS.ARGS({ "val:PyAx.AcDimUnits" }))
        .def("altTextPrefix", &PyAcadDimRadialLarge::altTextPrefix, DS.ARGS())
        .def("setAltTextPrefix", &PyAcadDimRadialLarge::setAltTextPrefix, DS.ARGS({ "val:str" }))
        .def("altTextSuffix", &PyAcadDimRadialLarge::altTextSuffix, DS.ARGS())
        .def("setAltTextSuffix", &PyAcadDimRadialLarge::setAltTextSuffix, DS.ARGS({ "val:str" }))
        .def("centerType", &PyAcadDimRadialLarge::centerType, DS.ARGS())
        .def("setCenterType", &PyAcadDimRadialLarge::setCenterType, DS.ARGS({ "val:PyAx.AcDimCenterType" }))
        .def("centerMarkSize", &PyAcadDimRadialLarge::centerMarkSize, DS.ARGS())
        .def("setCenterMarkSize", &PyAcadDimRadialLarge::setCenterMarkSize, DS.ARGS({ "val:float" }))
        .def("dimensionLineColor", &PyAcadDimRadialLarge::dimensionLineColor, DS.ARGS())
        .def("setDimensionLineColor", &PyAcadDimRadialLarge::setDimensionLineColor, DS.ARGS({ "val:PyAx.AcColor" }))
        .def("primaryUnitsPrecision", &PyAcadDimRadialLarge::primaryUnitsPrecision, DS.ARGS())
        .def("setPrimaryUnitsPrecision", &PyAcadDimRadialLarge::setPrimaryUnitsPrecision, DS.ARGS({ "val:PyAx.AcDimPrecision" }))
        .def("fractionFormat", &PyAcadDimRadialLarge::fractionFormat, DS.ARGS())
        .def("setFractionFormat", &PyAcadDimRadialLarge::setFractionFormat, DS.ARGS({ "val:PyAx.AcDimFractionType" }))
        .def("fit", &PyAcadDimRadialLarge::fit, DS.ARGS())
        .def("setFit", &PyAcadDimRadialLarge::setFit, DS.ARGS({ "val:PyAx.AcDimFit" }))
        .def("linearScaleFactor", &PyAcadDimRadialLarge::linearScaleFactor, DS.ARGS())
        .def("setLinearScaleFactor", &PyAcadDimRadialLarge::setLinearScaleFactor, DS.ARGS({ "val:float" }))
        .def("unitsFormat", &PyAcadDimRadialLarge::unitsFormat, DS.ARGS())
        .def("setUnitsFormat", &PyAcadDimRadialLarge::setUnitsFormat, DS.ARGS({ "val:PyAx.AcDimLUnits" }))
        .def("roundDistance", &PyAcadDimRadialLarge::roundDistance, DS.ARGS())
        .def("setRoundDistance", &PyAcadDimRadialLarge::setRoundDistance, DS.ARGS({ "val:float" }))
        .def("dimLineSuppress", &PyAcadDimRadialLarge::dimLineSuppress, DS.ARGS())
        .def("setDimLineSuppress", &PyAcadDimRadialLarge::setDimLineSuppress, DS.ARGS({ "val:bool" }))
        .def("textInsideAlign", &PyAcadDimRadialLarge::textInsideAlign, DS.ARGS())
        .def("setTextInsideAlign", &PyAcadDimRadialLarge::setTextInsideAlign, DS.ARGS({ "val:bool" }))
        .def("textInside", &PyAcadDimRadialLarge::textInside, DS.ARGS())
        .def("setTextInside", &PyAcadDimRadialLarge::setTextInside, DS.ARGS({ "val:bool" }))
        .def("forceLineInside", &PyAcadDimRadialLarge::forceLineInside, DS.ARGS())
        .def("setForceLineInside", &PyAcadDimRadialLarge::setForceLineInside, DS.ARGS({ "val:bool" }))
        .def("textOutsideAlign", &PyAcadDimRadialLarge::textOutsideAlign, DS.ARGS())
        .def("setTextOutsideAlign", &PyAcadDimRadialLarge::setTextOutsideAlign, DS.ARGS({ "val:bool" }))
        .def("altSuppressLeadingZeros", &PyAcadDimRadialLarge::altSuppressLeadingZeros, DS.ARGS())
        .def("setAltSuppressLeadingZeros", &PyAcadDimRadialLarge::setAltSuppressLeadingZeros, DS.ARGS({ "val:bool" }))
        .def("altSuppressTrailingZeros", &PyAcadDimRadialLarge::altSuppressTrailingZeros, DS.ARGS())
        .def("setAltSuppressTrailingZeros", &PyAcadDimRadialLarge::setAltSuppressTrailingZeros, DS.ARGS({ "val:bool" }))
        .def("altSuppressZeroFeet", &PyAcadDimRadialLarge::altSuppressZeroFeet, DS.ARGS())
        .def("setAltSuppressZeroFeet", &PyAcadDimRadialLarge::setAltSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("altSuppressZeroInches", &PyAcadDimRadialLarge::altSuppressZeroInches, DS.ARGS())
        .def("setAltSuppressZeroInches", &PyAcadDimRadialLarge::setAltSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressLeadingZeros", &PyAcadDimRadialLarge::altToleranceSuppressLeadingZeros, DS.ARGS())
        .def("setAltToleranceSuppressLeadingZeros", &PyAcadDimRadialLarge::setAltToleranceSuppressLeadingZeros, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressTrailingZeros", &PyAcadDimRadialLarge::altToleranceSuppressTrailingZeros, DS.ARGS())
        .def("setAltToleranceSuppressTrailingZeros", &PyAcadDimRadialLarge::setAltToleranceSuppressTrailingZeros, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressZeroFeet", &PyAcadDimRadialLarge::altToleranceSuppressZeroFeet, DS.ARGS())
        .def("setAltToleranceSuppressZeroFeet", &PyAcadDimRadialLarge::setAltToleranceSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("altToleranceSuppressZeroInches", &PyAcadDimRadialLarge::altToleranceSuppressZeroInches, DS.ARGS())
        .def("setAltToleranceSuppressZeroInches", &PyAcadDimRadialLarge::setAltToleranceSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("suppressZeroFeet", &PyAcadDimRadialLarge::suppressZeroFeet, DS.ARGS())
        .def("setSuppressZeroFeet", &PyAcadDimRadialLarge::setSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("suppressZeroInches", &PyAcadDimRadialLarge::suppressZeroInches, DS.ARGS())
        .def("setSuppressZeroInches", &PyAcadDimRadialLarge::setSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("toleranceSuppressZeroFeet", &PyAcadDimRadialLarge::toleranceSuppressZeroFeet, DS.ARGS())
        .def("setToleranceSuppressZeroFeet", &PyAcadDimRadialLarge::setToleranceSuppressZeroFeet, DS.ARGS({ "val:bool" }))
        .def("toleranceSuppressZeroInches", &PyAcadDimRadialLarge::toleranceSuppressZeroInches, DS.ARGS())
        .def("setToleranceSuppressZeroInches", &PyAcadDimRadialLarge::setToleranceSuppressZeroInches, DS.ARGS({ "val:bool" }))
        .def("dimensionLineWeight", &PyAcadDimRadialLarge::dimensionLineWeight, DS.ARGS())
        .def("setDimensionLineWeight", &PyAcadDimRadialLarge::setDimensionLineWeight, DS.ARGS({ "val:PyAx.AcLineWeight" }))
        .def("arrowheadSize", &PyAcadDimRadialLarge::arrowheadSize, DS.ARGS())
        .def("setArrowheadSize", &PyAcadDimRadialLarge::setArrowheadSize, DS.ARGS({ "val:float" }))
        .def("arrowheadType", &PyAcadDimRadialLarge::arrowheadType, DS.ARGS())
        .def("setArrowheadType", &PyAcadDimRadialLarge::setArrowheadType, DS.ARGS({ "val:PyAx.AcDimArrowheadType" }))
        .def("measurement", &PyAcadDimRadialLarge::measurement, DS.ARGS())
        .def("arrowheadBlock", &PyAcadDimRadialLarge::arrowheadBlock, DS.ARGS())
        .def("setArrowheadBlock", &PyAcadDimRadialLarge::setArrowheadBlock, DS.ARGS({ "val:PyAx.AcDimArrowheadType" }))
        .def("overrideCenter", &PyAcadDimRadialLarge::overrideCenter, DS.ARGS())
        .def("setOverrideCenter", &PyAcadDimRadialLarge::setOverrideCenter, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("jogLocation", &PyAcadDimRadialLarge::jogLocation, DS.ARGS())
        .def("setJogLocation", &PyAcadDimRadialLarge::setJogLocation, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("jogAngle", &PyAcadDimRadialLarge::jogAngle, DS.ARGS())
        .def("setJogAngle", &PyAcadDimRadialLarge::setJogAngle, DS.ARGS({ "val:float" }))
        .def("center", &PyAcadDimRadialLarge::center, DS.ARGS())
        .def("setCenter", &PyAcadDimRadialLarge::setCenter, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("chordPoint", &PyAcadDimRadialLarge::chordPoint, DS.ARGS())
        .def("setChordPoint", &PyAcadDimRadialLarge::setChordPoint, DS.ARGS({ "val:PyGe.Point3d" }))
        .def("dimensionLinetype", &PyAcadDimRadialLarge::dimensionLinetype, DS.ARGS())
        .def("setDimensionLinetype", &PyAcadDimRadialLarge::setDimensionLinetype, DS.ARGS({ "val:str" }))
