...
void makePyDbSplineWrapper()
{
    ...
    class_<PyDbSpline, bases<PyDbCurve>>("Spline")
        ...
        .def("setFitData", &PyDbSpline::setFitData, DS.ARGS({ "fitPoints: list[PyGe.Point3d]","degree: int","fitTolerance: float","startTan : PyGe.Vector3d","endTan : PyGe.Vector3d" }))
        ...
        .def("getOffsetCurvesGivenPlaneNormal", &PyDbSpline::getOffsetCurvesGivenPlaneNormal, DS.ARGS({ "normal: PyGe.Vector3d", "dist: float" }, 2784))
