...
public:
    CMemoryDwgFiler();
    virtual ~CMemoryDwgFiler() override = default;
    virtual  Acad::ErrorStatus  filerStatus() const override { return m_stat; };
    virtual  AcDb::FilerType    filerType() const override { return m_filerType; };
    virtual void                setFilerStatus(Acad::ErrorStatus es) override { m_stat = es; }
    virtual void                resetFilerStatus() override { m_stat = Acad::ErrorStatus::eOk; }
    virtual Acad::ErrorStatus   readHardOwnershipId(AcDbHardOwnershipId* pVal) override;
    virtual Acad::ErrorStatus   writeHardOwnershipId(const AcDbHardOwnershipId& val)override;
    virtual Acad::ErrorStatus   readSoftOwnershipId(AcDbSoftOwnershipId* pVal) override;
    virtual Acad::ErrorStatus   writeSoftOwnershipId(const AcDbSoftOwnershipId& val) override;
...
public:
    ...
    AcDb::FilerType     m_filerType = AcDb::kCopyFiler;
    size_t m_index;
    std::vector<FilerToken> m_tokens;
};
