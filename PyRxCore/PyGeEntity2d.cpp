...
void makePyGeEntity2dWrapper()
{
    ...
    class_<PyGeEntity2d>("Entity2d", boost::python::no_init)
        ...
        .def("isEqualTo", &PyGeEntity2d::isEqualTo2, DS.ARGS({ "val : PyGe.Entity2d","tol : PyGe.Tol = ..." }))
        ...
        .def("rotateBy", &PyGeEntity2d::rotateBy2, DS.ARGS({ "angle : float","pt : PyGe.Point2d=PyGe.Point2d.kOrgin" }))
