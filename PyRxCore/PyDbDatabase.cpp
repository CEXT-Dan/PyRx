...
void makePyDbDatabaseWrapper()
{
    ...
    class_<PyDbDatabase, bases<PyRxObject>>("Database")
        ...
        .def("setCePlotStyleName", &PyDbDatabase::setCePlotStyleName, DS.ARGS({ "val : PyDb.PlotStyleNameType", "newId : PyDb.ObjectId" }, 3150))
        ...
        .def("setQtextmode", &PyDbDatabase::setQtextmode, DS.ARGS({ "mode : bool" }, 3259))
        .def("setRealWorldScale", &PyDbDatabase::setRealWorldScale, DS.ARGS({ "realWorldScale : float" }, 3260))
        .def("setRegenmode", &PyDbDatabase::setRegenmode, DS.ARGS({ "mode : bool" }, 3261))
        .def("setRetainOriginalThumbnailBitmap", &PyDbDatabase::setRetainOriginalThumbnailBitmap, DS.ARGS({ "retain : bool" }, 3262))
        ...
        .def("setViewportScaleDefault", &PyDbDatabase::setViewportScaleDefault, DS.ARGS({ "newDefaultVPScale : float" }, 3315))
        ...
        .def("setWorldview", &PyDbDatabase::setWorldview, DS.ARGS({ "view : bool" }, 3319))
        .def("setXclipFrame", &PyDbDatabase::setXclipFrame, DS.ARGS({ "disp : int" }, 3320))
        .def("setXrefEditEnabled", &PyDbDatabase::setXrefEditEnabled, DS.ARGS({ "enable : bool" }, 3321))
