...
public:
    ...
    void                    setSourceObjects(const boost::python::list& ids);
    //PyAcadBlock             destinationBlock();
    //void                    setDestinationBlock(const PyAcadBlock& val);
    std::string             destinationFile() const;
    void                    setDestinationFile(const std::string& val);
    ...
    void                    setIntersectionBoundaryLayer(const std::string& val);
    std::string             intersectionBoundaryLinetype() const;
    void                    setIntersectionBoundaryLinetype(const std::string& val);
    ...
    void                    setIntersectionBoundaryPlotStyleName(const std::string& val);
    ...
    void                    setIntersectionFillHatchPatternName(const std::string& val);
    ...
    void                    setIntersectionFillLayer(const std::string& val);
    std::string             intersectionFillLinetype() const;
    void                    setIntersectionFillLinetype(const std::string& val);
    double                  intersectionFillLinetypeScale() const;
    void                    setIntersectionFillLinetypeScale(double val);
    void                    setIntersectionFillPlotStyleName(const std::string& val);
    ...
    void                    setBackgroundLinesLayer(const std::string& val);
    std::string             backgroundLinesLinetype() const;
    void                    setBackgroundLinesLinetype(const std::string& val);
    ...
    void                    setBackgroundLinesPlotStyleName(const std::string& val);
    ...
    void                    setForegroundLinesLayer(const std::string& val);
    std::string             foregroundLinesLinetype() const;
    void                    setForegroundLinesLinetype(const std::string& val);
    ...
    void                    setForegroundLinesPlotStyleName(const std::string& val);
    ...
    void                    setCurveTangencyLinesLayer(const std::string& val);
    std::string             curveTangencyLinesLinetype() const;
    void                    setCurveTangencyLinesLinetype(const std::string& val);
    ...
    void                    setCurveTangencyLinesPlotStyleName(const std::string& val);
