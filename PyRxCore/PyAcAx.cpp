...
BOOST_PYTHON_MODULE(PyAx)
{
    ...
    enum_<PyAcViewportScale>("AcViewportScale")
        .value("pyacVpScaleToFit", PyAcViewportScale::pyacVpScaleToFit)
        .value("pyacVpCustomScale", PyAcViewportScale::pyacVpCustomScale)
        .value("pyacVp1_1", PyAcViewportScale:: pyacVp1_1)
        .value("pyacVp1_2", PyAcViewportScale:: pyacVp1_2)
        .value("pyacVp1_4", PyAcViewportScale:: pyacVp1_4)
        .value("pyacVp1_5", PyAcViewportScale:: pyacVp1_5)
        .value("pyacVp1_8", PyAcViewportScale:: pyacVp1_8)
        .value("pyacVp1_10", PyAcViewportScale:: pyacVp1_10 )
        .value("pyacVp1_16", PyAcViewportScale:: pyacVp1_16 )
        .value("pyacVp1_20", PyAcViewportScale:: pyacVp1_20 )
        .value("pyacVp1_30", PyAcViewportScale:: pyacVp1_30 )
        .value("pyacVp1_40", PyAcViewportScale:: pyacVp1_40 )
        .value("pyacVp1_50", PyAcViewportScale:: pyacVp1_50 )
        .value("pyacVp1_100", PyAcViewportScale:: pyacVp1_100)
        .value("pyacVp2_1", PyAcViewportScale:: pyacVp2_1)
        .value("pyacVp4_1", PyAcViewportScale:: pyacVp4_1)
        .value("pyacVp8_1", PyAcViewportScale:: pyacVp8_1)
        .value("pyacVp10_1", PyAcViewportScale:: pyacVp10_1)
        .value("pyacVp100_1", PyAcViewportScale::pyacVp100_1)
        .value("pyacVp1_128in_1ft", PyAcViewportScale::pyacVp1_128in_1ft)
        .value("pyacVp1_64in_1ft", PyAcViewportScale::pyacVp1_64in_1ft)
        .value("pyacVp1_32in_1ft", PyAcViewportScale::pyacVp1_32in_1ft)
        .value("pyacVp1_16in_1ft", PyAcViewportScale::pyacVp1_16in_1ft)
        .value("pyacVp3_32in_1ft", PyAcViewportScale::pyacVp3_32in_1ft)
        .value("pyacVp1_8in_1ft", PyAcViewportScale::pyacVp1_8in_1ft)
        .value("pyacVp3_16in_1ft", PyAcViewportScale::pyacVp3_16in_1ft)
        .value("pyacVp1_4in_1ft", PyAcViewportScale::pyacVp1_4in_1ft)
        .value("pyacVp3_8in_1ft", PyAcViewportScale::pyacVp3_8in_1ft)
        .value("pyacVp1_2in_1ft", PyAcViewportScale::pyacVp1_2in_1ft)
        .value("pyacVp3_4in_1ft", PyAcViewportScale::pyacVp3_4in_1ft)
        .value("pyacVp1in_1ft", PyAcViewportScale::pyacVp1in_1ft)
        .value("pyacVp1and1_2in_1ft", PyAcViewportScale::pyacVp1and1_2in_1ft)
        .value("pyacVp3in_1ft", PyAcViewportScale::pyacVp3in_1ft)
        .value("pyacVp6in_1ft", PyAcViewportScale::pyacVp6in_1ft)
        .value("pyacVp1ft_1ft", PyAcViewportScale::pyacVp1ft_1ft)
        .export_values()
        ;
