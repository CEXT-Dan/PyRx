...
class IAcadBlock(DispatchBaseClass):
    ...
    def AddDim3PointAngular(self, AngleVertex=..., FirstEndPoint=..., SecondEndPoint=..., TextPoint=...)->IAcadDim3PointAngular: ...
    def AddDimAligned(self, ExtLine1Point=..., ExtLine2Point=..., TextPosition=...)->IAcadDimAligned: ...
    def AddDimAngular(self, AngleVertex=..., FirstEndPoint=..., SecondEndPoint=..., TextPoint=...)->IAcadDimAngular: ...
    def AddDimArc(self, ArcCenter=..., FirstEndPoint=..., SecondEndPoint=..., ArcPoint=...)->IAcadDimArcLength: ...
    def AddDimDiametric(self, ChordPoint=..., FarChordPoint=..., LeaderLength=...)->IAcadDimDiametric: ...
    def AddDimOrdinate(self, DefinitionPoint=..., LeaderEndPoint=..., UseXAxis=...)->IAcadDimOrdinate: ...
    def AddDimRadial(self, Center=..., ChordPoint=..., LeaderLength=...)->IAcadDimRadial: ...
    def AddDimRadialLarge(self, Center=..., ChordPoint=..., OverrideCenter=..., JogPoint=..., JogAngle=...)->IAcadDimRadialLarge: ...
    def AddDimRotated(self, ExtLine1Point=..., ExtLine2Point=..., DimLineLocation=..., RotationAngle=...)->IAcadDimRotated: ...
    def AddEllipse(self, Center=..., MajorAxis=..., RadiusRatio=...)->IAcadEllipse: ...
    def AddEllipticalCone(self, Center=..., MajorRadius=..., MinorRadius=..., Height=...)->IAcad3DSolid: ...
    def AddEllipticalCylinder(self, Center=..., MajorRadius=..., MinorRadius=..., Height=...)->IAcad3DSolid: ...
    ...
    def AddHatch(self, PatternType=..., PatternName=..., Associativity=..., HatchObjectType=...)->IAcadHatch: ...
    ...
    def AddMInsertBlock(self, InsertionPoint=..., Name=..., Xscale=..., Yscale=..., Zscale=..., Rotation=..., NumRows=..., NumColumns=..., RowSpacing=..., ColumnSpacing=..., Password=...)->IAcadMInsertBlock: ...
    def AddMLeader(self, PointsArray=..., leaderLineIndex=...)->IAcadMLeader: ...
    def AddMLine(self, VertexList=...)->IAcadMLine: ...
    def AddMText(self, InsertionPoint=..., Width=..., Text=...)->IAcadText: ...
    ...
    def AddRaster(self, imageFileName=..., InsertionPoint=..., ScaleFactor=..., RotationAngle=...)->IAcadRasterImage: ...
    def AddRay(self, Point1=..., Point2=...)->IAcadRay: ...
    def AddRegion(self, ObjectList=...)->IAcadRegion: ...
    def AddRevolvedSolid(self, Profile=..., AxisPoint=..., AxisDir=..., Angle=...)->IAcad3DSolid: ...
    def AddSection(self, FromPoint=..., ToPoint=..., planeVector=...)->IAcadSection: ...
    def AddShape(self, Name=..., InsertionPoint=..., ScaleFactor=..., RotationAngle=...)->IAcadShape: ...
    ...
    def AddTable(self, InsertionPoint=..., NumRows=..., NumColumns=..., RowHeight=..., ColWidth=...)->IAcadTable: ...
    ...
    def AttachExternalReference(self, PathName=..., Name=..., InsertionPoint=..., Xscale=..., Yscale=..., Zscale=..., Rotation=..., bOverlay=..., Password=...)->IAcadExternalReference: ...
    ...
    def GetExtensionDictionary(self): ...
    def GetXData(self, AppName=..., XDataType=..., XDataValue=...): ...
    def InsertBlock(self, InsertionPoint=..., Name=..., Xscale=..., Yscale=..., Zscale=..., Rotation=..., Password=...)->IAcadBlockReference: ...
    def Item(self, Index=...): ...
    def Reload(self): ...
    def SetXData(self, XDataType=..., XDataValue=...): ...
    def Unload(self): ...
