...
class Constraint:
    ...
    def setMeasurementMode(self, flag:PyBrx.ConstraintMeasurementMode, argIndex:int, /) -> None: ...
...
class ConstraintArgument:
    ...
    @overload
    def __init__(self, subpath: PyDb.FullSubentPath, val: PyBrx.ConstraintArgCoordSysObj, /) -> None: ...
    @overload
...
class ConstraintsGroup:
    def __init__(self) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def addConstraintArgs(self, type: PyBrx.ConstraintType, args: list[PyBrx.ConstraintArgument], /) -> Constraint: ...
    def addConstraintSubents(self, type: PyBrx.ConstraintType, paths: list[PyDb.FullSubentPath], /) -> Constraint: ...
    @staticmethod
    def className() -> str: ...
...
class Core:
    ...
    @staticmethod
    def getAllConstraintsGroups(db:PyDb.Database, /) -> list: ...
    @staticmethod
    ...
    @staticmethod
    def getConstraintsGroup(blockRefId: PyDb.ObjectId,createIfNotExist:bool = False, /) -> ConstraintsGroup: ...
    @staticmethod
    ...
    @staticmethod
    def setBlockParameterExpression(blockRefId:PyDb.ObjectId,name:str,expr:str, /) -> None: ...
    @staticmethod
...
class DesignTable:
    ...
    @staticmethod
    def getAllDesignTables(PyDb.ObjectId, /) -> list: ...
    def getBlockId(self, /) -> PyDb.ObjectId: ...
...
class MechanicalPropertySet:
    def __init__(self, /) -> None: ...
    def __reduce__(self, /) -> Any: ...
    def addProperty(self, propertyName : str, propertyType : PyBrx.MechanicalPropertyType, label: str=..., /) -> MechanicalPropertyDefinition: ...
    ...
    @overload
    def createCategory(db: PyDb.Database, propertyName: str, isPerInstance: bool, /) -> MechanicalPropertySet: ...
    @overload
    def createCategory(db: PyDb.Database, propertyName: str, isPerInstance: bool, label: str, /) -> MechanicalPropertySet: ...
    @overload
...
class Variable:
    ...
    def getBlockId(self, /) -> PyDb.ObjectId: ...
    @staticmethod
    def getByName(blockId: PyDb.ObjectId,name:str,createIfNotExist: bool = False, /) -> Variable: ...
    @staticmethod
