...
class Acad3DPolyline(PyAx.AcadEntity):
    def __init__(self) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def appendVertex(self, vertex_point: PyGe.Point3d, /) -> None: ...
    @staticmethod
    ...
    def setClosed(self, closed_state: bool, /) -> None: ...
    def setCoordinate(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def setCoordinates(self, points: Collection[PyGe.Point3d], /) -> None: ...
    def setType(self, polyline_type: PyAx.Ac3DPolylineType, /) -> None: ...
...
class Acad3DSolid(PyAx.AcadEntity):
    ...
    def sectionSolid(
        self, p1: PyGe.Point3d, p2: PyGe.Point3d, p3: PyGe.Point3d, /
    ) -> AcadRegion: ...
    ...
    def sliceSolid(
        self, p1: PyGe.Point3d, p2: PyGe.Point3d, p3: PyGe.Point3d, negative: bool, /
    ) -> Acad3DSolid: ...
...
class AcadAcCmColor:
    ...
    @overload
    def __init__(self, colorIndex: PyAx.AcColor, /) -> None: ...
    @overload
    ...
    def fromHTMLColor(self, colorString: str, /) -> None: ...
    def green(self, /) -> int: ...
    def red(self, /) -> int: ...
...
class AcadArc(PyAx.AcadEntity):
    ...
    def offset(self, distance: float, /) -> list[PyAx.AcadEntity]: ...
    def radius(self, /) -> float: ...
    def setCenter(self, center_point: PyGe.Point3d, /) -> None: ...
    def setEndAngle(self, angle_value: float, /) -> None: ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setRadius(self, radius_value: float, /) -> None: ...
    def setStartAngle(self, angle_value: float, /) -> None: ...
    def setThickness(self, thickness_value: float, /) -> None: ...
...
class AcadAttribute(PyAx.AcadEntity):
    ...
    def setAlignment(self, align: PyAx.AcAlignment, /) -> None: ...
    def setBackward(self, backwards: bool, /) -> None: ...
    def setConstant(self, locked: bool, /) -> None: ...
    def setFieldLength(self, length: int, /) -> None: ...
    def setHeight(self, height: float, /) -> None: ...
    def setHorizontalAlignment(self, h_align: PyAx.AcHorizontalAlignment, /) -> None: ...
    def setInsertionPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setInvisible(self, hidden: bool, /) -> None: ...
    def setIsMTextAttribute(self, mtext_flag: bool, /) -> None: ...
    def setLockPosition(self, locked: bool, /) -> None: ...
    def setMTextAttributeContent(self, content: str, /) -> None: ...
    def setMTextBoundaryWidth(self, width: float, /) -> None: ...
    def setMTextDrawingDirection(self, direction: PyAx.AcDrawingDirection, /) -> None: ...
    def setMode(self, mode: int, /) -> None: ...
    def setNormal(self, vector: PyGe.Vector3d, /) -> None: ...
    def setObliqueAngle(self, factor: float, /) -> None: ...
    def setPreset(self, preset: bool, /) -> None: ...
    def setPromptString(self, prompt: str, /) -> None: ...
    def setRotation(self, angle: float, /) -> None: ...
    def setScaleFactor(self, factor: float, /) -> None: ...
    def setStyleName(self, style: str, /) -> None: ...
    def setTagString(self, tag: str, /) -> None: ...
    def setTextAlignmentPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setTextGenerationFlag(self, flag: int, /) -> None: ...
    def setTextString(self, text: str, /) -> None: ...
    def setThickness(self, thickness: float, /) -> None: ...
    def setUpsideDown(self, flip: bool, /) -> None: ...
    def setVerify(self, check: bool, /) -> None: ...
    def setVerticalAlignment(self, v_align: PyAx.AcVerticalAlignment, /) -> None: ...
...
class AcadAttributeReference(PyAx.AcadEntity):
    ...
    def backward(self, /) -> bool: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadAttributeReference: ...
    @staticmethod
    def className() -> str: ...
    def constant(self, /) -> bool: ...
    def fieldLength(self, /) -> int: ...
    ...
    def scaleFactor(self, /) -> float: ...
    def setAlignment(self, align: PyAx.AcAlignment, /) -> None: ...
    def setBackward(self, flag: bool, /) -> None: ...
    def setFieldLength(self, length: int, /) -> None: ...
    def setHeight(self, height: float, /) -> None: ...
    def setHorizontalAlignment(self, h_align: PyAx.AcHorizontalAlignment, /) -> None: ...
    def setInsertionPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setInvisible(self, flag: bool, /) -> None: ...
    def setIsMTextAttribute(self, flag: bool, /) -> None: ...
    def setMTextAttributeContent(self, content: str, /) -> None: ...
    def setMTextBoundaryWidth(self, width: float, /) -> None: ...
    def setMTextDrawingDirection(self, direction: PyAx.AcDrawingDirection, /) -> None: ...
    def setNormal(self, vector: PyGe.Vector3d, /) -> None: ...
    ...
    def setTextString(self, text: str, /) -> None: ...
    def setThickness(self, thickness: float, /) -> None: ...
    def setUpsideDown(self, flag: bool, /) -> None: ...
    def setVerticalAlignment(self, v_align: PyAx.AcVerticalAlignment, /) -> None: ...
    def styleName(self, /) -> str: ...
    def tagString(self, /) -> str: ...
    def textAlignmentPoint(self, x: float, /) -> PyGe.Point3d: ...
    def textGenerationFlag(self, /) -> int: ...
    def textString(self, /) -> str: ...
    def thickness(self, /) -> float: ...
    def updateMTextAttribute(self, /) -> None: ...
...
class AcadBlock(PyAx.AcadObject):
    ...
    def addCircle(self, center: PyGe.Point3d, radius: float, /) -> AcadCircle: ...
    def addCone(
        self, center: PyGe.Point3d, baseRadius: float, height: float, /
    ) -> Acad3DSolid: ...
    def addCustomObject(self, name: str, /) -> AcadObject: ...
    def addCylinder(
        self, center: PyGe.Point3d, radius: float, height: float, /
    ) -> Acad3DSolid: ...
...
class AcadBlockReference(PyAx.AcadEntity):
    ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadBlockReference: ...
    @staticmethod
    def className() -> str: ...
    def constantAttributes(self, /) -> list[PyAx.AcadAttributeReference]: ...
    def convertToAnonymousBlock(self, /) -> None: ...
    def convertToStaticBlock(self, new_block_name: str, /) -> None: ...
    ...
    def rotation(self, /) -> float: ...
    def setInsertionPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setName(self, block_name: str, /) -> None: ...
    def setNormal(self, normal: PyGe.Vector3d, /) -> None: ...
    def setRotation(self, angle: float, /) -> None: ...
    def setXEffectiveScaleFactor(self, scale: float, /) -> None: ...
    def setXScaleFactor(self, scale: float, /) -> None: ...
    def setYEffectiveScaleFactor(self, scale: float, /) -> None: ...
    def setYScaleFactor(self, scale: float, /) -> None: ...
    def setZEffectiveScaleFactor(self, scale: float, /) -> None: ...
    def setZScaleFactor(self, scale: float, /) -> None: ...
...
class AcadCircle(PyAx.AcadEntity):
    ...
    def area(self, /) -> float: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadCircle: ...
    def center(self, /) -> PyGe.Point3d: ...
    ...
    def radius(self, /) -> float: ...
    def setArea(self, area_value: float, /) -> None: ...
    def setCenter(self, point: PyGe.GePoint3d, /) -> None: ...
    def setCircumference(self, circumference_value: float, /) -> None: ...
    def setDiameter(self, diameter_value: float, /) -> None: ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setRadius(self, radius_value: float, /) -> None: ...
    def setThickness(self, thickness_value: float, /) -> None: ...
    def thickness(self, /) -> float: ...
...
class AcadDim3PointAngular(PyAx.AcadDimension):
    ...
    def setAngleFormat(self, format_type: PyAx.AngleUnits, /) -> None: ...
    def setAngleVertex(self, vertex_point: PyGe.Point3d, /) -> None: ...
    def setArrowhead1Block(self, block_name: str, /) -> None: ...
    def setArrowhead1Type(self, type_value: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowhead2Block(self, block_name: str, /) -> None: ...
    def setArrowhead2Type(self, type_value: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowheadSize(self, size_value: float, /) -> None: ...
    def setDimConstrDesc(self, description_str: str, /) -> None: ...
    def setDimConstrExpression(self, expression_str: str, /) -> None: ...
    def setDimConstrForm(self, form_flag: bool, /) -> None: ...
    def setDimConstrName(self, constraint_name: str, /) -> None: ...
    def setDimConstrReference(self, reference_flag: bool, /) -> None: ...
    def setDimConstrValue(self, value_str: str, /) -> None: ...
    def setDimLine1Suppress(self, suppress: bool, /) -> None: ...
    def setDimLine2Suppress(self, suppress: bool, /) -> None: ...
    def setDimLineInside(self, inside_flag: bool, /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1EndPoint(self, endpoint: PyGe.Point3d, /) -> None: ...
    def setExtLine1Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1Suppress(self, suppress: bool, /) -> None: ...
    def setExtLine2EndPoint(self, endpoint: PyGe.Point3d, /) -> None: ...
    def setExtLine2Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine2Suppress(self, suppress: bool, /) -> None: ...
    def setExtLineFixedLen(self, length_value: float, /) -> None: ...
    def setExtLineFixedLenSuppress(self, suppress_flag: bool, /) -> None: ...
    def setExtensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setExtensionLineExtend(self, extend_value: PyAx.AcColor, /) -> None: ...
    def setExtensionLineOffset(self, offset_value: float, /) -> None: ...
    def setExtensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setFit(self, fit_type: PyAx.AcDimFit, /) -> None: ...
    def setForceLineInside(self, force_flag: bool, /) -> None: ...
    def setHorizontalTextPosition(
        self, justification: PyAx.AcDimHorizontalJustification, /
    ) -> None: ...
    def setTextInside(self, inside_flag: bool, /) -> None: ...
    def setTextInsideAlign(self, align_flag: bool, /) -> None: ...
    def setTextOutsideAlign(self, align_flag: bool, /) -> None: ...
    def setTextPrecision(self, precision_value: PyAx.AcDimPrecisionint3d, /) -> None: ...
...
class AcadDimAligned(PyAx.AcadDimension):
    ...
    def setAltSubUnitsFactor(self, factor: float, /) -> None: ...
    def setAltSubUnitsSuffix(self, suffix: str, /) -> None: ...
    def setAltSuppressLeadingZeros(self, suppress: bool, /) -> None: ...
    def setAltSuppressTrailingZeros(self, suppress: bool, /) -> None: ...
    def setAltSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setAltSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setAltTextPrefix(self, prefix: str, /) -> None: ...
    def setAltTextSuffix(self, suffix: str, /) -> None: ...
    def setAltToleranceSuppressLeadingZeros(self, suppress: bool, /) -> None: ...
    def setAltToleranceSuppressTrailingZeros(self, suppress: bool, /) -> None: ...
    def setAltToleranceSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setAltToleranceSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setAltUnits(self, alternate_units: bool, /) -> None: ...
    def setAltUnitsFormat(self, format: PyAx.AcDimUnits, /) -> None: ...
    def setAltUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setArrowhead1Block(self, block_name: str, /) -> None: ...
    def setArrowhead1Type(self, arrowhead_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowhead2Block(self, block_name: str, /) -> None: ...
    def setArrowhead2Type(self, arrowhead_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowheadSize(self, size: float, /) -> None: ...
    def setDimConstrDesc(self, description: str, /) -> None: ...
    def setDimConstrExpression(self, expression: str, /) -> None: ...
    def setDimConstrForm(self, constrained_form: bool, /) -> None: ...
    def setDimConstrName(self, constraint_name: str, /) -> None: ...
    def setDimConstrReference(self, reference: bool, /) -> None: ...
    def setDimConstrValue(self, value: str, /) -> None: ...
    def setDimLine1Suppress(self, suppress: bool, /) -> None: ...
    def setDimLine2Suppress(self, suppress: bool, /) -> None: ...
    def setDimLineInside(self, inside: bool, /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineExtend(self, extend_distance: float, /) -> None: ...
    def setDimensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1Point(self, extension_point1: PyGe.Point3d, /) -> None: ...
    def setExtLine1Suppress(self, suppress: bool, /) -> None: ...
    def setExtLine2Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine2Point(self, extension_point2: PyGe.Point3d, /) -> None: ...
    def setExtLine2Suppress(self, suppress: bool, /) -> None: ...
    def setExtLineFixedLen(self, fixed_length: bool, /) -> None: ...
    def setExtLineFixedLenSuppress(self, suppress: bool, /) -> None: ...
    def setExtensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setExtensionLineExtend(self, extend_distance: float, /) -> None: ...
    def setExtensionLineOffset(self, offset_distance: float, /) -> None: ...
    def setExtensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setFit(self, fit_type: PyAx.AcDimFit, /) -> None: ...
    def setForceLineInside(self, force: bool, /) -> None: ...
    def setFractionFormat(self, format: PyAx.AcDimFractionType, /) -> None: ...
    def setHorizontalTextPosition(
        self, position: PyAx.AcDimHorizontalJustification, /
    ) -> None: ...
    def setLinearScaleFactor(self, scale_factor: float, /) -> None: ...
    def setPrimaryUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setRoundDistance(self, distance: float, /) -> None: ...
    def setSubUnitsFactor(self, factor: float, /) -> None: ...
    def setSubUnitsSuffix(self, suffix: str, /) -> None: ...
    def setSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setTextInside(self, inside: bool, /) -> None: ...
    def setTextInsideAlign(self, align: bool, /) -> None: ...
    def setTextOutsideAlign(self, align: bool, /) -> None: ...
    def setToleranceSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setToleranceSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setUnitsFormat(self, format: PyAx.AcDimLUnits, /) -> None: ...
...
class AcadDimAngular(PyAx.AcadDimension):
    ...
    def extLine1EndPoint(self, /) -> PyGe.Point3d: ...
    def extLine1Linetype(self, /) -> str: ...
    def extLine1StartPoint(self, /) -> PyGe.Point3d: ...
    def extLine1Suppress(self, /) -> bool: ...
    def extLine2EndPoint(self, /) -> PyGe.Point3d: ...
    def extLine2Linetype(self, /) -> str: ...
    ...
    def horizontalTextPosition(self, /) -> AcDimHorizontalJustification: ...
    def measurement(self, /) -> float: ...
    def setAngleFormat(self, format_type: PyAx.AcAngleUnits, /) -> None: ...
    def setArrowhead1Block(self, block_name: str, /) -> None: ...
    def setArrowhead1Type(self, arrowhead_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowhead2Block(self, block_name: str, /) -> None: ...
    def setArrowhead2Type(self, arrowhead_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowheadSize(self, size_value: float, /) -> None: ...
    def setDimConstrDesc(self, description_string: str, /) -> None: ...
    def setDimConstrExpression(self, expression_string: str, /) -> None: ...
    def setDimConstrForm(self, form_flag: bool, /) -> None: ...
    def setDimConstrName(self, constraint_name: str, /) -> None: ...
    def setDimConstrReference(self, reference_flag: bool, /) -> None: ...
    def setDimConstrValue(self, value_string: str, /) -> None: ...
    def setDimLine1Suppress(self, suppress_flag: bool, /) -> None: ...
    def setDimLine2Suppress(self, suppress_flag: bool, /) -> None: ...
    def setDimLineInside(self, inside_flag: bool, /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1EndPoint(self, end_point: PyGe.GePoint3d, /) -> None: ...
    def setExtLine1Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1StartPoint(self, start_point: PyGe.GePoint3d, /) -> None: ...
    def setExtLine1Suppress(self, suppress_flag: bool, /) -> None: ...
    def setExtLine2EndPoint(self, end_point: PyGe.GePoint3d, /) -> None: ...
    def setExtLine2Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine2StartPoint(self, start_point: PyGe.GePoint3d, /) -> None: ...
    def setExtLine2Suppress(self, suppress_flag: bool, /) -> None: ...
    def setExtLineFixedLen(self, length_value: float, /) -> None: ...
    def setExtLineFixedLenSuppress(self, suppress_flag: bool, /) -> None: ...
    def setExtensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setExtensionLineExtend(self, extend_distance: float, /) -> None: ...
    ...
    def setTextInsideAlign(self, align_flag: bool, /) -> None: ...
    def setTextOutsideAlign(self, align_flag: bool, /) -> None: ...
    def setTextPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def textInside(self, /) -> bool: ...
    def textInsideAlign(self, /) -> bool: ...
    def textOutsideAlign(self, /) -> bool: ...
    def textPrecision(self, /) -> AcDimPrecision: ...
...
class AcadDimArcLength(PyAx.AcadDimension):
    ...
    def primaryUnitsPrecision(self, /) -> AcDimPrecision: ...
    def roundDistance(self, /) -> float: ...
    def setAltRoundDistance(self, round_distance: float, /) -> None: ...
    def setAltSubUnitsFactor(self, factor: float, /) -> None: ...
    def setAltSubUnitsSuffix(self, suffix: str, /) -> None: ...
    def setAltSuppressLeadingZeros(self, suppress: bool, /) -> None: ...
    def setAltSuppressTrailingZeros(self, suppress: bool, /) -> None: ...
    ...
    def setAltTextPrefix(self, prefix: str, /) -> None: ...
    def setAltTextSuffix(self, suffix: str, /) -> None: ...
    def setAltTolerancePrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltToleranceSuppressLeadingZeros(self, suppress: bool, /) -> None: ...
    def setAltToleranceSuppressTrailingZeros(self, suppress: bool, /) -> None: ...
    def setAltToleranceSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setAltToleranceSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setAltUnits(self, enabled: bool, /) -> None: ...
    def setAltUnitsFormat(self, format_type: PyAx.AcDimUnits, /) -> None: ...
    def setAltUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltUnitsScale(self, scale_factor: float, /) -> None: ...
    def setArcEndParam(self, param: float, /) -> None: ...
    def setArcPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setArcStartParam(self, param: float, /) -> None: ...
    def setArrowhead1Block(self, block_name: str, /) -> None: ...
    def setArrowhead1Type(self, type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowhead2Block(self, block_name: str, /) -> None: ...
    def setArrowhead2Type(self, type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowheadSize(self, size: float, /) -> None: ...
    def setCenterPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setDimLine1Suppress(self, suppress: bool, /) -> None: ...
    def setDimLine2Suppress(self, suppress: bool, /) -> None: ...
    def setDimLineInside(self, inside: bool, /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1Point(self, point: PyGe.Point3d, /) -> None: ...
    def setExtLine1Suppress(self, suppress: bool, /) -> None: ...
    def setExtLine2Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine2Point(self, point: PyGe.Point3d, /) -> None: ...
    def setExtLine2Suppress(self, suppress: bool, /) -> None: ...
    def setExtLineFixedLen(self, length: float, /) -> None: ...
    def setExtLineFixedLenSuppress(self, suppress: bool, /) -> None: ...
    def setExtensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setExtensionLineExtend(self, extend_distance: float, /) -> None: ...
    def setExtensionLineOffset(self, offset_distance: float, /) -> None: ...
    ...
    def setFit(self, fit_type: PyAx.AcDimFit, /) -> None: ...
    def setForceLineInside(self, force: bool, /) -> None: ...
    def setFractionFormat(self, format_type: PyAx.AcDimFractionType, /) -> None: ...
    def setHasLeader(self, has_leader: bool, /) -> None: ...
    def setHorizontalTextPosition(
        self, position: PyAx.AcDimHorizontalJustification, /
    ) -> None: ...
    def setIsPartial(self, partial: bool, /) -> None: ...
    def setLeader1Point(self, point: PyGe.Point3d, /) -> None: ...
    def setLeader2Point(self, point: PyGe.Point3d, /) -> None: ...
    def setLinearScaleFactor(self, scale_factor: float, /) -> None: ...
    def setPrimaryUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setRoundDistance(self, round_distance: float, /) -> None: ...
    def setSubUnitsFactor(self, factor: float, /) -> None: ...
    def setSubUnitsSuffix(self, suffix: str, /) -> None: ...
    def setSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setSymbolPosition(self, position: PyAx.AcDimArcLengthSymbol, /) -> None: ...
    def setTextInside(self, inside: bool, /) -> None: ...
    def setTextInsideAlign(self, align: bool, /) -> None: ...
    def setTextOutsideAlign(self, align: bool, /) -> None: ...
    def setToleranceSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setToleranceSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setUnitsFormat(self, format_type: PyAx.AcDimLUnits, /) -> None: ...
    def subUnitsFactor(self, /) -> float: ...
    def subUnitsSuffix(self, /) -> str: ...
    def suppressZeroFeet(self, /) -> bool: ...
    def suppressZeroInches(self, /) -> bool: ...
...
class AcadDimDiametric(PyAx.AcadDimension):
    ...
    def primaryUnitsPrecision(self, /) -> AcDimPrecision: ...
    def roundDistance(self, /) -> float: ...
    def setAltSuppressLeadingZeros(self, suppress_flag: bool, /) -> None: ...
    def setAltSuppressTrailingZeros(self, suppress_flag: bool, /) -> None: ...
    def setAltSuppressZeroFeet(self, suppress_flag: bool, /) -> None: ...
    def setAltSuppressZeroInches(self, suppress_flag: bool, /) -> None: ...
    def setAltTextPrefix(self, prefix_text: str, /) -> None: ...
    def setAltTextSuffix(self, suffix_text: str, /) -> None: ...
    def setAltTolerancePrecision(self, tolerance_precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltToleranceSuppressLeadingZeros(self, suppress_flag: bool, /) -> None: ...
    def setAltToleranceSuppressTrailingZeros(self, suppress_flag: bool, /) -> None: ...
    def setAltToleranceSuppressZeroFeet(self, suppress_flag: bool, /) -> None: ...
    def setAltToleranceSuppressZeroInches(self, suppress_flag: bool, /) -> None: ...
    def setAltUnits(self, alternate_units_flag: bool, /) -> None: ...
    def setAltUnitsFormat(self, format_type: PyAx.AcDimUnits, /) -> None: ...
    def setAltUnitsPrecision(self, precision_type: PyAx.AcDimPrecision, /) -> None: ...
    def setAltUnitsScale(self, scale_flag: bool, /) -> None: ...
    def setArrowhead1Block(self, block_name: str, /) -> None: ...
    def setArrowhead1Type(self, arrow_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowhead2Block(self, block_name: str, /) -> None: ...
    def setArrowhead2Type(self, arrow_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowheadSize(self, arrow_size: float, /) -> None: ...
    def setCenterMarkSize(self, mark_size: float, /) -> None: ...
    def setCenterType(self, center_type: PyAx.AcDimCenterType, /) -> None: ...
    def setDimConstrDesc(self, description_text: str, /) -> None: ...
    def setDimConstrExpression(self, expression_text: str, /) -> None: ...
    def setDimConstrForm(self, constraint_form_flag: bool, /) -> None: ...
    def setDimConstrName(self, constraint_name: str, /) -> None: ...
    def setDimConstrReference(self, reference_flag: bool, /) -> None: ...
    def setDimConstrValue(self, value_text: str, /) -> None: ...
    def setDimLine1Suppress(self, suppress_flag: bool, /) -> None: ...
    def setDimLine2Suppress(self, suppress_flag: bool, /) -> None: ...
    def setDimensionLineColor(self, line_color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineWeight(self, line_weight: PyAx.AcLineWeight, /) -> None: ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setFit(self, fit_type: PyAx.AcDimFit, /) -> None: ...
    def setForceLineInside(self, force_flag: bool, /) -> None: ...
    def setFractionFormat(self, fraction_format: PyAx.AcDimFractionType, /) -> None: ...
    def setLeaderLength(self, leader_length: float, /) -> None: ...
    def setLinearScaleFactor(self, scale_factor: float, /) -> None: ...
    def setPrimaryUnitsPrecision(self, precision_type: PyAx.AcDimPrecision, /) -> None: ...
    def setRoundDistance(self, rounding_distance: float, /) -> None: ...
    def setSuppressZeroFeet(self, suppress_flag: bool, /) -> None: ...
    def setSuppressZeroInches(self, suppress_flag: bool, /) -> None: ...
    def setTextInside(self, inside_flag: bool, /) -> None: ...
    def setTextInsideAlign(self, align_flag: bool, /) -> None: ...
    def setTextOutsideAlign(self, align_flag: bool, /) -> None: ...
    def setToleranceSuppressZeroFeet(self, suppress_flag: bool, /) -> None: ...
    def setToleranceSuppressZeroInches(self, suppress_flag: bool, /) -> None: ...
    def setUnitsFormat(self, units_format: AcDimLUnits, /) -> None: ...
    def suppressZeroFeet(self, /) -> bool: ...
    def suppressZeroInches(self, /) -> bool: ...
    def textInside(self, /) -> bool: ...
    def textInsideAlign(self, /) -> bool: ...
...
class AcadDimOrdinate(PyAx.AcadDimension):
    ...
    def setAltSubUnitsFactor(self, factor: float, /) -> None: ...
    def setAltSubUnitsSuffix(self, suffix: str, /) -> None: ...
    def setAltSuppressLeadingZeros(self, suppress_leading_zeros: bool, /) -> None: ...
    def setAltSuppressTrailingZeros(self, suppress_trailing_zeros: bool, /) -> None: ...
    def setAltSuppressZeroFeet(self, suppress_zero_feet: bool, /) -> None: ...
    def setAltSuppressZeroInches(self, suppress_zero_inches: bool, /) -> None: ...
    def setAltTextPrefix(self, prefix_text: str, /) -> None: ...
    def setAltTextSuffix(self, suffix_text: str, /) -> None: ...
    def setAltTolerancePrecision(self, tolerance_precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltToleranceSuppressLeadingZeros(self, suppress_leading_zeros: bool, /) -> None: ...
    def setAltToleranceSuppressTrailingZeros(self, suppress_trailing_zeros: bool, /) -> None: ...
    def setAltToleranceSuppressZeroFeet(self, suppress_zero_feet: bool, /) -> None: ...
    def setAltToleranceSuppressZeroInches(self, suppress_zero_inches: bool, /) -> None: ...
    def setAltUnits(self, use_alternate_units: bool, /) -> None: ...
    def setAltUnitsFormat(self, units_format: PyAx.AcDimUnits, /) -> None: ...
    def setAltUnitsPrecision(self, precision_type: PyAx.AcDimPrecision, /) -> None: ...
    def setAltUnitsScale(self, scale_factor: float, /) -> None: ...
    def setArrowheadSize(self, size: float, /) -> None: ...
    def setExtLineFixedLen(self, fixed_length: bool, /) -> None: ...
    ...
    def setExtensionLineOffset(self, offset_distance: float, /) -> None: ...
    def setExtensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setFractionFormat(self, fraction_type: PyAx.AcDimFractionType, /) -> None: ...
    def setLinearScaleFactor(self, scale_factor: float, /) -> None: ...
    def setPrimaryUnitsPrecision(self, precision_type: PyAx.AcDimPrecision, /) -> None: ...
    def setRoundDistance(self, round_distance: float, /) -> None: ...
    def setSubUnitsFactor(self, factor: float, /) -> None: ...
    def setSubUnitsSuffix(self, suffix: str, /) -> None: ...
    def setSuppressZeroFeet(self, suppress_zero_feet: bool, /) -> None: ...
    def setSuppressZeroInches(self, suppress_zero_inches: bool, /) -> None: ...
    def setToleranceSuppressZeroFeet(self, suppress_zero_feet: bool, /) -> None: ...
    def setToleranceSuppressZeroInches(self, suppress_zero_inches: bool, /) -> None: ...
    def setUnitsFormat(self, units_format: PyAx.AcDimLUnits, /) -> None: ...
    def subUnitsFactor(self, /) -> float: ...
    def subUnitsSuffix(self, /) -> str: ...
    def suppressZeroFeet(self, /) -> bool: ...
    def suppressZeroInches(self, /) -> bool: ...
...
class AcadDimRadial(PyAx.AcadDimension):
    ...
    def setAltTextSuffix(self, suffix_text: str, /) -> None: ...
    def setAltTolerancePrecision(self, tolerance_precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltToleranceSuppressLeadingZeros(
        self, suppress_tolerance_leading_zeros: bool, /
    ) -> None: ...
    def setAltToleranceSuppressTrailingZeros(
        self, suppress_tolerance_trailing_zeros: bool, /
    ) -> None: ...
    def setAltToleranceSuppressZeroFeet(self, suppress_tolerance_zero_feet: bool, /) -> None: ...
    def setAltToleranceSuppressZeroInches(
        self, suppress_tolerance_zero_inches: bool, /
    ) -> None: ...
    def setAltUnits(self, use_alternate_units: bool, /) -> None: ...
    def setAltUnitsFormat(self, format: PyAx.AcDimUnits, /) -> None: ...
    def setAltUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltUnitsScale(self, scale_factor: float, /) -> None: ...
    def setArrowheadBlock(self, block_name: str, /) -> None: ...
    def setArrowheadSize(self, size: float, /) -> None: ...
    def setArrowheadType(self, arrowhead_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setCenterMarkSize(self, mark_size: float, /) -> None: ...
    def setCenterType(self, center_type: PyAx.AcDimCenterType, /) -> None: ...
    def setDimConstrDesc(self, description: str, /) -> None: ...
    def setDimConstrExpression(self, expression_text: str, /) -> None: ...
    def setDimConstrForm(self, constrained_form: bool, /) -> None: ...
    def setDimConstrName(self, constraint_name: str, /) -> None: ...
    def setDimConstrReference(self, reference_constrained: bool, /) -> None: ...
    def setDimConstrValue(self, constraint_value: str, /) -> None: ...
    def setDimLineSuppress(self, suppress_dim_line: bool, /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineWeight(self, line_weight: PyAx.AcLineWeight, /) -> None: ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setFit(self, fit_type: PyAx.AcDimFit, /) -> None: ...
    def setForceLineInside(self, force_line_inside: bool, /) -> None: ...
    def setFractionFormat(self, format_type: PyAx.AcDimFractionType, /) -> None: ...
    def setLeaderLength(self, leader_length: float, /) -> None: ...
    def setLinearScaleFactor(self, scale_factor: float, /) -> None: ...
    def setPrimaryUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    ...
    def setSuppressZeroFeet(self, suppress_zero_feet: bool, /) -> None: ...
    def setSuppressZeroInches(self, suppress_zero_inches: bool, /) -> None: ...
    def setTextInside(self, inside_text: bool, /) -> None: ...
    def setTextInsideAlign(self, align_inside_text: bool, /) -> None: ...
    def setTextOutsideAlign(self, align_outside_text: bool, /) -> None: ...
    def setToleranceSuppressZeroFeet(self, suppress_tolerance_zero_feet: bool, /) -> None: ...
    def setToleranceSuppressZeroInches(self, suppress_tolerance_zero_inches: bool, /) -> None: ...
    def setUnitsFormat(self, format: PyAx.AcDimLUnits, /) -> None: ...
    def suppressZeroFeet(self, /) -> bool: ...
    def suppressZeroInches(self, /) -> bool: ...
    def textInside(self, /) -> bool: ...
...
class AcadDimRadialLarge(PyAx.AcadDimension):
    ...
    def setAltUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltUnitsScale(self, scale_factor: float, /) -> None: ...
    def setArrowheadBlock(self, block_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setArrowheadSize(self, size: float, /) -> None: ...
    def setArrowheadType(self, arrowhead_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setCenter(self, center_point: PyGe.Point3d, /) -> None: ...
    def setCenterMarkSize(self, size: float, /) -> None: ...
    def setCenterType(self, type: PyAx.AcDimCenterType, /) -> None: ...
    def setChordPoint(self, chord_point: PyGe.Point3d, /) -> None: ...
    def setDimLineSuppress(self, suppress: bool, /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setFit(self, fit_type: PyAx.AcDimFit, /) -> None: ...
    def setForceLineInside(self, force: bool, /) -> None: ...
    def setFractionFormat(self, format: PyAx.AcDimFractionType, /) -> None: ...
    def setJogAngle(self, angle: float, /) -> None: ...
    def setJogLocation(self, location: PyGe.Point3d, /) -> None: ...
    def setLinearScaleFactor(self, scale_factor: float, /) -> None: ...
    def setOverrideCenter(self, center_point: PyGe.Point3d, /) -> None: ...
    def setPrimaryUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setRoundDistance(self, round_distance: float, /) -> None: ...
    def setSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setSuppressZeroInches(self, suppress: bool, /) -> None: ...
...
class AcadDimRotated(PyAx.AcadDimension):
    ...
    def primaryUnitsPrecision(self, /) -> AcDimPrecision: ...
    def roundDistance(self, /) -> float: ...
    def setAltRoundDistance(self, distance: float, /) -> None: ...
    def setAltSubUnitsFactor(self, factor: float, /) -> None: ...
    def setAltSubUnitsSuffix(self, suffix: str, /) -> None: ...
    def setAltSuppressLeadingZeros(self, suppress: bool, /) -> None: ...
    def setAltSuppressTrailingZeros(self, suppress: bool, /) -> None: ...
    ...
    def setAltToleranceSuppressZeroFeet(self, suppress: bool, /) -> None: ...
    def setAltToleranceSuppressZeroInches(self, suppress: bool, /) -> None: ...
    def setAltUnits(self, enable: bool, /) -> None: ...
    def setAltUnitsFormat(self, format: PyAx.AcDimUnits, /) -> None: ...
    def setAltUnitsPrecision(self, precision: PyAx.AcDimPrecision, /) -> None: ...
    def setAltUnitsScale(self, scale_factor: float, /) -> None: ...
    def setArrowhead1Block(self, block_name: str, /) -> None: ...
    ...
    def setDimConstrDesc(self, description: str, /) -> None: ...
    def setDimConstrExpression(self, expression: str, /) -> None: ...
    def setDimConstrForm(self, form: bool, /) -> None: ...
    def setDimConstrName(self, name: str, /) -> None: ...
    def setDimConstrReference(self, reference: bool, /) -> None: ...
    def setDimConstrValue(self, value: str, /) -> None: ...
    def setDimLine1Suppress(self, suppress: bool, /) -> None: ...
    def setDimLine2Suppress(self, suppress: bool, /) -> None: ...
    def setDimLineInside(self, inside: bool, /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineExtend(self, extension: float, /) -> None: ...
    def setDimensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setDimensionLinetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1Linetype(self, linetype_name: str, /) -> None: ...
    def setExtLine1Suppress(self, suppress: bool, /) -> None: ...
    ...
    def setExtLineFixedLenSuppress(self, suppress: bool, /) -> None: ...
    def setExtensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setExtensionLineExtend(self, extension: float, /) -> None: ...
    def setExtensionLineOffset(self, offset: float, /) -> None: ...
    def setExtensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setFit(self, fit_type: PyAx.AcDimFit, /) -> None: ...
    def setForceLineInside(self, force: bool, /) -> None: ...
    def setFractionFormat(self, format: PyAx.AcDimFractionType, /) -> None: ...
...
class AcadDimStyle(PyAx.AcadObject):
    ...
    @staticmethod
    def className() -> str: ...
    def copyFrom(self, otherObject: PyAx.AcadObject, /) -> None: ...
    def name(self, /) -> str: ...
    def setName(self, name: str, /) -> None: ...
...
class AcadDimension(PyAx.AcadEntity):
    ...
    def rotation(self, /) -> float: ...
    def scaleFactor(self, /) -> float: ...
    def setDecimalSeparator(self, separator_char: str, /) -> None: ...
    def setDimTxtDirection(self, direction_enabled: bool, /) -> None: ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setRotation(self, rotation_angle: float, /) -> None: ...
    def setScaleFactor(self, scale_factor: float, /) -> None: ...
    def setStyleName(self, style_name: str, /) -> None: ...
    def setSuppressLeadingZeros(self, suppress_flag: bool, /) -> None: ...
    def setSuppressTrailingZeros(self, suppress_flag: bool, /) -> None: ...
    def setTextColor(self, text_color: PyAx.AcColor, /) -> None: ...
    def setTextFill(self, fill_enabled: bool, /) -> None: ...
    def setTextFillColor(self, fill_color: PyAx.AcColor, /) -> None: ...
    def setTextGap(self, gap_distance: float, /) -> None: ...
    def setTextHeight(self, height_value: float, /) -> None: ...
    def setTextMovement(self, movement_type: PyAx.AcDimTextMovement, /) -> None: ...
    def setTextOverride(self, override_text: str, /) -> None: ...
    def setTextPosition(self, text_point: PyGe.Point3d, /) -> None: ...
    def setTextPrefix(self, prefix_text: str, /) -> None: ...
    def setTextRotation(self, text_rotation_angle: float, /) -> None: ...
    def setTextStyle(self, style_name: str, /) -> None: ...
    def setTextSuffix(self, suffix_text: str, /) -> None: ...
    def setToleranceDisplay(self, display_method: PyAx.AcDimToleranceMethod, /) -> None: ...
    def setToleranceHeightScale(self, height_scale: float, /) -> None: ...
    def setToleranceJustification(self, justification: PyAx.AcDimToleranceJustify, /) -> None: ...
    def setToleranceLowerLimit(self, lower_limit: float, /) -> None: ...
    def setTolerancePrecision(self, precision_level: PyAx.AcDimPrecision, /) -> None: ...
    def setToleranceSuppressLeadingZeros(self, suppress_flag: bool, /) -> None: ...
    def setToleranceSuppressTrailingZeros(self, suppress_flag: bool, /) -> None: ...
    def setToleranceUpperLimit(self, upper_limit: float, /) -> None: ...
    def setVerticalTextPosition(
        self, justification: PyAx.AcDimVerticalJustification, /
    ) -> None: ...
    def styleName(self, /) -> str: ...
...
class AcadDocument(PyAx.AcadDatabase):
    ...
    def auditInfo(self, enable: bool, /) -> None: ...
    @staticmethod
    def className() -> str: ...
    def close(self, save_changes: bool = False, file_name: str = ..., /) -> None: ...
    def database(self, /) -> AcadDatabase: ...
    def endUndoMark(self, /) -> None: ...
    def exportToFile(
        self, file_name: str, extension: str, selection_set: PyAx.AcadSelectionSet, /
    ) -> None: ...
    def fullName(self, /) -> str: ...
    def getVariable(self, variable_name: str, /) -> object: ...
    def height(self, /) -> int: ...
    def importFile(
        self, file_path: str, insertion_point: PyGe.Point3d, scale_factor: float, /
    ) -> AcadBlockReference: ...
    def isActive(self, /) -> bool: ...
    def isReadOnly(self, /) -> bool: ...
    def isSaved(self, /) -> bool: ...
    def loadShapeFile(self, file_name: str, /) -> None: ...
    def mSpace(self, /) -> bool: ...
    def name(self, /) -> str: ...
    def objectSnapMode(self, /) -> bool: ...
    def open(self, full_path: str, /) -> AcadDocument: ...
    def path(self, /) -> str: ...
    ...
    def regen(self, regen_type: PyAx.AcRegenType, /) -> None: ...
    def save(self, /) -> None: ...
    @overload
    ...
    def setActiveDimStyle(self, dimstyle: PyAx.AcadDimStyle, /) -> None: ...
    def setActiveLayer(self, layer: PyAx.AcadLayer, /) -> None: ...
    def setActiveLayout(self, layout: PyAx.AcadLayout, /) -> None: ...
    def setActiveLinetype(self, linetype: PyAx.AcadLineType, /) -> None: ...
    def setActiveMaterial(self, material: PyAx.AcadMaterial, /) -> None: ...
    def setActivePViewport(self, p_viewport: PyAx.AcadPViewport, /) -> None: ...
    def setActiveSpace(self, space: PyAx.AcActiveSpace, /) -> None: ...
    def setActiveTextStyle(self, textstyle: PyAx.AcadTextStyle, /) -> None: ...
    def setActiveUCS(self, UCS: PyAx.AcadUCS, /) -> None: ...
    def setActiveViewport(self, viewport: PyAx.AcadViewport, /) -> None: ...
    def setHeight(self, height: int, /) -> None: ...
    def setMSpace(self, enable: bool, /) -> None: ...
    def setObjectSnapMode(self, enable: bool, /) -> None: ...
    def setVariable(self, variable_name: str, value: Any, /) -> None: ...
    def setWidth(self, width: int, /) -> None: ...
    def setWindowState(self, state: PyAx.AcWindowState, /) -> None: ...
    def startUndoMark(self, /) -> None: ...
    def utility(self, /) -> AcadUtility: ...
    def wblock(self, file_name: str, selection_set: PyAx.AcadSelectionSet, /) -> None: ...
    def width(self, /) -> int: ...
...
class AcadEllipse(PyAx.AcadEntity):
    ...
    def area(self, /) -> float: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadEllipse: ...
    def center(self, /) -> PyGe.Point3d: ...
    @staticmethod
    def className() -> str: ...
    def endAngle(self, /) -> float: ...
    ...
    def setEndParameter(self, parameter: float, /) -> None: ...
    def setMajorAxis(self, axis_vector: PyGe.Vector3d, /) -> None: ...
    def setMajorRadius(self, radius: float, /) -> None: ...
    def setMinorRadius(self, radius: float, /) -> None: ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setRadiusRatio(self, ratio: float, /) -> None: ...
    def setStartAngle(self, angle: float, /) -> None: ...
    def setStartParameter(self, parameter: float, /) -> None: ...
    def startAngle(self, /) -> float: ...
...
class AcadExternalReference(PyAx.AcadBlockReference):
    ...
    @staticmethod
    def className() -> str: ...
    def layerPropertyOverrides(self, layer_overrides: str, /) -> bool: ...
    def path(self, /) -> str: ...
    def setPath(self, ref_path: str, /) -> None: ...
...
class AcadGroup(PyAx.AcadObject):
    ...
    def __iter__(self, /) -> Iterator[PyAx.AcadEntity]: ...
    def __reduce__(self, /) -> Any: ...
    def appendItems(self, entities: Collection[PyAx.AcadEntity], /) -> None: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadGroup: ...
    @staticmethod
    def className() -> str: ...
    def count(self, /) -> int: ...
    def highlight(self, should_highlight: bool, /) -> None: ...
    def item(self, index: int, /) -> AcadEntity: ...
    def items(self, /) -> list[PyAx.AcadEntity]: ...
    def name(self, /) -> str: ...
    def removeItems(self, entities: Collection[PyAx.AcadEntity], /) -> None: ...
    def setColor(self, color: PyAx.AcColor, /) -> None: ...
    def setLayer(self, layer_name: str, /) -> None: ...
    def setLineWeight(self, line_weight: int, /) -> None: ...
    def setLinetype(self, linetype_name: str, /) -> None: ...
    def setLinetypeScale(self, scale_factor: float, /) -> None: ...
    def setMaterial(self, /) -> None: ...
    def setName(self, group_name: str, /) -> None: ...
    def setPlotStyleName(self, plot_style_name: str, /) -> None: ...
    def setTrueColor(self, color: PyAx.AcadAcCmColor, /) -> None: ...
...
class AcadHatch(PyAx.AcadEntity):
    def __init__(self) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def appendInnerLoop(self, entities: Collection[PyAx.AcadEntity], /) -> None: ...
    def appendOuterLoop(self, entities: Collection[PyAx.AcadEntity], /) -> None: ...
    def area(self, /) -> float: ...
    ...
    def insertLoopAt(
        self, index: int, loop_type: PyAx.AcLoopType, entities: Collection[PyAx.AcadEntity], /
    ) -> None: ...
    ...
    def setAssociativeHatch(self, assoc_flag: bool, /) -> None: ...
    def setBackgroundColor(self, color: PyAx.AcadAcCmColor, /) -> None: ...
    def setElevation(self, elev: float, /) -> None: ...
    def setGradientAngle(self, angle: float, /) -> None: ...
    def setGradientCentered(self, centered: float, /) -> None: ...
    def setGradientColor1(self, color: PyAx.AcadAcCmColor, /) -> None: ...
    def setGradientColor2(self, color: PyAx.AcadAcCmColor, /) -> None: ...
    def setGradientName(self, name: str, /) -> None: ...
    def setHatchObjectType(self, obj_type: PyAx.AcHatchObjectType, /) -> None: ...
    def setHatchStyle(self, style: PyAx.AcHatchStyle, /) -> None: ...
    def setISOPenWidth(self, width: PyAx.AcISOPenWidth, /) -> None: ...
    def setNormal(self, normal: PyGe.Vector3d, /) -> None: ...
    def setOrigin(self, point: PyGe.Point3d, /) -> None: ...
    def setPattern(self, pattern_type: int, name: str, /) -> None: ...
    def setPatternAngle(self, angle: float, /) -> None: ...
    def setPatternDouble(self, double_flag: bool, /) -> None: ...
...
class AcadHyperlink:
    ...
    def className() -> str: ...
    def clear(self, /) -> None: ...
    def setURL(self, url_val: str, /) -> None: ...
    def setURLDescription(self, description: str, /) -> None: ...
    def setURLNamedLocation(self, named_location: str, /) -> None: ...
    def url(self, /) -> str: ...
...
class AcadLWPolyline(PyAx.AcadEntity):
    def __init__(self) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def addVertex(self, index: int, vertex_point: PyGe.Point2d, /) -> None: ...
    def area(self, /) -> float: ...
    def bulge(self, index: int, /) -> float: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadLWPolyline: ...
    @staticmethod
    def className() -> str: ...
    ...
    def normal(self, /) -> PyGe.Vector3d: ...
    def offset(self, distance: float, /) -> list[PyAx.AcadEntity]: ...
    def setBulge(self, index: int, bulge_value: float, /) -> None: ...
    def setClosed(self, closed_flag: bool, /) -> None: ...
    def setConstantWidth(self, width_value: float, /) -> None: ...
    def setCoordinate(self, index: int, point: PyGe.Point2d, /) -> None: ...
    def setCoordinates(self, points: Collection[PyGe.Point2d], /) -> None: ...
    def setElevation(self, elevation_value: float, /) -> None: ...
    def setLinetypeGeneration(self, generate_flag: bool, /) -> None: ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setThickness(self, thickness_value: float, /) -> None: ...
    def setWidth(self, index: int, start_width: float, end_width: float, /) -> None: ...
    def thickness(self, /) -> float: ...
...
class AcadLayer(PyAx.AcadObject):
    ...
    def setColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDescription(self, description_text: str, /) -> None: ...
    def setFreeze(self, is_frozen: bool, /) -> None: ...
    def setLayerOn(self, is_on: bool, /) -> None: ...
    def setLineWeight(self, line_weight: PyAx.AcLineWeight, /) -> None: ...
    def setLinetype(self, linetype_name: str, /) -> None: ...
    def setLock(self, is_locked: bool, /) -> None: ...
    def setMaterial(self, material_name: str, /) -> None: ...
    def setName(self, layer_name: str, /) -> None: ...
    def setPlotStyleName(self, plot_style_name: str, /) -> None: ...
    def setPlottable(self, is_plottable: bool, /) -> None: ...
    def setTrueColor(self, true_color: PyAx.AcadAcCmColor, /) -> None: ...
    def setViewportDefault(self, is_default: bool, /) -> None: ...
    def trueColor(self, /) -> AcadAcCmColor: ...
    def used(self, /) -> bool: ...
...
class AcadLayout(PyAx.AcadPlotConfiguration):
    ...
    @staticmethod
    def className() -> str: ...
    def setTabOrder(self, index: int, /) -> None: ...
...
class AcadLeader(PyAx.AcadEntity):
    ...
    def normal(self, /) -> PyGe.Vector3d: ...
    def scaleFactor(self, /) -> float: ...
    def setAnnotation(self, annotation_entity: PyAx.AcadEntity, /) -> None: ...
    def setArrowheadBlock(self, block_name: str, /) -> None: ...
    def setArrowheadSize(self, size: float, /) -> None: ...
    def setArrowheadType(self, arrow_type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setCoordinate(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def setCoordinates(self, coords: Collection[PyGe.Point3d], /) -> None: ...
    def setDimensionLineColor(self, color: PyAx.AcColor, /) -> None: ...
    def setDimensionLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setLeaderType(self, leader_type: PyAx.AcLeaderType, /) -> None: ...
    def setScaleFactor(self, factor: float, /) -> None: ...
    def setStyleName(self, style_name: str, /) -> None: ...
    def setTextGap(self, gap: float, /) -> None: ...
    def setVerticalTextPosition(self, position: PyAx.AcDimVerticalJustification, /) -> None: ...
    def styleName(self, /) -> str: ...
    def textGap(self, /) -> float: ...
    def verticalTextPosition(self, /) -> AcDimVerticalJustification: ...
...
class AcadLine(PyAx.AcadEntity):
    ...
    def normal(self, /) -> PyGe.Vector3d: ...
    def offset(self, distance: float, /) -> list[PyAx.AcadEntity]: ...
    def setEndPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setNormal(self, vector: PyGe.Vector3d, /) -> None: ...
    def setStartPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setThickness(self, thickness: float, /) -> None: ...
    def startPoint(self, /) -> PyGe.Point3d: ...
    def thickness(self, /) -> float: ...
...
class AcadLineType(PyAx.AcadObject):
    ...
    def description(self, /) -> str: ...
    def name(self, /) -> str: ...
    def setDescription(self, otherObject: str, /) -> None: ...
    def setName(self, name: str, /) -> None: ...
...
class AcadMInsertBlock(PyAx.AcadBlockReference):
    ...
    def setColumns(self, count: int, /) -> None: ...
    def setRowSpacing(self, spacing: float, /) -> None: ...
    def setRows(self, count: int, /) -> None: ...
...
class AcadMLeader(PyAx.AcadEntity):
    ...
    def addLeaderLine(self, leader_index: int, points: Collection[PyGe.Point3d], /) -> int: ...
    def addLeaderLineEx(self, points: Collection[PyGe.Point3d], /) -> int: ...
    def arrowheadBlock(self, /) -> str: ...
    def arrowheadSize(self, /) -> float: ...
    def arrowheadType(self, /) -> AcDimArrowheadType: ...
    def blockAttributeValue(self, object_id: PyDb.ObjectId, /) -> str: ...
    ...
    def doglegDirection(self, leader_index: int, /) -> PyGe.Vector3d: ...
    def doglegLength(self, /) -> float: ...
    def landingGap(self, /) -> float: ...
    def leaderCount(self, /) -> int: ...
    def leaderIndex(self, index: int, /) -> int: ...
    def leaderLineColor(self, /) -> AcadAcCmColor: ...
    def leaderLineIndexes(self, leader_index: int, /) -> list[int]: ...
    def leaderLineVertices(self, leader_index: int, /) -> list[PyGe.Point3d]: ...
    ...
    def removeLeaderLine(self, index: int, /) -> None: ...
    def scaleFactor(self, /) -> float: ...
    def setArrowheadBlock(self, name: str, /) -> None: ...
    def setArrowheadSize(self, size: float, /) -> None: ...
    def setArrowheadType(self, type: PyAx.AcDimArrowheadType, /) -> None: ...
    def setBlockAttributeValue(self, id: PyDb.ObjectId, value: str, /) -> None: ...
    def setBlockConnectionType(self, type: PyAx.AcBlockConnectionType, /) -> None: ...
    def setBlockScale(self, scale: float, /) -> None: ...
    def setContentBlockName(self, name: str, /) -> None: ...
    def setContentBlockType(self, type: PyAx.AcPredefBlockType, /) -> None: ...
    def setContentType(self, type: PyAx.AcMLeaderContentType, /) -> None: ...
    def setDogLegged(self, enabled: bool, /) -> None: ...
    def setDoglegDirection(self, index: int, direction: PyGe.Vector3d, /) -> None: ...
    def setDoglegLength(self, length: float, /) -> None: ...
    def setLandingGap(self, gap: float, /) -> None: ...
    def setLeaderLineColor(self, color: PyAx.AcadAcCmColor, /) -> None: ...
    def setLeaderLineVertices(
        self, leader_index: int, points: Collection[PyGe.Point3d], /
    ) -> None: ...
    def setLeaderLineWeight(self, weight: PyAx.AcLineWeight, /) -> None: ...
    def setLeaderLinetype(self, linetype_name: str, /) -> None: ...
    def setLeaderType(self, type: PyAx.AcMLeaderType, /) -> None: ...
    def setScaleFactor(self, factor: float, /) -> None: ...
    def setStyleName(self, name: str, /) -> None: ...
    def setTextAttachmentDirection(self, direction: PyAx.AcTextAttachmentDirection, /) -> None: ...
    def setTextBackgroundFill(self, enabled: bool, /) -> None: ...
    def setTextBottomAttachmentType(self, type: PyAx.AcVerticalTextAttachmentType, /) -> None: ...
    def setTextDirection(self, direction: PyAx.AcDrawingDirection, /) -> None: ...
    def setTextFrameDisplay(self, enabled: bool, /) -> None: ...
    def setTextHeight(self, height: float, /) -> None: ...
    def setTextJustify(self, justify: PyAx.AcAttachmentPoint, /) -> None: ...
    def setTextLeftAttachmentType(self, type: PyAx.AcTextAttachmentType, /) -> None: ...
    def setTextLineSpacingDistance(self, distance: float, /) -> None: ...
    def setTextLineSpacingFactor(self, factor: float, /) -> None: ...
    def setTextLineSpacingStyle(self, style: PyAx.AcLineSpacingStyle, /) -> None: ...
    def setTextRightAttachmentType(self, type: PyAx.AcTextAttachmentType, /) -> None: ...
    def setTextRotation(self, rotation: float, /) -> None: ...
    def setTextString(self, text: str, /) -> None: ...
    def setTextStyleName(self, name: str, /) -> None: ...
    def setTextTopAttachmentType(self, type: PyAx.AcVerticalTextAttachmentType, /) -> None: ...
    ...
    def vertexCount(self, leader_index: int, /) -> int: ...
...
class AcadMLeaderStyle(PyAx.AcadObject):
    ...
    def setAlignSpace(self, space: float, /) -> None: ...
    def setAnnotative(self, enabled: bool, /) -> None: ...
    def setArrowSize(self, size: float, /) -> None: ...
    def setArrowSymbol(self, symbol_name: str, /) -> None: ...
    def setBitFlags(self, flags: int, /) -> None: ...
    def setBlock(self, block_name: PyAx.AcadAcCmColor, /) -> None: ...
    def setBlockConnectionType(self, connection_type: PyAx.AcBlockConnectionType, /) -> None: ...
    def setBlockRotation(self, rotation: float, /) -> None: ...
    def setBlockScale(self, scale: float, /) -> None: ...
    def setBreakSize(self, size: float, /) -> None: ...
    def setContentType(self, content_type: PyAx.AcMLeaderContentType, /) -> None: ...
    def setDescription(self, description_text: str, /) -> None: ...
    def setDoglegLength(self, length: float, /) -> None: ...
    def setDrawLeaderOrderType(self, order_type: PyAx.AcDrawLeaderOrderType, /) -> None: ...
    def setDrawMLeaderOrderType(self, order_type: PyAx.AcMLeaderContentType, /) -> None: ...
    def setEnableBlockRotation(self, enabled: bool, /) -> None: ...
    def setEnableBlockScale(self, enabled: bool, /) -> None: ...
    def setEnableDogleg(self, enabled: bool, /) -> None: ...
    def setEnableFrameText(self, enabled: bool, /) -> None: ...
    def setEnableLanding(self, enabled: bool, /) -> None: ...
    def setFirstSegmentAngleConstraint(self, angle_type: PyAx.AcSegmentAngleType, /) -> None: ...
    def setLandingGap(self, gap_distance: float, /) -> None: ...
    def setLeaderLineColor(self, color: PyAx.AcadAcCmColor, /) -> None: ...
    def setLeaderLineType(self, line_type: PyAx.AcMLeaderType, /) -> None: ...
    def setLeaderLineTypeId(self, line_type_id: str, /) -> None: ...
    def setLeaderLineWeight(self, weight: AcLineWeight, /) -> None: ...
    def setMaxLeaderSegmentsPoints(self, point_count: int, /) -> None: ...
    def setName(self, style_name: str, /) -> None: ...
    def setScaleFactor(self, factor: float, /) -> None: ...
    def setSecondSegmentAngleConstraint(self, angle_type: PyAx.AcSegmentAngleType, /) -> None: ...
    def setTextAlignmentType(self, alignment_type: PyAx.AcTextAlignmentType, /) -> None: ...
    def setTextAngleType(self, angle_type: PyAx.AcTextAngleType, /) -> None: ...
    def setTextAttachmentDirection(self, direction: PyAx.AcTextAttachmentDirection, /) -> None: ...
    def setTextBottomAttachmentType(
        self, attachment_type: PyAx.AcVerticalTextAttachmentType, /
    ) -> None: ...
    def setTextColor(self, color: PyAx.AcadAcCmColor, /) -> None: ...
    def setTextHeight(self, height: float, /) -> None: ...
    def setTextLeftAttachmentType(self, attachment_type: PyAx.AcTextAttachmentType, /) -> None: ...
    def setTextRightAttachmentType(
        self, attachment_type: PyAx.AcTextAttachmentType, /
    ) -> None: ...
    def setTextString(self, text: str, /) -> None: ...
    def setTextStyle(self, style_name: str, /) -> None: ...
    def setTextTopAttachmentType(
        self, attachment_type: PyAx.AcVerticalTextAttachmentType, /
    ) -> None: ...
...
class AcadMText(PyAx.AcadEntity):
    ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadMText: ...
    @staticmethod
    def className() -> str: ...
    ...
    def normal(self, /) -> PyGe.Vector3d: ...
    def rotation(self, /) -> float: ...
    def setAttachmentPoint(self, attachment_point: PyAx.AcAttachmentPoint, /) -> None: ...
    def setBackgroundFill(self, enable_background: bool, /) -> None: ...
    def setDrawingDirection(self, drawing_direction: PyAx.AcDrawingDirection, /) -> None: ...
    def setHeight(self, height_value: float, /) -> None: ...
    def setInsertionPoint(self, insertion_point: PyGe.Point3d, /) -> None: ...
    def setLineSpacingDistance(self, spacing_distance: float, /) -> None: ...
    def setLineSpacingFactor(self, spacing_factor: float, /) -> None: ...
    def setLineSpacingStyle(self, spacing_style: str, /) -> None: ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setRotation(self, rotation_angle: float, /) -> None: ...
    def setStyleName(self, style_name: str, /) -> None: ...
    def setTextString(self, text_content: str, /) -> None: ...
    def setWidth(self, width_value: float, /) -> None: ...
    def styleName(self, /) -> str: ...
    def text(self, /) -> str: ...
    def textString(self, /) -> str: ...
...
class AcadPViewport(PyAx.AcadEntity):
    ...
    def setArcSmoothness(self, smoothness_value: int, /) -> None: ...
    def setCenter(self, point: PyGe.Point3d, /) -> None: ...
    def setCustomScale(self, scale_factor: float, /) -> None: ...
    def setDirection(self, vector: PyGe.Vector3d, /) -> None: ...
    def setDisplayLocked(self, lock_display: bool, /) -> None: ...
    def setGridOn(self, enable_grid: bool, /) -> None: ...
    def setGridSpacing(self, XSpacing: float, YSpacing: float, /) -> None: ...
    def setHeight(self, height_value: float, /) -> None: ...
    def setLabelBlockId(self, block_id: PyDb.ObjectId, /) -> None: ...
    def setLensLength(self, length_value: float, /) -> None: ...
    def setModelView(self, view_object: PyAx.AcadView, /) -> None: ...
    def setRemoveHiddenLines(self, remove_lines: bool, /) -> None: ...
    def setShadePlot(self, plot_style: int, /) -> None: ...
    def setSheetView(self, view_object: PyAx.AcadView, /) -> None: ...
    def setSnapBasePoint(self, point: PyGe.Point2d, /) -> None: ...
    def setSnapOn(self, enable_snap: bool, /) -> None: ...
    def setSnapRotationAngle(self, angle_value: float, /) -> None: ...
    def setSnapSpacing(self, XSpacing: float, YSpacing: float, /) -> None: ...
    def setStandardScale(self, scale_value: PyAx.AcviewportScale, /) -> None: ...
    def setStandardScale2(self, scale_value: int, /) -> None: ...
    def setStyleSheet(self, stylesheet_name: str, /) -> None: ...
    def setTarget(self, point: PyGe.Point3d, /) -> None: ...
    def setTwistAngle(self, angle_value: float, /) -> None: ...
    def setUCSIconAtOrigin(self, origin_ucs_icon: bool, /) -> None: ...
    def setUCSIconOn(self, show_ucs_icon: bool, /) -> None: ...
    def setUCSPerViewport(self, enable_ucs: bool, /) -> None: ...
    def setViewportOn(self, enable_viewport: bool, /) -> None: ...
    def setVisualStyle(self, style_value: int, /) -> None: ...
    def setWidth(self, width_value: float, /) -> None: ...
...
class AcadPlotConfiguration(PyAx.AcadObject):
    ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadPlotConfiguration: ...
    def centerPlot(self, /) -> bool: ...
    @staticmethod
    def className() -> str: ...
    def configName(self, /) -> str: ...
    def copyFrom(self, source_config: PyAx.AcadPlotConfiguration, /) -> None: ...
    def customScale(self, /) -> tuple[float, float]: ...
    def localeMediaName(self, media_name: str, /) -> str: ...
    ...
    def setCanonicalMediaName(self, media_name: str, /) -> None: ...
    def setCenterPlot(self, center: bool, /) -> None: ...
    def setConfigName(self, config_name: str, /) -> None: ...
    def setCustomScale(self, numerator: float, denominator: float, /) -> None: ...
    def setName(self, plot_config_name: str, /) -> None: ...
    def setPaperUnits(self, units: PyAx.AcPlotPaperUnits, /) -> None: ...
    def setPlotHidden(self, plot_hidden: bool, /) -> None: ...
    def setPlotOrigin(self, origin: PyGe.Point2d, /) -> None: ...
    def setPlotRotation(self, rotation: PyAx.AcPlotRotation, /) -> None: ...
    def setPlotType(self, plot_type: PyAx.AcPlotType, /) -> None: ...
    def setPlotViewportBorders(self, plot_borders: bool, /) -> None: ...
    def setPlotViewportsFirst(self, viewports_first: bool, /) -> None: ...
    def setPlotWithLineweights(self, plot_weights: bool, /) -> None: ...
    def setPlotWithPlotStyles(self, plot_styles: bool, /) -> None: ...
    def setScaleLineweights(self, scale_weights: bool, /) -> None: ...
    def setShowPlotStyles(self, show_styles: bool, /) -> None: ...
    def setStandardScale(self, scale: PyAx.AcPlotScale, /) -> None: ...
    def setStyleSheet(self, style_sheet: str, /) -> None: ...
    def setUseStandardScale(self, use_standard: bool, /) -> None: ...
    def setViewToPlot(self, view_name: str, /) -> None: ...
    def setWindowToPlot(self, lower_left: PyGe.Point2d, upper_right: PyGe.Point2d, /) -> None: ...
...
class AcadPoint(PyAx.AcadEntity):
    ...
    def normal(self, /) -> PyGe.Vector3d: ...
    def setCoordinates(self, point: PyGe.Point3d, /) -> None: ...
    def setNormal(self, vector: PyGe.Vector3d, /) -> None: ...
    def setThickness(self, thickness_value: float, /) -> None: ...
    def thickness(self, /) -> float: ...
...
class AcadPolygonMesh(PyAx.AcadEntity):
    ...
    def setCoordinate(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def setCoordinates(self, coords: Collection[PyGe.Point3d], /) -> None: ...
    def setMClose(self, is_closed: bool, /) -> None: ...
    def setMDensity(self, density: int, /) -> None: ...
    def setNClose(self, is_closed: bool, /) -> None: ...
    def setNDensity(self, density: int, /) -> None: ...
    def setType(self, mesh_type: PyAx.AcPolymeshType, /) -> None: ...
...
class AcadPolyline(PyAx.AcadEntity):
    ...
    def __reduce__(self, /) -> Any: ...
    def area(self, /) -> float: ...
    def bulge(self, segment_index: int, /) -> float: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadPolyline: ...
    @staticmethod
    def className() -> str: ...
    def constantWidth(self, /) -> float: ...
    def coordinate(self, index: int, /) -> PyGe.Point3d: ...
    ...
    def normal(self, /) -> PyGe.Vector3d: ...
    def offset(self, distance: float, /) -> list[PyAx.AcadEntity]: ...
    def setBulge(self, segment_index: int, bulge_value: float, /) -> None: ...
    def setClosed(self, closed_flag: bool, /) -> None: ...
    def setConstantWidth(self, width_value: float, /) -> None: ...
    def setCoordinate(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def setCoordinates(self, points: Collection[PyGe.Point3d], /) -> None: ...
    ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setThickness(self, thickness_value: float, /) -> None: ...
    def setWidth(self, segment_index: int, start_width: float, end_width: float, /) -> None: ...
    def thickness(self, /) -> float: ...
    def width(self, segment_index: int, /) -> tuple: ...
...
class AcadRasterImage(PyAx.AcadEntity):
    ...
    @staticmethod
    def className() -> str: ...
    def clipBoundary(self, boundary: Collection[PyGe.Point2d], /) -> None: ...
    ...
    def setClippingEnabled(self, enabled: bool, /) -> None: ...
    def setContrast(self, value: int, /) -> None: ...
    def setFade(self, value: int, /) -> None: ...
    def setImageFile(self, file_path: str, /) -> None: ...
    def setImageHeight(self, height: float, /) -> None: ...
    def setImageVisibility(self, visible: bool, /) -> None: ...
    def setImageWidth(self, width: float, /) -> None: ...
    def setName(self, image_name: str, /) -> None: ...
    def setOrigin(self, point: PyGe.Point3d, /) -> None: ...
    def setRotation(self, angle: float, /) -> None: ...
    def setScaleFactor(self, factor: float, /) -> None: ...
    def setShowRotation(self, show: bool, /) -> None: ...
    def setTransparency(self, transparent: bool, /) -> None: ...
...
class AcadRay(PyAx.AcadEntity):
    ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadRay: ...
    @staticmethod
    def className() -> str: ...
    def directionVector(self, /) -> PyGe.Vector3d: ...
    def secondPoint(self, /) -> PyGe.Point3d: ...
    def setBasePoint(self, point: PyGe.Point3d, /) -> None: ...
    def setDirectionVector(self, vector: PyGe.Vector3d, /) -> None: ...
    def setSecondPoint(self, point: PyGe.Point3d, /) -> None: ...
...
class AcadSection(PyAx.AcadEntity):
    def __init__(self) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def addVertex(self, index: int, point: PyGe.Point3d, /) -> None: ...
    ...
    def className() -> str: ...
    def coordinate(self, index: int, /) -> PyGe.Point3d: ...
    def createJog(self, point: PyGe.Point3d, /) -> None: ...
    def elevation(self, /) -> float: ...
    def generateSectionGeometry(self, entity: PyAx.AcadEntity, /) -> tuple: ...
    def hitTest(self, point: PyGe.Point3d, /) -> tuple: ...
    ...
    def setBottomHeight(self, height: float, /) -> None: ...
    def setCoordinate(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def setElevation(self, elev: float, /) -> None: ...
    def setIndicatorFillColor(self, color: PyAx.AcadAcCmColor, /) -> None: ...
    def setIndicatorTransparency(self, transparency: int, /) -> None: ...
    def setLiveSectionEnabled(self, enabled: bool, /) -> None: ...
    def setName(self, section_name: str, /) -> None: ...
    def setState(self, state: PyAx.AcSectionState, /) -> None: ...
    def setTopHeight(self, height: float, /) -> None: ...
    def setVerticalDirection(self, direction: PyGe.Vector3d, /) -> None: ...
    def setVertices(self, coordinates: Collection[PyGe.Point3d], /) -> None: ...
    def setViewingDirection(self, direction: PyGe.Vector3d, /) -> None: ...
...
class AcadSectionSettings(PyAx.AcadObject):
    ...
    def setCurrentSectionType(self, secType: PyAx.AcSectionType, /) -> None: ...
...
class AcadShape(PyAx.AcadEntity):
    ...
    def __reduce__(self, /) -> Any: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadShape: ...
    @staticmethod
    def className() -> str: ...
    def height(self, /) -> float: ...
    def insertionPoint(self, /) -> PyGe.Point3d: ...
    ...
    def setHeight(self, height_value: float, /) -> None: ...
    def setInsertionPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setName(self, shape_name: str, /) -> None: ...
    def setNormal(self, vector: PyGe.Vector3d, /) -> None: ...
    def setObliqueAngle(self, angle: float, /) -> None: ...
    def setRotation(self, angle: float, /) -> None: ...
    def setScaleFactor(self, factor: float, /) -> None: ...
    def setThickness(self, thickness_value: float, /) -> None: ...
    def thickness(self, /) -> float: ...
...
class AcadSpline(PyAx.AcadEntity):
    def __init__(self) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def addFitPoint(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def area(self, /) -> float: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadSpline: ...
    @staticmethod
    def className() -> str: ...
    def closed(self, /) -> bool: ...
    def closed2(self, /) -> bool: ...
    def controlPoint(self, index: int, /) -> PyGe.Point3d: ...
    ...
    def fitPoint(self, index: int, /) -> PyGe.Point3d: ...
    ...
    def setClosed2(self, is_closed: bool, /) -> None: ...
    def setControlPoint(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def setControlPoints(self, points: Collection[PyGe.Point3d], /) -> None: ...
    def setDegree2(self, degree: int, /) -> None: ...
    def setEndTangent(self, tangent: PyGe.Vector3d, /) -> None: ...
    def setFitPoint(self, index: int, point: PyGe.Point3d, /) -> None: ...
    def setFitPoints(self, points: Collection[PyGe.Point3d], /) -> None: ...
    def setFitTolerance(self, tolerance: float, /) -> None: ...
    def setKnotParameterization(
        self, param_type: PyAx.AcSplineKnotParameterizationType, /
    ) -> None: ...
    def setKnots(self, knots: Collection[PyGe.Vector3d], /) -> None: ...
    def setSplineFrame(self, frame_type: PyAx.AcSplineFrameType, /) -> None: ...
    def setSplineMethod(self, method_type: PyAx.AcSplineMethodType, /) -> None: ...
    def setStartTangent(self, tangent: PyGe.Vector3d, /) -> None: ...
    def setWeight(self, index: int, weight: float, /) -> None: ...
    def setWeights(self, weights: Collection[float], /) -> None: ...
...
class AcadTable(PyAx.AcadEntity):
    ...
    def columnName(self, col: int, /) -> str: ...
    ...
    def customData(self, row: int, col: int, key: str, /) -> PyDb.AcValue: ...
...
class AcadTableStyle(PyAx.AcadObject):
    def __init__(self) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def alignment(self, cell_style_name: str, /) -> AcCellAlignment: ...
    def backgroundColor(self, cell_style_name: str, /) -> AcadAcCmColor: ...
    def bitFlags(self, /) -> int: ...
    @staticmethod
    def cast(otherObject: PyAx.AcadObject, /) -> AcadTableStyle: ...
    def cellClass(self, cell_style_name: str, /) -> int: ...
    def cellStyles(self, /) -> list[str]: ...
    @staticmethod
    def className() -> str: ...
    def color(self, cell_style_name: str, /) -> AcadAcCmColor: ...
    def createCellStyle(self, cell_style_name: str, /) -> None: ...
    def createCellStyleFromStyle(self, new_cell_style: str, source_cell_style: str, /) -> None: ...
    def dataType(
        self, cell_style_name: str, /
    ) -> tuple[PyAx.AcValueDataType, PyAx.AcValueUnitType]: ...
    def deleteCellStyle(self, cell_style_name: str, /) -> None: ...
    def description(self, /) -> str: ...
    def enableMergeAll(self, cell_style_name: str, enable_flag: bool, /) -> None: ...
    def flowDirection(self, /) -> AcTableDirection: ...
    def format(self, cell_style_name: str, /) -> str: ...
    def gridColor(
        self, cell_style_name: str, grid_line_type: PyAx.AcGridLineType, /
    ) -> AcadAcCmColor: ...
    def gridLineWeight(
        self, cell_style_name: str, grid_line_type: PyAx.AcGridLineType, /
    ) -> AcLineWeight: ...
    ...
    def headerSuppressed(self, /) -> bool: ...
    def horzCellMargin(self, /) -> float: ...
    def isCellStyleInUse(self, cell_style_name: str, /) -> bool: ...
    def isMergeAllEnabled(self, cell_style_name: str, /) -> bool: ...
    def name(self, /) -> str: ...
    def numCellStyles(self, /) -> int: ...
    def renameCellStyle(self, old_name: str, new_name: str, /) -> None: ...
    def rotation(self, cell_style_name: str, /) -> float: ...
    def setAlignment(
        self, cell_style_name: str, alignment_type: PyAx.AcCellAlignment, /
    ) -> None: ...
    def setBackgroundColor(
        self, cell_style_name: str, color_value: PyAx.AcadAcCmColor, /
    ) -> None: ...
    def setBitFlags(self, flags_value: int, /) -> None: ...
    def setCellClass(self, cell_style_name: str, class_value: int, /) -> None: ...
    def setColor(self, cell_style_name: str, color_value: PyAx.AcadAcCmColor, /) -> None: ...
    def setDataType(
        self,
        cell_style_name: str,
        data_type: PyAx.AcValueDataType,
        unit_type: PyAx.AcValueUnitType,
        /,
    ) -> None: ...
    def setDescription(self, description_text: str, /) -> None: ...
    def setFlowDirections(self, direction: PyAx.AcTableDirection, /) -> None: ...
    def setFormat(self, cell_style_name: str, format_string: str, /) -> None: ...
    def setGridColor(
        self,
        cell_style_name: str,
        grid_line_type: PyAx.AcGridLineType,
        color_value: PyAx.AcadAcCmColor,
        /,
    ) -> None: ...
    def setGridLineWeight(
        self,
        cell_style_name: str,
        grid_line_type: PyAx.AcGridLineType,
        line_weight: PyAx.AcLineWeight,
        /,
    ) -> None: ...
    def setGridVisibility(
        self, cell_style_name: str, grid_line_type: PyAx.AcGridLineType, visibility_flag: bool, /
    ) -> None: ...
    def setHeaderSuppressed(self, suppress_flag: bool, /) -> None: ...
    def setHorzCellMargin(self, margin_value: float, /) -> None: ...
    def setName(self, style_name: str, /) -> None: ...
    def setRotation(self, cell_style_name: str, rotation_angle: int, /) -> None: ...
    def setTemplateId(
        self,
        id: PyDb.ObjectId,
    ...
    def setTextHeight(self, cell_style_name: str, height_value: float, /) -> None: ...
    def setTextStyleId(self, cell_style_name: str, text_style_id: PyDb.ObjectIdr, /) -> None: ...
    def setTitleSuppressed(self, suppress_flag: bool, /) -> None: ...
    def setVertCellMargin(self, margin_value: float, /) -> None: ...
    def templateId(self, /) -> PyDb.ObjectId: ...
    def textHeight(self, cell_style_name: str, /) -> float: ...
    def textStyleId(self, cell_style_name: str, /) -> PyDb.ObjectId: ...
    def titleSuppressed(self, /) -> bool: ...
    def uniqueCellStyleName(self, base_name: str, /) -> str: ...
    def vertCellMargin(self, /) -> float: ...
...
class AcadText(PyAx.AcadEntity):
    ...
    def backward(self, /) -> bool: ...
    @staticmethod
    def cast(other_object: PyAx.AcadObject, /) -> AcadText: ...
    @staticmethod
    def className() -> str: ...
    def fieldCode(self, /) -> str: ...
    def height(self, /) -> float: ...
    ...
    def rotation(self, /) -> float: ...
    def scaleFactor(self, /) -> float: ...
    def setAlignment(self, alignment_type: PyAx.AcAlignment, /) -> None: ...
    def setBackward(self, is_backward: bool, /) -> None: ...
    def setHeight(self, text_height: float, /) -> None: ...
    def setHorizontalAlignment(self, horiz_alignment: PyAx.AcHorizontalAlignment, /) -> None: ...
    def setInsertionPoint(self, insertion_point: PyGe.Point3d, /) -> None: ...
    def setNormal(self, normal_vector: PyGe.Vector3d, /) -> None: ...
    def setObliqueAngle(self, oblique_angle: float, /) -> None: ...
    def setRotation(self, rotation_angle: float, /) -> None: ...
    def setScaleFactor(self, scale_factor: float, /) -> None: ...
    def setStyleName(self, style_name: str, /) -> None: ...
    def setTextAlignmentPoint(self, alignment_point: PyGe.Point3d, /) -> None: ...
    def setTextGenerationFlag(self, generation_flag: int, /) -> None: ...
    def setTextString(self, text: str, /) -> None: ...
    def setThickness(self, thickness_value: float, /) -> None: ...
    def setUpsideDown(self, is_upsidedown: bool, /) -> None: ...
    def setVerticalAlignment(self, vert_alignment: PyAx.AcVerticalAlignment, /) -> None: ...
    def styleName(self, /) -> str: ...
    def textAlignmentPoint(self, /) -> PyGe.Point3d: ...
    def textGenerationFlag(self, /) -> int: ...
    def textString(self, /) -> str: ...
...
class AcadTextStyle(PyAx.AcadObject):
    ...
    def name(self, /) -> str: ...
    def obliqueAngle(self, /) -> float: ...
    def setBigFontFile(self, font_file: str, /) -> None: ...
    def setFont(
        self, typeFace: str, bold: bool, italic: bool, charset: int, pitchAndFamily: int, /
    ) -> None: ...
    def setFontFile(self, font_file: str, /) -> None: ...
    def setHeight(self, text_height: float, /) -> None: ...
    def setLastHeight(self, last_height: float, /) -> None: ...
    def setObliqueAngle(self, angle: float, /) -> None: ...
    def setTextGenerationFlag(self, flag: int, /) -> None: ...
    def setWidth(self, width_factor: float, /) -> None: ...
    def textGenerationFlag(self, /) -> int: ...
    def width(self, /) -> float: ...
...
class AcadTolerance(PyAx.AcadEntity):
    ...
    def normal(self, /) -> PyGe.Vector3d: ...
    def scaleFactor(self, /) -> float: ...
    def setDimensionLineColor(self, color_index: float, /) -> None: ...
    def setDirectionVector(self, direction: PyGe.Vector3d, /) -> None: ...
    def setInsertionPoint(self, point: PyGe.Point3d, /) -> None: ...
    def setNormal(self, normal: PyGe.Vector3d, /) -> None: ...
    def setScaleFactor(self, factor: float, /) -> None: ...
    def setStyleName(self, name: str, /) -> None: ...
    def setTextColor(self, color: PyAx.AcColor, /) -> None: ...
    def setTextHeight(self, height: float, /) -> None: ...
    def setTextString(self, text: str, /) -> None: ...
    def setTextStyle(self, name: str, /) -> None: ...
    def styleName(self, /) -> str: ...
    def textColor(self, /) -> AcColor: ...
    def textHeight(self, /) -> float: ...
    def textString(self, /) -> str: ...
...
class AcadUCS(PyAx.AcadObject):
    ...
    def name(self, /) -> str: ...
    def origin(self, /) -> PyGe.Point3d: ...
    def setName(self, ucs_name: str, /) -> None: ...
    def setOrigin(self, origin_point: PyGe.Point3d, /) -> None: ...
    def setXVector(self, x_axis_vector: PyGe.Vector3d, /) -> None: ...
    def setYVector(self, y_axis_vector: PyGe.Vector3d, /) -> None: ...
...
class AcadUtility:
    ...
    def isRemoteFile(self, localFile: str, /) -> tuple: ...
...
class AcadView(PyAx.AcadObject):
    ...
    def name(self, /) -> str: ...
    def setCategoryName(self, category_name: str, /) -> None: ...
    def setCenter(self, point: PyGe.Point3d, /) -> None: ...
    def setDirection(self, vector: PyGe.Vector3d, /) -> None: ...
    def setHasVpAssociation(self, association_state: str, /) -> None: ...
    def setHeight(self, height_value: float, /) -> None: ...
    def setLayerState(self, state_name: str, /) -> None: ...
    def setLayoutId(self, layout_id: PyDb.ObjectId, /) -> None: ...
    def setName(self, view_name: str, /) -> None: ...
    def setTarget(self, point: PyGe.Point3d, /) -> None: ...
    def setWidth(self, width_value: float, /) -> None: ...
    def target(self, /) -> PyGe.Point3d: ...
    def width(self, /) -> float: ...
...
class AcadViewport(PyAx.AcadObject):
    ...
    def setArcSmoothness(self, smoothness_value: int, /) -> None: ...
    def setCenter(self, center_point: PyGe.Point3d, /) -> None: ...
    def setDirection(self, view_direction: PyGe.Vector3d, /) -> None: ...
    def setGridOn(self, show_grid: bool, /) -> None: ...
    def setGridSpacing(self, XSpacing: float, YSpacing: float, /) -> None: ...
    def setHeight(self, height_value: float, /) -> None: ...
    def setName(self, viewport_name: str, /) -> None: ...
    def setOrthoOn(self, enable_ortho: bool, /) -> None: ...
    def setSnapBasePoint(self, snap_point: PyGe.Point3d, /) -> None: ...
    def setSnapOn(self, enable_snap: bool, /) -> None: ...
    def setSnapRotationAngle(self, rotation_angle: float, /) -> None: ...
    def setSnapSpacing(self, XSpacing: float, YSpacing: float, /) -> None: ...
    def setTarget(self, target_point: PyGe.Point3d, /) -> None: ...
    def setUCSIconAtOrigin(self, ucs_at_origin: bool, /) -> None: ...
    def setUCSIconOn(self, show_ucs_icon: bool, /) -> None: ...
    def setView(self, view_object: PyAx.AcadView, /) -> None: ...
    def setWidth(self, width_value: float, /) -> None: ...
    def snapBasePoint(self, /) -> PyGe.Point3d: ...
    def snapOn(self, /) -> bool: ...
    def snapRotationAngle(self, /) -> float: ...
    def snapSpacing(self, /) -> tuple[float, float]: ...
    def split(self, split_type: PyAx.AcviewportSplitType, /) -> None: ...
    def target(self, /) -> PyGe.Point3d: ...
    def ucsIconAtOrigin(self, /) -> bool: ...
    def ucsIconOn(self, /) -> bool: ...
...
class AcadXRecord(PyAx.AcadObject):
    ...
    def name(self, /) -> str: ...
    def setName(self, name: str, /) -> None: ...
    def setTranslateIDs(self, flag: bool, /) -> None: ...
...
class AcadXline(PyAx.AcadEntity):
    ...
    def secondPoint(self, /) -> PyGe.Point3d: ...
    def setBasePoint(self, basePoint: PyGe.Point3d, /) -> None: ...
    def setDirectionVector(self, direction: PyGe.Vector3d, /) -> None: ...
    def setSecondPoint(self, secondPoint: PyGe.Point3d, /) -> None: ...
