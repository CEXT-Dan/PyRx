...
class Application:
    ...
    @staticmethod
    def applyHostIcon(hwnd: int, /) -> None: ...
    @staticmethod
    def className() -> str: ...
    @staticmethod
    ...
    @staticmethod
    def getInvisibleBorderWidth(hwnd: int, /) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def listFilesInPath(path: str, ext: str, /) -> list[str]: ...
    @staticmethod
    def listFilesInPathRecursive(path: str, ext: str, /) -> list[str]: ...
    @staticmethod
    ...
    @staticmethod
    def setTitleThemeDark(hwnd: int, /) -> None: ...
    @staticmethod
...
class DocManagerReactor:
    ...
    def documentBecameCurrent(self, doc: Document, /) -> None:
        ...
        """
    def documentCreateCanceled(self, doc: Document, /) -> None:
        """
        ...
        """
    def documentCreateStarted(self, doc: Document, /) -> None:
        """
        This notification is sent when a document is first instantiated and no database is yet
        available.
        """
    def documentCreated(self, doc: Document, /) -> None:
        """
        ...
        """
    def documentDestroyed(self, doc: str, /) -> None:
        """
    ...
    def documentLockModeWillChange(
        ...
        """
    def documentToBeActivated(self, doc: Document, /) -> None:
        """
        This notification is sent when a document is about to be activated.
        """
    def documentToBeDeactivated(self, doc: Document, /) -> None:
        """
        This notification is sent when a document is about to be deactivated.
        """
    def documentToBeDestroyed(self, doc: Document, /) -> None:
        """
...
class Internal:
    ...
    @staticmethod
    def roundTripStringTest(strings: list[str], /) -> list: ...
    @staticmethod
...
class LayerFilter(PyRx.RxObject):
    def __init__(self, /) -> None:
        ...
        """
    def __reduce__(self, /) -> Any: ...
    def addNested(self, nested_filter: PyAp.LayerFilter, /) -> None:
        """
    ...
    @staticmethod
    def className() -> str: ...
    def compareTo(self, other_filter: PyAp.LayerFilter, /) -> bool:
        """
    ...
    def dynamicallyGenerated(self, /) -> bool:
        ...
        """
    def filter(self, layer_record: PyDb.LayerTableRecord, /) -> bool:
        """
    ...
    def filterExpression(self, /) -> str:
        ...
        """
    def filterExpressionTree(self, /) -> list[tuple[str, str]]: ...
    ...
    def parent(self, /) -> LayerFilter:
        ...
        """
    def removeNested(self, nested_filter: PyAp.LayerFilter, /) -> None:
        """
    ...
    def setFilterExpression(self, expression: str, /) -> None:
        ...
        """
    def setName(self, filter_name: str, /) -> None:
        """
...
class LayoutManager(PyDb.LayoutManager):
    ...
    def createLayoutFromTemplate(
        self, newLayoutName: str, templatePath: str, layoutName: str, db: PyDb.Database = ..., /
    ) -> PyDb.ObjectId:
        """
    ...
    def desc() -> PyRx.RxClass:
        ...
        by the returned pointer was created by an ObjectARX application that will not be unloaded.
        """
    def generateNextNewLayoutName(self, useDb: PyDb.Database = ..., /) -> str:
        """
    ...
    def getActiveTab(self, /) -> str:
        ...
        """
    def getClipBoundaryElabration(self, id: PyDb.ObjectId, /) -> list[PyGe.Point2d]: ...
    def pageSetup(
        self,
        ...
        """
    def pointInViewports(self, id: PyGe.Point3d, /) -> list[PyDb.ObjectId]:
        """
        ...
        """
    def setCaptureOnLayoutSwitch(self, id: bool, /) -> None:
        """
    ...
    def setShowPaperBackground(self, show_paper_background: bool, /) -> None:
        ...
        """
    def setShowPaperMargins(self, show_paper_margins: bool, /) -> None:
        """
        ...
        """
    def setShowPrintBorder(self, show_print_border: bool, /) -> None:
        """
        ...
        it invisible.
        """
    def setShowTabs(self, show_tabs: bool, /) -> None:
        """
...
class PaletteSet:
    ...
    def propertiesMenuStyle(self, /) -> bool:
        ...
        false.
        """
    def removePalette(self, nPaletteIndex: int, /) -> bool:
        """
    ...
    def setTitleBarLocation(self, loc: PyAp.PaletteTitleBarLocation, /) -> None:
        """
...
@overload
def Command(CmdFlags: PyAp.CmdFlags, /) -> _CommandDecorator: ...
@overload
