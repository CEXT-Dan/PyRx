...
class BimBuilding(PyBrxBim.BimSpatialLocation):
    ...
    def __reduce__(self, /) -> Any: ...
    @staticmethod
    def allObjectBuildings(db: PyDb.Database, /) -> list[PyBrxBim.BimBuilding]: ...
    def allObjectStories(self, /) -> list[PyBrxBim.BimStory]: ...
    @staticmethod
    def allObjectStoriesFromDb(db: PyDb.Database, /) -> list[PyBrxBim.BimStory]: ...
    @staticmethod
    def allStringBuildings(db: PyDb.Database, /) -> list[str]: ...
    def allStringStories(self, /) -> list[str]: ...
    @staticmethod
    def allStringStoriesFromDb(db: PyDb.Database, /) -> list[str]: ...
    def assignToEntity(self, id: PyDb.ObjectId, /) -> None: ...
    @staticmethod
    def assignedBuilding(building: PyBrxBim.BimBuilding, id: PyDb.ObjectId, /) -> None: ...
    def assignedObjects(self, db: PyDb.Database, /) -> list[PyDb.ObjectId]: ...
    @staticmethod
    ...
    def createStory(self, name: str, /) -> BimStory: ...
    def deleteBuilding(self, db: PyDb.Database, /) -> None: ...
    @staticmethod
