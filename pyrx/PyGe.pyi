...
Helix: EntityId  # 80
KConformToEdges: CDTOpts  # 16
KEraseSuperTriangle: CDTOpts  # 1
KInsertEdges: CDTOpts  # 8
k0Arg1: AcGeError  # 2
k0Arg2: AcGeError  # 3
k0This: AcGeError  # 1
...
kEraseOuterTriangles: CDTOpts  # 2
kEraseOuterTrianglesAndHoles: CDTOpts  # 4
...
class BoundBlock2d(PyGe.Entity2d):
    ...
    def clipCircArc2d(self, seg2d: PyGe.CircArc2d, /) -> tuple[bool, list[PyGe.CircArc2d]]:
        ...
        of reentry
        """
    def clipCircArc3d(self, seg2d: PyGe.CircArc3d, /) -> tuple:
        """
        This function clips or trims a PyGe.CircArc2d to the bounding box defined by min/max
        coordinates. It returns a tuple (bool, list[PyGe.CircArc2d]). It returns True if the
        segment is inside the box and has been clipped to a valid line segment. It returns False
    ...
    def clipLineSeg2d(self, seg2d: PyGe.LineSeg2d, /) -> tuple[bool, PyGe.LineSeg2d]:
        ...
        """
    def clipLineSeg3d(self, seg2d: PyGe.LineSeg3d, /) -> tuple:
        """
        Using the Liang-Barsky algorithm, this function clips or trims a PyGe.LineSeg2d to the
        bounding box defined by min/max coordinates. It returns a tuple (bool, PyGe.LineSeg2d). It
        returns True if the segment is inside the box and has been clipped to a valid line segment.
...
class CDT:
    ...
    @staticmethod
    def triangulate(
        points: Collection[PyGe.Point3d], edges: Collection[tuple[int, int]], opts: PyGe.CDTOpts, /
    ) -> tuple[PyGe.Point3dArray, list[tuple[int, int, int]]]: ...

class CDTOpts(_BoostPythonEnum):
...
class CompositeCurve3d(PyGe.Curve3d):
    ...
    @staticmethod
    def createFromPolyCurves(curveList: list[PyGe.Curve3d], /) -> list: ...
    def getCurveList(self, /) -> list[PyGe.Curve3d]: ...
    def globalToLocalParam(self, param: float, /) -> tuple[float, int]: ...
    def localToGlobalParam(self, param: float, segNum: int, /) -> float: ...
    @overload
...
class ExternalBoundedSurface(PyGe.Surface):
    ...
    def externalSurfaceKind(self, /) -> ExternalEntityKind: ...
    def getBaseExternalSurface(self, /) -> ExternalSurface: ...
    def getBaseSurface(self, /) -> Surface: ...
    def getContours(self, /) -> tuple: ...
    def getExternalSurface(self, /) -> Surface: ...
    def isCone(self, /) -> bool: ...
    def isCylinder(self, /) -> bool: ...
    def isDefined(self, /) -> bool: ...
    def isExternalSurface(self, /) -> bool: ...
    def isNurbs(self, /) -> bool: ...
...
class LineSeg2d(PyGe.LinearEnt2d):
    ...
    @overload
    def set(self, curve1: PyGe.Curve2d, pnt: PyGe.Point2d, /) -> None: ...
    @overload
    def set(self, *args) -> None: ...
    def startPoint(self, /) -> Point2d: ...
...
class Matrix3d:
    ...
    def safeInverse(self, /) -> Matrix3d: ...
    def scale(self, /) -> float: ...
    def scale3d(self, /) -> Scale3d: ...
    def scale3dMagnitude(self, /) -> Scale3d: ...
    @staticmethod
...
class Point2d:
    ...
    @overload
    def __sub__(self, val: PyGe.Vector2d, /) -> Point2d: ...
    @overload
    def __sub__(self, val: PyGe.Point2d, /) -> Point2d: ...
    @overload
    def __sub__(self, *args) -> Point2d: ...
...
class Point2dArray:
    ...
    def __init__(self, /) -> None: ...
    @overload
    def __init__(self, pnts: Collection[PyGe.Point2d], /) -> None: ...
    @overload
    def __init__(self, *args) -> None: ...
    def __iter__(self, /) -> Iterator[PyGe.Point2d]: ...
    def __len__(self, /) -> int: ...
    def __reduce__(self, /) -> Any: ...
    def __setitem__(self, /) -> None: ...
    def append(self, pnt: PyGe.Point2d, /) -> None: ...
    def approxShortestTour(self, /) -> Point2dArray: ...
    def approxShortestTourIndexes(self, /) -> list: ...
    def clear(self, /) -> None: ...
    def convexHull(self, /) -> Point2dArray: ...
    def convexHullIndexes(self, /) -> list: ...
    def extend(self, pnt: Collection[PyGe.Point2d], /) -> None: ...
    def pop_back(self, /) -> None: ...
    def shortestTour(self, /) -> Point2dArray: ...
    def shortestTourIndexes(self, /) -> list: ...
...
class Point2dTree:
    ...
    def knnSearch(
        self, point: PyGe.Point2d, num_closest: int, /
    ) -> tuple[list[int], list[float]]: ...
    def radiusSearch(
        self, point: PyGe.Point2d, radius: float, /
    ) -> tuple[list[int], list[float]]: ...
...
class Point3d:
    ...
    def __setitem__(self, idx: int, val: float, /) -> None: ...
    @overload
    def __sub__(self, val: PyGe.Vector3d, /) -> Vector3d: ...
    @overload
    def __sub__(self, val: PyGe.Point3d, /) -> Vector3d: ...
    @overload
    def __sub__(self, *args) -> Vector3d: ...
...
class Point3dArray:
    ...
    def __init__(self, /) -> None: ...
    @overload
    def __init__(self, pnts: Collection[PyGe.Point3d], /) -> None: ...
    @overload
    def __init__(self, *args) -> None: ...
    def __iter__(self, /) -> Iterator[PyGe.Point3d]: ...
    def __len__(self, /) -> int: ...
    def __reduce__(self, /) -> Any: ...
    def __setitem__(self, /) -> None: ...
    def append(self, pnt: PyGe.Point3d, /) -> None: ...
    def approxShortestTour(self, /) -> Point3dArray: ...
    def approxShortestTourIndexes(self, /) -> list: ...
    def clear(self, /) -> None: ...
    ...
    def convexHullIndexes(self, /) -> list: ...
    def extend(self, pnt: Collection[PyGe.Point3d], /) -> None: ...
    def isPlanar(self, /) -> tuple[bool, PyGe.Plane]: ...
    def pop_back(self, /) -> None: ...
    def shortestTour(self, /) -> Point3dArray: ...
    def shortestTourIndexes(self, /) -> list: ...
    def sortByDistFrom(self, basePnt: PyGe.Point3d, /) -> None: ...
    def sortByDynamicDistance(self, basePnt: PyGe.Point3d, /) -> None:
        """
        Reorders a 3D point array in-place using a greedy Nearest Neighbor path algorithm. Starts
        from the initial `basePoint` coordinate, finds the closest point, and then dynamically
        chains subsequent points to their nearest unsorted neighbor.
        """
    def sortByX(self, /) -> None: ...
    def sortByY(self, /) -> None: ...
...
class Point3dTree:
    ...
    def knnSearch(
        self, point: PyGe.Point3d, num_closest: int, /
    ) -> tuple[list[int], list[float]]: ...
    def radiusSearch(
        self, point: PyGe.Point3d, radius: float, /
    ) -> tuple[list[int], list[float]]: ...
