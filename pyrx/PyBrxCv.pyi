...
eElevation: StringLinePointType  # 2
...
eFromAlignment: StringLineCreationSource  # 2
eFromCorridor: StringLineCreationSource  # 1
...
eIntersection: StringLinePointType  # 4
...
eNone: StringLineCreationSource  # 0
...
class CvDbLabelStyle(PyBrxCv.CvDbStyle):
    ...
    def setReadabilityBias(self, radAngle: float, /) -> None: ...
...
class CvDbStringLine(PyBrxCv.CvDbCurve):
    @overload
    def __init__(self, /) -> None: ...
    @overload
    def __init__(self, id: PyDb.ObjectId, /) -> None: ...
    ...
    def __init__(self, *args) -> None: ...
    def __reduce__(self, /) -> Any: ...
    def addPI(self, point: PyGe.Point3d, bulge: float = ..., /) -> None: ...
    @staticmethod
    def cast(otherObject: PyRx.RxObject, /) -> CvDbStringLine: ...
    @staticmethod
    def className() -> str: ...
    @staticmethod
    def cloneFrom(otherObject: PyRx.RxObject, /) -> CvDbStringLine: ...
    def creationSource(self, /) -> StringLineCreationSource: ...
    def deleteElevationPoint(self, val: int | PyGe.Point3d, /) -> None: ...
    def deletePI(self, val: int | PyGe.Point3d, /) -> None: ...
    ...
    def desc() -> PyRx.RxClass:
        ...
        """
    def findPoint(
        self, pointLocation: PyGe.Point2d, pInterval: PyGe.Interval = ..., /
    ) -> tuple: ...
    def get2dDistanceAtParam(self, param: float, /) -> float: ...
    def get2dDistanceAtPoint(self, point: PyGe.Point2d, /) -> float: ...
    def get2dDistancesAtPoints(self, points: list[PyGe.Point2d], /) -> list: ...
    def get3dDistanceAtPoint(self, point: PyGe.Point3d, /) -> float: ...
    def getBulge(self, index: int, /) -> float: ...
    def getElevationAtPoint(self, pointOnCurve: PyGe.Point2d, /) -> float: ...
    def getElevationsAt2dIntersections(self, stringline: PyBrxCv.CvDbStringLine, /) -> list: ...
    def getGradeInAtParam(self, param: float, /) -> float: ...
    def getGradeInAtPoint(self, pointOnCurve: PyGe.Point2d, /) -> float: ...
    def getGradeOutAtParam(self, param: float, /) -> float: ...
    def getGradeOutAtPoint(self, pointOnCurve: PyGe.Point2d, /) -> float: ...
    def getPoint(self, index: int, /) -> tuple: ...
    def getPoints(self, ptype: PyBrxCv.StringLinePointType = ..., /) -> tuple: ...
    def getRadius(self, index: int, /) -> float: ...
    def getRelativeElevation(self, index: int, /) -> float: ...
    def insertCurve(self, index: int, radius: float, /) -> None: ...
    def insertElevationPoint(self, param: float, elevation: float, /) -> int: ...
    def insertPI(self, index: int, point: PyGe.Point3d, bulge: float = ..., /) -> None: ...
    def isRelativeToSurface(self, index: int, /) -> bool: ...
    ...
    def minGrade(self, /) -> float: ...
    def numberOfPoints(self, ptype: PyBrxCv.StringLinePointType = ..., /) -> int: ...
    def setBulge(self, index: int, bulge: float, /) -> None: ...
    def setElevation(self, index: int, elevation: float, /) -> None: ...
    def setGradeIn(self, index: int, grade: float, /) -> None: ...
    def setGradeOut(self, index: int, grade: float, /) -> None: ...
    def setLocation(self, index: int, location: PyGe.Point3d, /) -> None: ...
    def setRadius(self, index: int, radius: float, isClockwise: bool, /) -> None: ...
    def setRelativeElevation(
        self, index: int, isInputRelative: bool, elevation: float, /
    ) -> None: ...
    def setRelativeToSurface(self, index: int, isRelative: bool, /) -> None: ...
    def setSurfaceId(self, surfaceId: PyDb.ObjectId, /) -> None: ...
    def surfaceId(self, /) -> PyDb.ObjectId: ...
    def update(self, forceUpdate: bool = True, /) -> None: ...

class CvDbStringLineManager(PyDb.DbObject):
    @overload
    def __init__(self, /) -> None: ...
    @overload
    def __init__(self, id: PyDb.ObjectId, /) -> None: ...
    ...
    def addStringlineToGroup(self, groupName: str, stringlineId: PyDb.ObjectId, /) -> None: ...
    @staticmethod
    def cast(otherObject: PyRx.RxObject, /) -> CvDbStringLineManager: ...
    @staticmethod
    def className() -> str: ...
    @staticmethod
    def cloneFrom(otherObject: PyRx.RxObject, /) -> CvDbStringLineManager: ...
    @staticmethod
    def desc() -> PyRx.RxClass:
        """
        Returns a pointer to the AcRxClass object representing the specific class, or most recent
        ...
        by the returned pointer was created by an ObjectARX application that will not be unloaded.
        """
    def eraseGroup(self, groupName: str, /) -> None: ...
    @staticmethod
    def getInstanceFromDatabase(
        db: PyDb.Database, createIfNotExists: bool = True, /
    ) -> PyDb.ObjectId: ...
    def getPriorityOrder(self, groupName: str, stringlineId: PyDb.ObjectId, /) -> int: ...
    def getStringlineCount(self, groupName: str, /) -> int: ...
    def getStringlineGroup(self, stringlineId: PyDb.ObjectId, /) -> str: ...
    def getStringlineIds(self, groupName: str, /) -> list: ...
    def groupAt(self, index: int, /) -> str: ...
    def groupCount(self, /) -> int: ...
    def intersectionInteractionEnabled(self, groupName: str, /) -> bool: ...
    @staticmethod
    def openInstanceFromDatabase(
        db: PyDb.Database, openMode: PyDb.OpenMode, createIfNotExists: bool = True, /
    ) -> CvDbStringLineManager: ...
    def removeStringlineFromGroup(
        self, groupName: str, stringlineId: PyDb.ObjectId, addToDefault: bool = True, /
    ) -> None: ...
    def renameGroup(self, groupName: str, newName: str, /) -> None: ...
    def setIntersectionInteraction(self, groupName: str, isOn: bool, /) -> None: ...
    def setPriorityOrder(
        self, groupName: str, stringlineId: PyDb.ObjectId, order: int, /
    ) -> None: ...
    def updateInteractionGeometry(self, groupName: str, /) -> None: ...
...
class CvDbTinSurface(PyBrxCv.CvDbEntity):
    ...
    def findTinTrianglesAt(self, pt: PyGe.Point3d, /) -> list[PyBrxCv.CvTinTriangle]: ...
    ...
    def setContoursBaseElevation(self, baseElevation: float, /) -> bool: ...
    ...
    def tinTriangles(self, /) -> list[PyBrxCv.CvTinTriangle]: ...
...
class CvDbTinSurfaceBoundary(PyBrxCv.CvDbTinSurfaceConstraint):
    ...
    def __reduce__(self, /) -> Any: ...
    def boundaryType(self, /) -> TinBoundaryType: ...
    @staticmethod
    def className() -> str: ...
...
class CvTinTriangle:
    ...
    def circumcenter(self, /) -> PyGe.Point3d: ...
    def intersectWith(self, linearEnt3d: PyGe.LinearEnt3d, /) -> tuple: ...
    def isPointInside(self, pt: PyGe.Point3d, /) -> bool: ...
    def isValid(self, /) -> bool: ...
    def isVisible(self, /) -> bool: ...
...
class StringLineCreationSource(_BoostPythonEnum):
    eNone: ClassVar[Self]  # 0
    eFromCorridor: ClassVar[Self]  # 1
    eFromAlignment: ClassVar[Self]  # 2

class StringLinePointType(_BoostPythonEnum):
    ePI: ClassVar[Self]  # 1
    eElevation: ClassVar[Self]  # 2
    eIntersection: ClassVar[Self]  # 4
    eAll: ClassVar[Self]  # 7
