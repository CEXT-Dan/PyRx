...
void makePyGiSubEntityTraitsWrapper()
{
    ...
    class_<PyGiSubEntityTraits, bases<PyRxObject>>("SubEntityTraits", boost::python::no_init)
        ...
        .def("setTrueColor", &PyGiSubEntityTraits::setTrueColor, DS.ARGS({ "clr: PyDb.AcCmColor" }))
        ...
        .def("setPlotStyleName", &PyGiSubEntityTraits::setPlotStyleName2, DS.ARGS({ "val: PyDb.PlotStyleNameType","id: PyDb.ObjectId=None" }))
