...
public:
    ...
    static void                 bindXrefs1(PyDbDatabase& pHostDb, const boost::python::object& xrefBlkIds, const bool bInsertBind);
    static void                 bindXrefs2(PyDbDatabase& pHostDb, const boost::python::object& xrefBlkIds, const bool bInsertBind, const bool bAllowUnresolved, const bool bQuiet);
    ...
    static boost::python::list  entGetX2(const PyDbObjectId& id, const boost::python::object& rb);
    static PyDbObjectId         entLast();
    static bool                 entMod(const boost::python::object& list);
    ...
    static void                 forceTextAdjust(const boost::python::object& ids);
    ...
    static boost::python::list  openDbObjects1(const boost::python::object& ids);
    static boost::python::list  openDbObjects2(const boost::python::object& ids, AcDb::OpenMode mode);
    static boost::python::list  openDbObjects3(const boost::python::object& ids, AcDb::OpenMode mode, bool erased);
    static PyDbEntity           openDbEntity(const PyDbObjectId& id, AcDb::OpenMode mode, bool erased);
    static boost::python::list  openDbEntities1(const boost::python::object& ids);
    static boost::python::list  openDbEntities2(const boost::python::object& ids, AcDb::OpenMode mode);
    static boost::python::list  openDbEntities3(const boost::python::object& ids, AcDb::OpenMode mode, bool erased);
    ...
    static int                  queueForRegen(const boost::python::object& pyids);
    ...
    void                        reloadXrefs1(PyDbDatabase& db, const boost::python::object& ids);
    void                        reloadXrefs2(PyDbDatabase& db, const boost::python::object& ids, bool bQuiet);
    static boost::python::list  resbufTest(const boost::python::object& list);
    ...
    static boost::python::list  textFind2(PyDbDatabase& db, const std::string& findString, const std::string& replaceString, Adesk::UInt8 searchOptions, const boost::python::object& selSet);
    static PyDbTransactionManager transactionManager();
    static AcGeMatrix3d           ucsMatrix(PyDbDatabase& db);
    static void                 unloadXrefs1(PyDbDatabase& db, const boost::python::object& xrefBlkIds);
    static void                 unloadXrefs2(PyDbDatabase& db, const boost::python::object& xrefBlkIds, bool bQuiet);
