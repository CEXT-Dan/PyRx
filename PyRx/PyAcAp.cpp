...
BOOST_PYTHON_MODULE(PyAp)
{
    ...
    class_<CmdFlags>("CmdFlags")
        .def_readonly("MODAL", CmdFlags::kMODAL, DS.CLASSARGS())
        .def_readonly("TRANSPARENT", CmdFlags::kTRANSPARENT, DS.CLASSARGS())
        .def_readonly("USEPICKSET", CmdFlags::kUSEPICKSET, DS.CLASSARGS())
        .def_readonly("REDRAW", CmdFlags::kREDRAW, DS.CLASSARGS())
        .def_readonly("NOPERSPECTIVE", CmdFlags::kNOPERSPECTIVE, DS.CLASSARGS())
        .def_readonly("NOMULTIPLE", CmdFlags::kNOMULTIPLE, DS.CLASSARGS())
        .def_readonly("NOTILEMODE", CmdFlags::kNOTILEMODE, DS.CLASSARGS())
        .def_readonly("NOPAPERSPACE", CmdFlags::kNOPAPERSPACE, DS.CLASSARGS())
        .def_readonly("NOOEM", CmdFlags::kNOOEM, DS.CLASSARGS())
        .def_readonly("UNDEFINED", CmdFlags::kUNDEFINED, DS.CLASSARGS())
        .def_readonly("INPROGRESS", CmdFlags::kINPROGRESS, DS.CLASSARGS())
        .def_readonly("DEFUN", CmdFlags::kDEFUN, DS.CLASSARGS())
        .def_readonly("NOINTERNALLOCK", CmdFlags::kNOINTERNALLOCK, DS.CLASSARGS())
        .def_readonly("DOCREADLOCK", CmdFlags::kDOCREADLOCK, DS.CLASSARGS())
        .def_readonly("DOCEXCLUSIVELOCK", CmdFlags::kDOCEXCLUSIVELOCK, DS.CLASSARGS())
        .def_readonly("SESSION", CmdFlags::kSESSION, DS.CLASSARGS())
        .def_readonly("INTERRUPTIBLE", CmdFlags::kINTERRUPTIBLE, DS.CLASSARGS())
        .def_readonly("NOHISTORY", CmdFlags::kNOHISTORY, DS.CLASSARGS())
        .def_readonly("NO_UNDO_MARKER", CmdFlags::kNO_UNDO_MARKER, DS.CLASSARGS())
        .def_readonly("NOBEDIT", CmdFlags::kNOBEDIT, DS.CLASSARGS())
        ;
