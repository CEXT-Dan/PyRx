...
void makePyDbGeoDataWrapper()
{
    ...
    class_<PyDbGeoData, bases<PyDbObject>>("GeoData")
        ...
        .def("setMeshPointMaps", &PyDbGeoData::setMeshPointMaps, DS.ARGS({ "src : Iterable[PyGe.Point2d]", "dest : Iterable[PyGe.Point2d]" }))
        ...
        .def("transformToLonLatAlt", &PyDbGeoData::transformToLonLatAlt2, DS.ARGS({ "pt : PyGe.Point3d | xyz" }))
        .def("transformToLonLatAlt", &PyDbGeoData::transformFromLonLatAlt1)
        .def("transformToLonLatAlt", &PyDbGeoData::transformFromLonLatAlt2, DS.ARGS({ "pt : PyGe.Point3d | lat_long_alt" }))
