...
void makePyDbSubDMeshWrapper()
{
    ...
    class_<PyDbSubDMesh, bases<PyDbEntity>>("SubDMesh")
        ...
        .def("isWatertight", &PyDbSubDMesh::isWatertight)
        .def("numOfFaces", &PyDbSubDMesh::numOfFaces)
        .def("numOfSubDividedFaces", &PyDbSubDMesh::numOfSubDividedFaces)
        .def("numOfSubDividedFacesAt", &PyDbSubDMesh::numOfSubDividedFacesAt)
        .def("numOfVertices", &PyDbSubDMesh::numOfVertices)
        .def("numOfSubDividedVertices", &PyDbSubDMesh::numOfSubDividedVertices)
        .def("numOfEdges", &PyDbSubDMesh::numOfEdges)
        .def("getVertices", &PyDbSubDMesh::getVertices)
        .def("getEdgeArray", &PyDbSubDMesh::getEdgeArray)
        .def("getFaceArray", &PyDbSubDMesh::getFaceArray)
        .def("getNormalArray", &PyDbSubDMesh::getNormalArray)
        .def("getSubDividedVertices", &PyDbSubDMesh::getSubDividedVertices)
        .def("getSubDividedFaceArray", &PyDbSubDMesh::getSubDividedFaceArray)
        .def("getSubDividedNormalArray", &PyDbSubDMesh::getSubDividedNormalArray)
        ...
        .def("computeVolume", &PyDbSubDMesh::computeVolume)
        .def("computeSurfaceArea", &PyDbSubDMesh::computeSurfaceArea)
