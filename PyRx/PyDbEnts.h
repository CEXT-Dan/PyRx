...
public:
    ...
    Acad::ErrorStatus   setDimstyleData2(const PyDbDimStyleTableRecord& pNewData);
    Acad::ErrorStatus   setDimstyleData1(const PyDbObjectId& newDataId);
    void				setDimVars();
    ...
    Acad::ErrorStatus	setDimtxsty(PyDbObjectId& val);
