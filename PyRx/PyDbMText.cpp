...
void makePyDbMTextWrapper()
{
    ...
    class_<PyDbMText, bases<PyDbEntity>>("MText")
        ...
        .def("setRotation", &PyDbMText::setRotation, DS.ARGS({ "val : float" }))
        .def("width", &PyDbMText::width, DS.ARGS())
        .def("setWidth", &PyDbMText::setWidth, DS.ARGS({ "val : float" }))
        ...
        .def("setTextHeight", &PyDbMText::setTextHeight, DS.ARGS({ "val : float" }))
        ...
        .def("setLineSpacingFactor", &PyDbMText::setLineSpacingFactor, DS.ARGS({ "val : float" }))
        ...
        .def("setBackgroundScaleFactor", &PyDbMText::setBackgroundScaleFactor, DS.ARGS({ "val : float" }))
        ...
        .def("setDynamicColumns", &PyDbMText::setDynamicColumns, DS.ARGS({ "width : float","gutter : float","autoHeight : bool" }))
        .def("setStaticColumns", &PyDbMText::setStaticColumns, DS.ARGS({ "width : float","gutter : float","count : int" }))
        ...
        .def("setColumnWidth", &PyDbMText::setColumnWidth, DS.ARGS({ "val : float" }))
        .def("getColumnGutterWidth", &PyDbMText::getColumnGutterWidth, DS.ARGS())
        .def("setColumnGutterWidth", &PyDbMText::setColumnGutterWidth, DS.ARGS({ "val : float" }))
        ...
        .def("setColumnHeight", &PyDbMText::setColumnHeight, DS.ARGS({ "idx : int", "val : float" }))
