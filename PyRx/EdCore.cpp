...
void makePyEdCoreWrapper()
{
    ...
    class_<EdCore>("Core")
        ...
        .def("setStatusBarProgressMeterPos", &EdCore::setStatusBarProgressMeterPos, DS.SARGS({ "pos: int" })).staticmethod("setStatusBarProgressMeterPos")
        ...
        .def("textBox", &EdCore::textBox, DS.SARGS({ "resultBuffer: list" })).staticmethod("textBox")
