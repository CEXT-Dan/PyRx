...
void makePyBrxCvDbTinSurfaceWrapper()
{
    ...
    class_<PyBrxCvDbTinSurface, bases<PyBrxCvDbEntity>>("CvDbTinSurface")
        ...
        .def("movePoint", &PyBrxCvDbTinSurface::movePoint, DS.ARGS({ "from : PyGe.Point3d","to : PyGe.Point3d" }))
        ...
        .def("getPoints", &PyBrxCvDbTinSurface::getPoints, DS.ARGS({ "val : bool" }))
        ...
        .def("triangles", &PyBrxCvDbTinSurface::triangles, DS.ARGS({ "val : bool" }))
        ...
        .def("pointsCount", &PyBrxCvDbTinSurface::pointsCount, DS.ARGS({ "val : bool" }))
        .def("trianglesCount", &PyBrxCvDbTinSurface::trianglesCount, DS.ARGS({ "val : bool" }))
        .def("area2d", &PyBrxCvDbTinSurface::area2d, DS.ARGS({ "val : bool" }))
        .def("area3d", &PyBrxCvDbTinSurface::area3d, DS.ARGS({ "val : bool" }))
        .def("minElevation", &PyBrxCvDbTinSurface::minElevation, DS.ARGS({ "val : bool" }))
        .def("maxElevation", &PyBrxCvDbTinSurface::maxElevation, DS.ARGS({ "val : bool" }))
