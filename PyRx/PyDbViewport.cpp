...
void makePyDbViewportWrapper()
{
    ...
    class_<PyDbViewport, bases<PyDbEntity>>("Viewport")
        ...
        .def("setAnnotationScale", &PyDbViewport::setAnnotationScale, DS.ARGS({ "val: PyDb.AnnotationScale" }))
        ...
        .def("setFrontClipOn", &PyDbViewport::setFrontClipOn2, DS.ARGS({ "val: bool=True" }))
        ...
        .def("setFrontClipDistance", &PyDbViewport::setFrontClipDistance, DS.ARGS({ "val: float" }))
        ...
        .def("setPerspectiveOff", &PyDbViewport::setPerspectiveOff, DS.ARGS())
        ...
        .def("setDefaultLightingType", &PyDbViewport::setDefaultLightingType, DS.ARGS({ "val: PyGi.DefaultLightingType" }))
