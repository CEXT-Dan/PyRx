...
void makePyDbViewportWrapper()
{
    ...
    class_<PyDbViewport, bases<PyDbEntity>>("Viewport")
        ...
        .def("setHeight", &PyDbViewport::setHeight, DS.ARGS({ "val : real" }))
        .def("width", &PyDbViewport::width, DS.ARGS())
        .def("setWidth", &PyDbViewport::setWidth, DS.ARGS({ "val : real" }))
        ...
        .def("setViewHeight", &PyDbViewport::setViewHeight, DS.ARGS({ "val : real" }))
        ...
        .def("setTwistAngle", &PyDbViewport::setTwistAngle, DS.ARGS({ "val : real" }))
        .def("lensLength", &PyDbViewport::lensLength, DS.ARGS())
        .def("setLensLength", &PyDbViewport::setLensLength, DS.ARGS({ "val : real" }))
        ...
        .def("setSnapAngle", &PyDbViewport::setSnapAngle, DS.ARGS({ "val : real" }))
        ...
        .def("setBrightness", &PyDbViewport::setBrightness, DS.ARGS({ "val : real" }))
        .def("contrast", &PyDbViewport::contrast, DS.ARGS())
        .def("setContrast", &PyDbViewport::setContrast, DS.ARGS({ "val : real" }))
