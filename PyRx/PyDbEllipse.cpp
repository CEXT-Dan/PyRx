...
void makePyDbEllipseWrapper()
{
    ...
    class_<PyDbEllipse, bases<PyDbCurve>>("Ellipse")
        ...
        .def("setMajorRadius", &PyDbEllipse::setMajorRadius, DS.ARGS({ "val : float" }))
        .def("setMinorRadius", &PyDbEllipse::setMinorRadius, DS.ARGS({ "val : float" }))
        .def("radiusRatio", &PyDbEllipse::radiusRatio, DS.ARGS())
        .def("setRadiusRatio", &PyDbEllipse::setRadiusRatio, DS.ARGS({ "val : float" }))
        .def("startAngle", &PyDbEllipse::startAngle, DS.ARGS())
        .def("setStartAngle", &PyDbEllipse::setStartAngle, DS.ARGS({ "val : float" }))
        .def("endAngle", &PyDbEllipse::endAngle, DS.ARGS())
        .def("setEndAngle", &PyDbEllipse::setEndAngle, DS.ARGS({ "val : float" }))
        .def("setStartParam", &PyDbEllipse::setStartParam, DS.ARGS({ "val : float" }))
        .def("setEndParam", &PyDbEllipse::setEndParam, DS.ARGS({ "val : float" }))
        .def("paramAtAngle", &PyDbEllipse::paramAtAngle, DS.ARGS({ "val : float" }))
