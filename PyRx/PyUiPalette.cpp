...
void makePyCAdUiPaletteSetWrapper()
{
    ...
    class_<PyCAdUiPaletteSet>("PaletteSet", no_init)
        ...
        .def(init<const std::string&, const std::string&>(DS.CLASSARGS({ "name : str", "guid : str=None" })))
        .def("add", &PyCAdUiPaletteSet::add, DS.CLASSARGS({ "name : str" }))
        .def("setVisible", &PyCAdUiPaletteSet::setVisible, DS.CLASSARGS({ "val : bool" }))
        .def("getPaletteSetStyle", &PyCAdUiPaletteSet::getPaletteSetStyle, DS.CLASSARGS())
        .def("setPaletteSetStyle", &PyCAdUiPaletteSet::setPaletteSetStyle, DS.CLASSARGS({ "val : int" }))
        .def("autoRollupStyle", &PyCAdUiPaletteSet::autoRollupStyle, DS.CLASSARGS())
        .def("propertiesMenuStyle", &PyCAdUiPaletteSet::propertiesMenuStyle, DS.CLASSARGS())
        .def("closeButtonStyle", &PyCAdUiPaletteSet::closeButtonStyle, DS.CLASSARGS())
        .def("singlePaletteTabStyle", &PyCAdUiPaletteSet::singlePaletteTabStyle, DS.CLASSARGS())
        .def("useSinglePaletteTabNameStyle", &PyCAdUiPaletteSet::useSinglePaletteTabNameStyle, DS.CLASSARGS())
        .def("editNameStyle", &PyCAdUiPaletteSet::editNameStyle, DS.CLASSARGS())
        .def("snapStyle", &PyCAdUiPaletteSet::snapStyle, DS.CLASSARGS())
        .def("showRollupButtonStyle", &PyCAdUiPaletteSet::showRollupButtonStyle, DS.CLASSARGS())
        .def("showIconStyle", &PyCAdUiPaletteSet::showIconStyle, DS.CLASSARGS())
        .def("getName", &PyCAdUiPaletteSet::getName, DS.CLASSARGS())
        .def("setName", &PyCAdUiPaletteSet::setName, DS.CLASSARGS({ "val : str" }))
        .def("getOpacity", &PyCAdUiPaletteSet::getOpacity, DS.CLASSARGS())
        .def("setOpacity", &PyCAdUiPaletteSet::setOpacity, DS.CLASSARGS({ "val : int" }))
        .def("getRolloverOpacity", &PyCAdUiPaletteSet::getRolloverOpacity, DS.CLASSARGS())
        .def("setRolloverOpacity", &PyCAdUiPaletteSet::setRolloverOpacity, DS.CLASSARGS({ "val : int" }))
        .def("getActivePaletteTabIndex", &PyCAdUiPaletteSet::getActivePaletteTabIndex, DS.CLASSARGS())
        .def("setActivePalette", &PyCAdUiPaletteSet::setActivePalette, DS.CLASSARGS({ "val : int" }))
        .def("setAutoRollup", &PyCAdUiPaletteSet::setAutoRollup, DS.CLASSARGS({ "val : bool" }))
        .def("getAutoRollup", &PyCAdUiPaletteSet::getAutoRollup, DS.CLASSARGS())
        .def("rollOut", &PyCAdUiPaletteSet::rollOut1)
        .def("rollOut", &PyCAdUiPaletteSet::rollOut2, DS.CLASSARGS({ "delay : bool=False" }))
        .def("rollUp", &PyCAdUiPaletteSet::rollUp, DS.CLASSARGS())
        .def("removePalette", &PyCAdUiPaletteSet::removePalette, DS.CLASSARGS({ "val : int" }))
        .def("getPaletteCount", &PyCAdUiPaletteSet::getPaletteCount, DS.CLASSARGS())
        .def("getFullRect", &PyCAdUiPaletteSet::getFullRect, DS.CLASSARGS())
        .def("rolledUp", &PyCAdUiPaletteSet::rolledUp, DS.CLASSARGS())
        .def("titleBarLocation", &PyCAdUiPaletteSet::titleBarLocation, DS.CLASSARGS())
        .def("setTitleBarLocation", &PyCAdUiPaletteSet::setTitleBarLocation, DS.CLASSARGS({ "val : AdUiTitleBarLocation" }))
        .def("updateTabs", &PyCAdUiPaletteSet::updateTabs, DS.CLASSARGS())
        .def("paletteBackgroundColor", &PyCAdUiPaletteSet::paletteBackgroundColor, DS.CLASSARGS())
        .def("paletteTabTextColor", &PyCAdUiPaletteSet::paletteTabTextColor, DS.CLASSARGS())
        ;
