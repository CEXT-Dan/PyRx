...
void makePyDbDatabaseWrapper()
{
    ...
    class_<PyDbDatabase, bases<PyRxObject>>("Database")
        ...
        .def("setPucs", &PyDbDatabase::setPucs, DS.CLASSARGS({ "ucsOrigin : PyGe.Point3d","ucsXDir : PyGe.Vector3d" ,"ucsYDir : PyGe.Vector3d" }))
        ...
        .def("setUcs", &PyDbDatabase::setUcs, DS.CLASSARGS({ "ucsOrigin : PyGe.Point3d","ucsXDir : PyGe.Vector3d" ,"ucsYDir : PyGe.Vector3d" }))
