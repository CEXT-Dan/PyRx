...
void makePyDbDatabaseWrapper()
{
    ...
    class_<PyDbDatabase, bases<PyRxObject>>("Database")
        ...
        .def("objectContextManager", &PyDbDatabase::objectContextManager, DS.ARGS())
        ...
        .def("setCePlotStyleName", &PyDbDatabase::setCePlotStyleName, DS.ARGS({ "val : PyDb.PlotStyleNameType", "id : PyDb.ObjectId" }))
        ...
        .def("setDimstyleData", &PyDbDatabase::setDimstyleData2, DS.ARGS({ "val : PyDb.DimStyleTableRecord | PyDb.ObjectId" }))
        ...
        .def("setInterfereObjVisStyle", &PyDbDatabase::setInterfereObjVisStyle, DS.ARGS({ "val : PyDb.ObjectId" }))
        .def("setInterfereVpVisStyle", &PyDbDatabase::setInterfereVpVisStyle, DS.ARGS({ "val : PyDb.ObjectId" }))
