...
void makePyDbUnderlayReferenceWrapper()
{
    ...
    class_<PyDbUnderlayReference, bases<PyDbEntity>>("UnderlayReference", boost::python::no_init)
        ...
        .def("setRotation", &PyDbUnderlayReference::setRotation, DS.ARGS({ "val : real" }))
        ...
        .def("setWidth", &PyDbUnderlayReference::setWidth, DS.ARGS({ "val : real" }))
        .def("width", &PyDbUnderlayReference::width, DS.ARGS())
        .def("setHeight", &PyDbUnderlayReference::setHeight, DS.ARGS({ "val : real" }))
