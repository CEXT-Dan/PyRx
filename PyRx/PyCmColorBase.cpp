...
{
    static auto wrapper = class_<AcCmColor>("Color")
...
{
    static auto wrapper = class_<AcCmTransparency>("Transparency")
...
{
    static auto wrapper = class_<AcCmEntityColor>("EntityColor")
