...
void makePyDbDimStyleTableRecordWrapper()
{
    ...
    class_<PyDbDimStyleTableRecord, bases<PyDbSymbolTableRecord>>("DimStyleTableRecord")
        ...
        .def("arrowId", &PyDbDimStyleTableRecord::arrowId)
        .def("dimadec", &PyDbDimStyleTableRecord::dimadec)
        .def("dimalt", &PyDbDimStyleTableRecord::dimalt)
        .def("dimaltd", &PyDbDimStyleTableRecord::dimaltd)
        .def("dimaltf", &PyDbDimStyleTableRecord::dimaltf)
        .def("dimaltrnd", &PyDbDimStyleTableRecord::dimaltrnd)
        .def("dimalttd", &PyDbDimStyleTableRecord::dimalttd)
        .def("dimalttz", &PyDbDimStyleTableRecord::dimalttz)
        .def("dimaltu", &PyDbDimStyleTableRecord::dimaltu)
        .def("dimaltz", &PyDbDimStyleTableRecord::dimaltz)
        .def("dimapost", &PyDbDimStyleTableRecord::dimapost)
        .def("dimarcsym", &PyDbDimStyleTableRecord::dimarcsym)
        .def("dimasz", &PyDbDimStyleTableRecord::dimasz)
        .def("dimatfit", &PyDbDimStyleTableRecord::dimatfit)
        .def("dimaunit", &PyDbDimStyleTableRecord::dimaunit)
        .def("dimazin", &PyDbDimStyleTableRecord::dimazin)
        .def("dimblk", &PyDbDimStyleTableRecord::dimblk)
        .def("dimblk1", &PyDbDimStyleTableRecord::dimblk1)
        .def("dimblk2", &PyDbDimStyleTableRecord::dimblk2)
        .def("dimcen", &PyDbDimStyleTableRecord::dimcen)
        .def("dimclrd", &PyDbDimStyleTableRecord::dimclrd)
        .def("dimclre", &PyDbDimStyleTableRecord::dimclre)
        .def("dimclrt", &PyDbDimStyleTableRecord::dimclrt)
        .def("dimdec", &PyDbDimStyleTableRecord::dimdec)
        .def("dimdle", &PyDbDimStyleTableRecord::dimdle)
        .def("dimdli", &PyDbDimStyleTableRecord::dimdli)
        .def("dimdsep", &PyDbDimStyleTableRecord::dimdsep)
        .def("dimexe", &PyDbDimStyleTableRecord::dimexe)
        .def("dimexo", &PyDbDimStyleTableRecord::dimexo)
        .def("dimfrac", &PyDbDimStyleTableRecord::dimfrac)
        .def("dimgap", &PyDbDimStyleTableRecord::dimgap)
        .def("dimjogang", &PyDbDimStyleTableRecord::dimjogang)
        .def("dimjust", &PyDbDimStyleTableRecord::dimjust)
        .def("dimldrblk", &PyDbDimStyleTableRecord::dimldrblk)
        .def("dimlfac", &PyDbDimStyleTableRecord::dimlfac)
        .def("dimlim", &PyDbDimStyleTableRecord::dimlim)
        .def("dimltex1", &PyDbDimStyleTableRecord::dimltex1)
        .def("dimltex2", &PyDbDimStyleTableRecord::dimltex2)
        .def("dimltype", &PyDbDimStyleTableRecord::dimltype)
        .def("dimlunit", &PyDbDimStyleTableRecord::dimlunit)
        .def("dimlwd", &PyDbDimStyleTableRecord::dimlwd)
        .def("dimlwe", &PyDbDimStyleTableRecord::dimlwe)
        .def("dimpost", &PyDbDimStyleTableRecord::dimpost)
        .def("dimrnd", &PyDbDimStyleTableRecord::dimrnd)
        .def("dimsah", &PyDbDimStyleTableRecord::dimsah)
        .def("dimscale", &PyDbDimStyleTableRecord::dimscale)
        .def("dimsd1", &PyDbDimStyleTableRecord::dimsd1)
        .def("dimsd2", &PyDbDimStyleTableRecord::dimsd2)
        .def("dimse1", &PyDbDimStyleTableRecord::dimse1)
        .def("dimse2", &PyDbDimStyleTableRecord::dimse2)
        .def("dimsoxd", &PyDbDimStyleTableRecord::dimsoxd)
        .def("dimtad", &PyDbDimStyleTableRecord::dimtad)
        .def("dimtdec", &PyDbDimStyleTableRecord::dimtdec)
        .def("dimtfac", &PyDbDimStyleTableRecord::dimtfac)
        .def("dimtfill", &PyDbDimStyleTableRecord::dimtfill)
        .def("dimtfillclr", &PyDbDimStyleTableRecord::dimtfillclr)
        .def("dimtih", &PyDbDimStyleTableRecord::dimtih)
        .def("dimtix", &PyDbDimStyleTableRecord::dimtix)
        .def("dimtm", &PyDbDimStyleTableRecord::dimtm)
        .def("dimtmove", &PyDbDimStyleTableRecord::dimtmove)
        .def("dimtofl", &PyDbDimStyleTableRecord::dimtofl)
        .def("dimtoh", &PyDbDimStyleTableRecord::dimtoh)
        .def("dimtol", &PyDbDimStyleTableRecord::dimtol)
        .def("dimtolj", &PyDbDimStyleTableRecord::dimtolj)
        .def("dimtp", &PyDbDimStyleTableRecord::dimtp)
        .def("dimtsz", &PyDbDimStyleTableRecord::dimtsz)
        .def("dimtvp", &PyDbDimStyleTableRecord::dimtvp)
        .def("dimtxsty", &PyDbDimStyleTableRecord::dimtxsty)
        .def("dimtxt", &PyDbDimStyleTableRecord::dimtxt)
        .def("dimtzin", &PyDbDimStyleTableRecord::dimtzin)
        .def("dimupt", &PyDbDimStyleTableRecord::dimupt)
        .def("dimzin", &PyDbDimStyleTableRecord::dimzin)
        .def("dimfxlenOn", &PyDbDimStyleTableRecord::dimfxlenOn)
        .def("dimfxlen", &PyDbDimStyleTableRecord::dimfxlen)
        .def("dimtxtdirection", &PyDbDimStyleTableRecord::dimtxtdirection)
        .def("dimmzf", &PyDbDimStyleTableRecord::dimmzf)
        .def("dimmzs", &PyDbDimStyleTableRecord::dimmzs)
        .def("dimaltmzf", &PyDbDimStyleTableRecord::dimaltmzf)
        .def("dimaltmzs", &PyDbDimStyleTableRecord::dimaltmzs)

        .def("setDimadec", &PyDbDimStyleTableRecord::setDimadec)
        .def("setDimalt", &PyDbDimStyleTableRecord::setDimalt)
        .def("setDimaltd", &PyDbDimStyleTableRecord::setDimaltd)
        .def("setDimaltf", &PyDbDimStyleTableRecord::setDimaltf)
        .def("setDimaltmzf", &PyDbDimStyleTableRecord::setDimaltmzf)
        .def("setDimaltmzs", &PyDbDimStyleTableRecord::setDimaltmzs)
        .def("setDimaltrnd", &PyDbDimStyleTableRecord::setDimaltrnd)
        .def("setDimalttd", &PyDbDimStyleTableRecord::setDimalttd)
        .def("setDimalttz", &PyDbDimStyleTableRecord::setDimalttz)
        .def("setDimaltu", &PyDbDimStyleTableRecord::setDimaltu)
        .def("setDimaltz", &PyDbDimStyleTableRecord::setDimaltz)
        .def("setDimapost", &PyDbDimStyleTableRecord::setDimapost)
        .def("setDimarcsym", &PyDbDimStyleTableRecord::setDimarcsym)
        .def("setDimasz", &PyDbDimStyleTableRecord::setDimasz)
        .def("setDimatfit", &PyDbDimStyleTableRecord::setDimatfit)
        .def("setDimaunit", &PyDbDimStyleTableRecord::setDimaunit)
        .def("setDimazin", &PyDbDimStyleTableRecord::setDimazin)
        .def("setDimblk", &PyDbDimStyleTableRecord::setDimblkId)
        .def("setDimblk1", &PyDbDimStyleTableRecord::setDimblk1Id)
        .def("setDimblk2", &PyDbDimStyleTableRecord::setDimblk2Id)
        .def("setDimcen", &PyDbDimStyleTableRecord::setDimcen)
        .def("setDimclrd", &PyDbDimStyleTableRecord::setDimclrd)
        .def("setDimclre", &PyDbDimStyleTableRecord::setDimclre)
        .def("setDimclrt", &PyDbDimStyleTableRecord::setDimclrt)
        .def("setDimdec", &PyDbDimStyleTableRecord::setDimdec)
        .def("setDimdle", &PyDbDimStyleTableRecord::setDimdle)
        .def("setDimdli", &PyDbDimStyleTableRecord::setDimdli)
        .def("setDimdsep", &PyDbDimStyleTableRecord::setDimdsep)
        .def("setDimexe", &PyDbDimStyleTableRecord::setDimexe)
        .def("setDimexo", &PyDbDimStyleTableRecord::setDimexo)
        .def("setDimfrac", &PyDbDimStyleTableRecord::setDimfrac)
        .def("setDimgap", &PyDbDimStyleTableRecord::setDimgap)
        .def("setDimjogang", &PyDbDimStyleTableRecord::setDimjogang)
        .def("setDimjust", &PyDbDimStyleTableRecord::setDimjust)
        .def("setDimldrblk", &PyDbDimStyleTableRecord::setDimldrblkId)
        .def("setDimlfac", &PyDbDimStyleTableRecord::setDimlfac)
        .def("setDimlim", &PyDbDimStyleTableRecord::setDimlim)
        .def("setDimltex1", &PyDbDimStyleTableRecord::setDimltex1)
        .def("setDimltex2", &PyDbDimStyleTableRecord::setDimltex2)
        .def("setDimltype", &PyDbDimStyleTableRecord::setDimltype)
        .def("setDimlunit", &PyDbDimStyleTableRecord::setDimlunit)
        .def("setDimlwd", &PyDbDimStyleTableRecord::setDimlwd)
        .def("setDimlwe", &PyDbDimStyleTableRecord::setDimlwe)
        .def("setDimmzf", &PyDbDimStyleTableRecord::setDimmzf)
        .def("setDimmzs", &PyDbDimStyleTableRecord::setDimmzs)
        .def("setDimpost", &PyDbDimStyleTableRecord::setDimpost)
        .def("setDimrnd", &PyDbDimStyleTableRecord::setDimrnd)
        .def("setDimsah", &PyDbDimStyleTableRecord::setDimsah)
        .def("setDimscale", &PyDbDimStyleTableRecord::setDimscale)
        .def("setDimsd1", &PyDbDimStyleTableRecord::setDimsd1)
        .def("setDimsd2", &PyDbDimStyleTableRecord::setDimsd2)
        .def("setDimse1", &PyDbDimStyleTableRecord::setDimse1)
        .def("setDimse2", &PyDbDimStyleTableRecord::setDimse2)
        .def("setDimsoxd", &PyDbDimStyleTableRecord::setDimsoxd)
        .def("setDimtad", &PyDbDimStyleTableRecord::setDimtad)
        .def("setDimtdec", &PyDbDimStyleTableRecord::setDimtdec)
        .def("setDimtfac", &PyDbDimStyleTableRecord::setDimtfac)
        .def("setDimtfill", &PyDbDimStyleTableRecord::setDimtfill)
        .def("setDimtfillclr", &PyDbDimStyleTableRecord::setDimtfillclr)
        .def("setDimtih", &PyDbDimStyleTableRecord::setDimtih)
        .def("setDimtix", &PyDbDimStyleTableRecord::setDimtix)
        .def("setDimtm", &PyDbDimStyleTableRecord::setDimtm)
        .def("setDimtmove", &PyDbDimStyleTableRecord::setDimtmove)
        .def("setDimtofl", &PyDbDimStyleTableRecord::setDimtofl)
        .def("setDimtoh", &PyDbDimStyleTableRecord::setDimtoh)
        .def("setDimtol", &PyDbDimStyleTableRecord::setDimtol)
        .def("setDimtolj", &PyDbDimStyleTableRecord::setDimtolj)
        .def("setDimtp", &PyDbDimStyleTableRecord::setDimtp)
        .def("setDimtsz", &PyDbDimStyleTableRecord::setDimtsz)
        .def("setDimtvp", &PyDbDimStyleTableRecord::setDimtvp)
        .def("setDimtxsty", &PyDbDimStyleTableRecord::setDimtxsty)
        .def("setDimtxt", &PyDbDimStyleTableRecord::setDimtxt)
        .def("setDimtxtdirection", &PyDbDimStyleTableRecord::setDimtxtdirection)
        .def("setDimtzin", &PyDbDimStyleTableRecord::setDimtzin)
        .def("setDimupt", &PyDbDimStyleTableRecord::setDimupt)
        .def("setDimzin", &PyDbDimStyleTableRecord::setDimzin)
        .def("setDimblk", &PyDbDimStyleTableRecord::setDimblk)
        .def("setDimblk1", &PyDbDimStyleTableRecord::setDimblk1)
        .def("setDimblk2", &PyDbDimStyleTableRecord::setDimblk2)
        .def("setDimldrblk", &PyDbDimStyleTableRecord::setDimldrblk)
        .def("setDimfxlenOn", &PyDbDimStyleTableRecord::setDimfxlenOn)
        .def("setDimfxlen", &PyDbDimStyleTableRecord::setDimfxlen)
        .def("isModifiedForRecompute", &PyDbDimStyleTableRecord::isModifiedForRecompute)
