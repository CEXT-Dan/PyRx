...
void makePyDbDimStyleTableRecordWrapper()
{
    ...
    class_<PyDbDimStyleTableRecord, bases<PyDbSymbolTableRecord>>("DimStyleTableRecord")
        ...
        .def("setDimaltf", &PyDbDimStyleTableRecord::setDimaltf, DS.ARGS({ "val : real" }))
        .def("setDimaltmzf", &PyDbDimStyleTableRecord::setDimaltmzf, DS.ARGS({ "val : real" }))
        .def("setDimaltmzs", &PyDbDimStyleTableRecord::setDimaltmzs, DS.ARGS({ "val : str" }))
        .def("setDimaltrnd", &PyDbDimStyleTableRecord::setDimaltrnd, DS.ARGS({ "val : real" }))
        ...
        .def("setDimasz", &PyDbDimStyleTableRecord::setDimasz, DS.ARGS({ "val : real" }))
        ...
        .def("setDimcen", &PyDbDimStyleTableRecord::setDimcen, DS.ARGS({ "val : real" }))
        ...
        .def("setDimdle", &PyDbDimStyleTableRecord::setDimdle, DS.ARGS({ "val : real" }))
        .def("setDimdli", &PyDbDimStyleTableRecord::setDimdli, DS.ARGS({ "val : real" }))
        .def("setDimdsep", &PyDbDimStyleTableRecord::setDimdsep, DS.ARGS({ "val : char" }))
        .def("setDimexe", &PyDbDimStyleTableRecord::setDimexe, DS.ARGS({ "val : real" }))
        .def("setDimexo", &PyDbDimStyleTableRecord::setDimexo, DS.ARGS({ "val : real" }))
        .def("setDimfrac", &PyDbDimStyleTableRecord::setDimfrac, DS.ARGS({ "val : int" }))
        .def("setDimgap", &PyDbDimStyleTableRecord::setDimgap, DS.ARGS({ "val : real" }))
        .def("setDimjogang", &PyDbDimStyleTableRecord::setDimjogang, DS.ARGS({ "val : real" }))
        ...
        .def("setDimlfac", &PyDbDimStyleTableRecord::setDimlfac, DS.ARGS({ "val : real" }))
        ...
        .def("setDimmzf", &PyDbDimStyleTableRecord::setDimmzf, DS.ARGS({ "val : real" }))
        ...
        .def("setDimrnd", &PyDbDimStyleTableRecord::setDimrnd, DS.ARGS({ "val : real" }))
        .def("setDimsah", &PyDbDimStyleTableRecord::setDimsah, DS.ARGS({ "val : bool" }))
        .def("setDimscale", &PyDbDimStyleTableRecord::setDimscale, DS.ARGS({ "val : real" }))
        ...
        .def("setDimtfac", &PyDbDimStyleTableRecord::setDimtfac, DS.ARGS({ "val : real" }))
        ...
        .def("setDimtm", &PyDbDimStyleTableRecord::setDimtm, DS.ARGS({ "val : real" }))
        ...
        .def("setDimtp", &PyDbDimStyleTableRecord::setDimtp, DS.ARGS({ "val : real" }))
        .def("setDimtsz", &PyDbDimStyleTableRecord::setDimtsz, DS.ARGS({ "val : real" }))
        .def("setDimtvp", &PyDbDimStyleTableRecord::setDimtvp, DS.ARGS({ "val : real" }))
        ...
        .def("setDimfxlen", &PyDbDimStyleTableRecord::setDimfxlen, DS.ARGS({ "val : real" }))
...
void makePyDbBlockTableRecordWrapper()
{
    ...
    class_<PyDbBlockTableRecord, bases<PyDbSymbolTableRecord>>("BlockTableRecord")
        .def(init<>())
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>(DS.ARGS({ "id: ObjectId=kNull", "mode: PyDb.OpenMode=kForRead" })))
...
void makePyDbTextStyleTableRecordWrapper()
{
    ...
    class_<PyDbTextStyleTableRecord, bases<PyDbSymbolTableRecord>>("TextStyleTableRecord")
        ...
        .def("setTextSize", &PyDbTextStyleTableRecord::setTextSize, DS.ARGS({ "val : real" }))
        .def("xScale", &PyDbTextStyleTableRecord::xScale, DS.ARGS())
        .def("setXScale", &PyDbTextStyleTableRecord::setXScale, DS.ARGS({ "val : real" }))
        .def("obliquingAngle", &PyDbTextStyleTableRecord::obliquingAngle, DS.ARGS())
        .def("setObliquingAngle", &PyDbTextStyleTableRecord::setObliquingAngle, DS.ARGS({ "val : real" }))
