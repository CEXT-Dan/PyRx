...
void makePyEditorWrapper()
{
    ...
    class_<PyAcEditor>("Editor")
        ...
        .def("selectWindowPolygon", &PyAcEditor::selectWindowPolygon2, DS.SARGS({ "points: list[PyGe.Point3d]","filter: list=None" }, 11344)).staticmethod("selectWindowPolygon")
        .def("selectFence", &PyAcEditor::selectFence1)
        .def("selectFence", &PyAcEditor::selectFence2, DS.SARGS({ "points: list[PyGe.Point3d]","filter: list=None" }, 11344)).staticmethod("selectFence")
