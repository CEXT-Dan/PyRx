...
void makePyGeCurve3dWrapper()
{
    ...
    class_<PyGeCurve3d, bases<PyGeEntity3d>>("Curve3d", boost::python::no_init)
        ...
        .def("distanceTo", &PyGeCurve3d::distanceTo4, DS.ARGS({ "pt : PyGe.Point3d | PyGe.Curve3d","tol : PyGe.Tol=None" }))
        ...
        .def("closestPointTo", &PyGeCurve3d::closestPointTo4, DS.ARGS({ "other : PyGe.Point3d | PyGe.Curve3d","tol : PyGe.Tol=None" }))
        .def("getClosestPointTo", &PyGeCurve3d::getClosestPointTo1)
        .def("getClosestPointTo", &PyGeCurve3d::getClosestPointTo2, DS.ARGS({ "other : PyGe.Point3d","tol : PyGe.Tol=None" }))
        .def("getClosestPointsTo", &PyGeCurve3d::getClosestPointsTo1)
        .def("getClosestPointsTo", &PyGeCurve3d::getClosestPointsTo2, DS.ARGS({ "other : PyGe.Curve3d","tol : PyGe.Tol=None" }))
        .def("projClosestPointTo", &PyGeCurve3d::projClosestPointTo1)
        .def("projClosestPointTo", &PyGeCurve3d::projClosestPointTo2, DS.ARGS({ "pt : PyGe.Point3d","projDir : PyGe.Vector3d","tol : PyGe.Tol=None" }))
        .def("projClosestPointsTo", &PyGeCurve3d::projClosestPointsTo1)
        .def("projClosestPointsTo", &PyGeCurve3d::projClosestPointsTo2, DS.ARGS({ "pt : PyGe.Curve3d","projDir : PyGe.Vector3d","tol : PyGe.Tol=None" }))
        .def("getProjClosestPointTo", &PyGeCurve3d::getProjClosestPointTo1)
        .def("getProjClosestPointTo", &PyGeCurve3d::getProjClosestPointTo2, DS.ARGS({ "pt : PyGe.Point3d","projDir : PyGe.Vector3d","tol : PyGe.Tol=None" }))
        .def("getProjClosestPointsTo", &PyGeCurve3d::getProjClosestPointsTo1)
        .def("getProjClosestPointsTo", &PyGeCurve3d::getProjClosestPointsTo2, DS.ARGS({ "pt : PyGe.Curve3d","projDir : PyGe.Vector3d","tol : PyGe.Tol=None" }))
        .def("getNormalPoint", &PyGeCurve3d::getNormalPoint1)
        .def("getNormalPoint", &PyGeCurve3d::getNormalPoint2, DS.ARGS({ "pnt : PyGe.Point3d","tol : PyGe.Tol=None" }))
        ...
        .def("project", &PyGeCurve3d::project2, DS.ARGS({ "projectionPlane : PyGe.Plane","projDir : PyGe.Vector3d","tol : PyGe.Tol=None" }))
        .def("orthoProject", &PyGeCurve3d::orthoProject1)
        .def("orthoProject", &PyGeCurve3d::orthoProject2, DS.ARGS({ "projectionPlane : PyGe.Plane","tol : PyGe.Tol=None" }))
        .def("isOn", &PyGeCurve3d::isOn1)
        .def("isOn", &PyGeCurve3d::isOn2)
        .def("isOn", &PyGeCurve3d::isOn3)
        .def("isOn", &PyGeCurve3d::isOn4, DS.ARGS({ "pt : float | PyGe.Point3d","tol : PyGe.Tol=None" }))
        .def("paramOf", &PyGeCurve3d::paramOf1)
        .def("paramOf", &PyGeCurve3d::paramOf2, DS.ARGS({ "pt : PyGe.Point3d","tol : PyGe.Tol=None" }))
        .def("getTrimmedOffset", &PyGeCurve3d::getTrimmedOffset1)
        .def("getTrimmedOffset", &PyGeCurve3d::getTrimmedOffset2, DS.ARGS({ "dist : float", "planeNormal : PyGe.Vector3d","extensionType : PyGe.OffsetCrvExtType","tol : PyGe.Tol=None" }))
        .def("isClosed", &PyGeCurve3d::isClosed1)
        .def("isClosed", &PyGeCurve3d::isClosed2, DS.ARGS({ "tol : PyGe.Tol=None" }))
        .def("isPlanar", &PyGeCurve3d::isPlanar1)
        .def("isPlanar", &PyGeCurve3d::isPlanar2, DS.ARGS({ "tol : PyGe.Tol=None" }))
        .def("isLinear", &PyGeCurve3d::isLinear1)
        .def("isLinear", &PyGeCurve3d::isLinear2, DS.ARGS({ "tol : PyGe.Tol=None" }))
        .def("isCoplanarWith", &PyGeCurve3d::isCoplanarWith1)
        .def("isCoplanarWith", &PyGeCurve3d::isCoplanarWith2, DS.ARGS({ "curve : PyGe.Curve3d","tol : PyGe.Tol=None" }))
        .def("isPeriodic", &PyGeCurve3d::isPeriodic, DS.ARGS())
        .def("length", &PyGeCurve3d::length1)
        .def("length", &PyGeCurve3d::length2, DS.ARGS({ "frm : float", "to : float", "tol : float = None" }))
        ...
        .def("area", &PyGeCurve3d::area2, DS.ARGS({ "startParam : float", "endParam : float", "tol : float = None" }))
        .def("isDegenerate", &PyGeCurve3d::isDegenerate1)
        .def("isDegenerate", &PyGeCurve3d::isDegenerate2, DS.ARGS({ "tol : PyGe.Tol=None" }))
