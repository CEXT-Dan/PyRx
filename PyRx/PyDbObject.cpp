...
void makePyDbObjectWrapper()
{
    ...
    class_<PyDbObject, bases<PyGiDrawable>>("DbObject", boost::python::no_init)
        ...
        .def("erase", &PyDbObject::erase1, DS.ARGS())
        ...
        .def("addPersistentReactor", &PyDbObject::addPersistentReactor, DS.ARGS({ "id: ObjectId" }))
        .def("removePersistentReactor", &PyDbObject::removePersistentReactor, DS.ARGS({ "id: ObjectId" }))
        .def("hasPersistentReactor", &PyDbObject::hasPersistentReactor, DS.ARGS({ "id: ObjectId" }))
