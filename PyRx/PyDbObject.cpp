...
void makePyDbObjectWrapper()
{
    ...
    class_<PyDbObject, bases<PyGiDrawable>>("DbObject", boost::python::no_init)
        ...
        .def("removeField", &PyDbObject::removeField2, DS.ARGS({ "id: str|PyDb.ObjectId" }))
        .def("getFieldDictionary", &PyDbObject::getFieldDictionary, DS.ARGS())
        .def("addReactor", &PyDbObject::addReactor, DS.ARGS({ "reactor: PyDb.DbObjectReactor" }))
        .def("removeReactor", &PyDbObject::removeReactor, DS.ARGS({ "reactor: PyDb.DbObjectReactor" }))
