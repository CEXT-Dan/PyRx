...
void makePyDbTableWrapper()
{
    ...
    class_<PyDbTable, bases<PyDbBlockReference>>("Table")
        ...
        .def("setWidth", &PyDbTable::setWidth, DS.ARGS({ "val : real" }))
        ...
        .def("setHeight", &PyDbTable::setHeight, DS.ARGS({ "val : real" }))
        ...
        .def("setHorzCellMargin", &PyDbTable::setHorzCellMargin, DS.ARGS({ "val : real" }))
        .def("vertCellMargin", &PyDbTable::vertCellMargin, DS.ARGS())
        .def("setVertCellMargin", &PyDbTable::setVertCellMargin, DS.ARGS({ "val : real" }))
        ...
        .def("setBlockScale", &PyDbTable::setBlockScale, DS.ARGS({ "row: int", "col: int","scale : real" }))
        .def("blockRotation", &PyDbTable::blockRotation, DS.ARGS({ "row: int", "col: int" }))
        .def("setBlockRotation", &PyDbTable::setBlockRotation, DS.ARGS({ "row: int", "col: int","rotAng : real" }))
        ...
        .def("insertColumns", &PyDbTable::insertColumns, DS.ARGS({ "row: int","width : real", "nCols: int" }))
        .def("deleteColumns", &PyDbTable::deleteColumns, DS.ARGS({ "row: int", "nCols: int" }))
        .def("insertRows", &PyDbTable::insertRows, DS.ARGS({ "row: int","height : real", "nRows: int" }))
        ...
        .def("recomputeTableBlock", &PyDbTable::recomputeTableBlock, DS.ARGS())
        .def("hitTest", &PyDbTable::hitTest)
        .def("hitTest", &PyDbTable::hitTest2, DS.ARGS({ "wpt: PyGe.Point3d","viewvec: PyGe.Vector3d","wx: real=0.0","wy: real=0.0" }))
        ...
        .def("moveContent", &PyDbTable::moveContent, DS.ARGS({ "row: int", "col: int", "from: int","to: int" }))
        ...
        .def("setMargin", &PyDbTable::setMargin, DS.ARGS({ "row: int", "col: int", "nMargin: PyDb.CellMargin","val : real" }))
        ...
        .def("setScale", &PyDbTable::setScale, DS.ARGS({ "row: int", "col: int", "content: int","val : real" }))
        ...
        .def("setBreakHeight", &PyDbTable::setBreakHeight, DS.ARGS({ "val : int","height : real" }))
        ...
        .def("setBreakSpacing", &PyDbTable::setBreakSpacing, DS.ARGS({ "val : real" }))
