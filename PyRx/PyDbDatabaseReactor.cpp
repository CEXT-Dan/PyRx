...
void makePyDbDatabaseReactorWrapper()
{
    ...
    class_<PyDbDatabaseReactor, bases<PyRxObject>>("DatabaseReactor")
        ...
        .def("objectUnAppended", &PyDbDatabaseReactor::objectUnAppended, DS.ARGS({ "db: PyDb.Database", "obj: PyDb.DbObject" }))
        .def("objectReAppended", &PyDbDatabaseReactor::objectReAppended, DS.ARGS({ "db: PyDb.Database", "obj: PyDb.DbObject" }))
        .def("objectOpenedForModify", &PyDbDatabaseReactor::objectOpenedForModify, DS.ARGS({ "db: PyDb.Database", "obj: PyDb.DbObject" }))
        .def("objectModified", &PyDbDatabaseReactor::objectModified, DS.ARGS({ "db: PyDb.Database", "obj: PyDb.DbObject" }))
        .def("objectErased", &PyDbDatabaseReactor::objectErased, DS.ARGS({ "db: PyDb.Database", "obj: PyDb.DbObject", "erased: bool" }))
