...
void makePyDbEntityWrapper()
{
    ...
    class_<PyDbEntity, bases<PyDbObject>>("Entity", boost::python::no_init)
        ...
        .def("setColor", &PyDbEntity::setColor3, DS.ARGS({ "clr: PyDb.AcCmColor", "dosubents : bool=True","db : PyDb.Database='current'" }))
        ...
        .def("setLayer", &PyDbEntity::setLayer6, DS.ARGS({ "val: str|PyDb.ObjectId", "dosubents : bool=True","allowHiddenLayer : bool=False" }))
        ...
        .def("setLinetype", &PyDbEntity::setLinetype4, DS.ARGS({ "val: str|PyDb.ObjectId", "dosubents : bool=True" }))
        ...
        .def("setMaterial", &PyDbEntity::setMaterial4, DS.ARGS({ "val: str|PyDb.ObjectId",  "dosubents : bool=True" }))
        ...
        .def("setVisibility", &PyDbEntity::setVisibility2, DS.ARGS({ "val: PyDb.Visibility",  "dosubents : bool=True" }))
        .def("lineWeight", &PyDbEntity::lineWeight, DS.ARGS())
        .def("setLineWeight", &PyDbEntity::setLineWeight1)
        .def("setLineWeight", &PyDbEntity::setLineWeight2, DS.ARGS({ "val: PyDb.LineWeight",  "dosubents : bool=True" }))
        ...
        .def("setDatabaseDefaults", &PyDbEntity::setDatabaseDefaults2, DS.ARGS({ "db: PyDb.Database = 'current'" }))
