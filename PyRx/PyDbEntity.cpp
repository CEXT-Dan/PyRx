...
void makeAcDbEntityWrapper()
{
    ...
    class_<PyDbEntity, bases<PyDbObject>>("Entity", boost::python::no_init)
        ...
        .def("getEcs", &PyDbEntity::getEcs, DS.CLASSARGS({ "matrix3d: Matrix3d" }))
        ...
        .def("transformBy", &PyDbEntity::transformBy, DS.CLASSARGS({ "matrix3d: Matrix3d" }))
        ...
        .def("getCompoundObjectTransform", &PyDbEntity::getCompoundObjectTransform, DS.CLASSARGS({ "matrix3d: Matrix3d" }))
