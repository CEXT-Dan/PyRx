...
void makePyDbTextWrapper()
{
    ...
    class_<PyDbText, bases<PyDbEntity>>("Text")
        ...
        .def("position", &PyDbText::position, DS.CLASSARGS())
        .def("setPosition", &PyDbText::setPosition, DS.CLASSARGS({ "pos : PyGe.Point3d" }))
        .def("alignmentPoint", &PyDbText::alignmentPoint, DS.CLASSARGS())
        .def("setAlignmentPoint", &PyDbText::setAlignmentPoint, DS.CLASSARGS({ "val : PyGe.Point3d" }))
        .def("isDefaultAlignment", &PyDbText::isDefaultAlignment, DS.CLASSARGS())
        .def("normal", &PyDbText::normal, DS.CLASSARGS())
        .def("setNormal", &PyDbText::setNormal, DS.CLASSARGS({ "val : PyGe.Vector3d" }))
        .def("thickness", &PyDbText::thickness, DS.CLASSARGS())
        .def("setThickness", &PyDbText::setThickness, DS.CLASSARGS({ "val : float" }))
        .def("oblique", &PyDbText::oblique, DS.CLASSARGS())
        .def("setOblique", &PyDbText::setOblique, DS.CLASSARGS({ "val : float" }))
        .def("rotation", &PyDbText::rotation, DS.CLASSARGS())
        .def("setRotation", &PyDbText::setRotation, DS.CLASSARGS({ "val : float" }))
        .def("height", &PyDbText::height, DS.CLASSARGS())
        .def("setHeight", &PyDbText::setHeight, DS.CLASSARGS({ "val : float" }))
        .def("widthFactor", &PyDbText::widthFactor, DS.CLASSARGS())
        .def("setWidthFactor", &PyDbText::setWidthFactor, DS.CLASSARGS({ "val : float" }))
        .def("textString", &PyDbText::textString, DS.CLASSARGS())
        .def("setTextString", &PyDbText::setTextString, DS.CLASSARGS({ "val : str" }))
        .def("textStyle", &PyDbText::textStyle, DS.CLASSARGS())
        .def("setTextStyle", &PyDbText::setTextStyle, DS.CLASSARGS({ "val : ObjectId" }))
        .def("isMirroredInX", &PyDbText::isMirroredInX, DS.CLASSARGS())
        .def("mirrorInX", &PyDbText::mirrorInX, DS.CLASSARGS({ "val : bool" }))
        .def("isMirroredInY", &PyDbText::isMirroredInY, DS.CLASSARGS())
        .def("mirrorInY", &PyDbText::mirrorInY, DS.CLASSARGS({ "val : bool" }))
        .def("horizontalMode", &PyDbText::horizontalMode, DS.CLASSARGS())
        .def("setHorizontalMode", &PyDbText::setHorizontalMode, DS.CLASSARGS({ "val : TextHorzMode" }))
        .def("verticalMode", &PyDbText::verticalMode, DS.CLASSARGS())
        .def("setVerticalMode", &PyDbText::setVerticalMode, DS.CLASSARGS({ "val : TextVertMode" }))
        .def("correctSpelling", &PyDbText::correctSpelling, DS.CLASSARGS())
        .def("adjustAlignment", &PyDbText::adjustAlignment, DS.CLASSARGS({ "val : Database" }))
        .def("convertFieldToText", &PyDbText::convertFieldToText, DS.CLASSARGS())
        .def("hitTest", &PyDbText::hitTest, DS.CLASSARGS({ "val : PyGe.Point3d" }))
        .def("getBoundingPoints", &PyDbText::getBoundingPoints, DS.CLASSARGS())
        .def("justification", &PyDbText::justification, DS.CLASSARGS())
        .def("setJustification", &PyDbText::setJustification, DS.CLASSARGS({ "val : TextAlignment" }))
        .def("className", &PyDbText::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbText::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbText::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbText::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
...
void makePyDbAttributeDefinitionWrapper()
{
    ...
    class_<PyDbAttributeDefinition, bases<PyDbText>>("AttributeDefinition")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("prompt", &PyDbAttributeDefinition::prompt, DS.CLASSARGS())
        .def("setPrompt", &PyDbAttributeDefinition::setPrompt, DS.CLASSARGS({ "val : str" }))
        .def("tag", &PyDbAttributeDefinition::tag, DS.CLASSARGS())
        .def("setTag", &PyDbAttributeDefinition::setTag, DS.CLASSARGS({ "val : str" }))
        .def("isInvisible", &PyDbAttributeDefinition::isInvisible, DS.CLASSARGS())
        .def("setInvisible", &PyDbAttributeDefinition::setInvisible, DS.CLASSARGS({ "val : bool" }))
        .def("isConstant", &PyDbAttributeDefinition::isConstant, DS.CLASSARGS())
        .def("setConstant", &PyDbAttributeDefinition::setConstant, DS.CLASSARGS({ "val : bool" }))
        .def("isVerifiable", &PyDbAttributeDefinition::isVerifiable, DS.CLASSARGS())
        .def("setVerifiable", &PyDbAttributeDefinition::setVerifiable, DS.CLASSARGS({ "val : bool" }))
        .def("isPreset", &PyDbAttributeDefinition::isPreset, DS.CLASSARGS())
        .def("setPreset", &PyDbAttributeDefinition::setPreset, DS.CLASSARGS({ "val : bool" }))
        .def("fieldLength", &PyDbAttributeDefinition::fieldLength, DS.CLASSARGS())
        .def("setFieldLength", &PyDbAttributeDefinition::setFieldLength, DS.CLASSARGS({ "val : int" }))
        .def("adjustAlignment", &PyDbAttributeDefinition::adjustAlignment, DS.CLASSARGS({ "val : Database" }))
        .def("lockPositionInBlock", &PyDbAttributeDefinition::lockPositionInBlock, DS.CLASSARGS())
        .def("setLockPositionInBlock", &PyDbAttributeDefinition::setLockPositionInBlock, DS.CLASSARGS({ "val : bool" }))
        .def("isMTextAttributeDefinition", &PyDbAttributeDefinition::isMTextAttributeDefinition, DS.CLASSARGS())
        .def("convertIntoMTextAttributeDefinition", &PyDbAttributeDefinition::convertIntoMTextAttributeDefinition, DS.CLASSARGS({ "val : bool" }))
        .def("updateMTextAttributeDefinition", &PyDbAttributeDefinition::updateMTextAttributeDefinition, DS.CLASSARGS())
        .def("getMTextAttributeDefinition", &PyDbAttributeDefinition::getMTextAttributeDefinition, DS.CLASSARGS())
        .def("setMTextAttributeDefinition", &PyDbAttributeDefinition::setMTextAttributeDefinition, DS.CLASSARGS({ "val : MText" }))
        .def("className", &PyDbAttributeDefinition::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbAttributeDefinition::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbAttributeDefinition::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbAttributeDefinition::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbAttributeWrapper()
{
    ...
    class_<PyDbAttribute, bases<PyDbText>>("AttributeReference")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("tag", &PyDbAttribute::tag, DS.CLASSARGS())
        .def("setTag", &PyDbAttribute::setTag, DS.CLASSARGS({ "val : str" }))
        .def("isInvisible", &PyDbAttribute::isInvisible, DS.CLASSARGS())
        .def("setInvisible", &PyDbAttribute::setInvisible, DS.CLASSARGS({ "val : bool" }))
        .def("isConstant", &PyDbAttribute::isConstant, DS.CLASSARGS())
        .def("isVerifiable", &PyDbAttribute::isVerifiable, DS.CLASSARGS())
        .def("isPreset", &PyDbAttribute::isPreset, DS.CLASSARGS())
        .def("fieldLength", &PyDbAttribute::fieldLength, DS.CLASSARGS())
        .def("setFieldLength", &PyDbAttribute::setFieldLength, DS.CLASSARGS({ "val : int" }))
        ...
        .def("lockPositionInBlock", &PyDbAttribute::lockPositionInBlock, DS.CLASSARGS())
        .def("setLockPositionInBlock", &PyDbAttribute::setLockPositionInBlock, DS.CLASSARGS({ "val : bool" }))
        .def("isMTextAttribute", &PyDbAttribute::isMTextAttribute, DS.CLASSARGS())
        .def("getMTextAttribute", &PyDbAttribute::getMTextAttribute, DS.CLASSARGS())
        .def("setMTextAttribute", &PyDbAttribute::setMTextAttribute, DS.CLASSARGS({ "val : MText" }))
        .def("convertIntoMTextAttribute", &PyDbAttribute::convertIntoMTextAttribute, DS.CLASSARGS({ "val : bool" }))
        .def("updateMTextAttribute", &PyDbAttribute::updateMTextAttribute, DS.CLASSARGS())
        .def("isReallyLocked", &PyDbAttribute::isReallyLocked, DS.CLASSARGS())
        .def("className", &PyDbAttribute::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbAttribute::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbAttribute::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbAttribute::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbBlockReferenceWrapper()
{
    ...
    class_<PyDbBlockReference, bases<PyDbEntity>>("BlockReference")
        ...
        .def("blockTableRecord", &PyDbBlockReference::blockTableRecord, DS.CLASSARGS())
        .def("setBlockTableRecord", &PyDbBlockReference::setBlockTableRecord, DS.CLASSARGS({ "val : ObjectId" }))
        .def("position", &PyDbBlockReference::position, DS.CLASSARGS())
        .def("setPosition", &PyDbBlockReference::setPosition, DS.CLASSARGS({ "val : PyGe.Point3d" }))
        .def("scaleFactors", &PyDbBlockReference::scaleFactors, DS.CLASSARGS())
        .def("nonAnnotationScaleFactors", &PyDbBlockReference::nonAnnotationScaleFactors, DS.CLASSARGS())
        .def("setScaleFactors", &PyDbBlockReference::setScaleFactors, DS.CLASSARGS({ "val : PyGe.Scale3d" }))
        .def("rotation", &PyDbBlockReference::rotation, DS.CLASSARGS())
        .def("setRotation", &PyDbBlockReference::setRotation, DS.CLASSARGS({ "val : float" }))
        .def("normal", &PyDbBlockReference::normal, DS.CLASSARGS())
        .def("setNormal", &PyDbBlockReference::setNormal, DS.CLASSARGS({ "val : PyGe.Vector3d" }))
        .def("blockTransform", &PyDbBlockReference::blockTransform, DS.CLASSARGS())
        .def("nonAnnotationBlockTransform", &PyDbBlockReference::nonAnnotationBlockTransform, DS.CLASSARGS())
        .def("setBlockTransform", &PyDbBlockReference::setBlockTransform, DS.CLASSARGS({ "val : PyGe.Matrix3d" }))
        .def("appendAttribute", &PyDbBlockReference::appendAttribute, DS.CLASSARGS({ "val : Attribute" }))
        .def("attributeIds", &PyDbBlockReference::attributeIds, DS.CLASSARGS())
        .def("treatAsAcDbBlockRefForExplode", &PyDbBlockReference::treatAsAcDbBlockRefForExplode, DS.CLASSARGS())
        .def("geomExtentsBestFit", &PyDbBlockReference::geomExtentsBestFit1)
        .def("geomExtentsBestFit", &PyDbBlockReference::geomExtentsBestFit2, DS.CLASSARGS({ "val : PyGe.Matrix3d=kIdentity" }))
        .def("explodeToOwnerSpace", &PyDbBlockReference::explodeToOwnerSpace, DS.CLASSARGS())
        .def("className", &PyDbBlockReference::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbBlockReference::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbBlockReference::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbBlockReference::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbDynBlockReferenceWrapper() //TODO: Make test
{
    ...
    class_<PyDbDynBlockReference>("DynBlockReference", no_init)
        .def(init<const PyDbObjectId&>(DS.CLASSARGS({ "val : ObjectId" })))
        .def("isDynamicBlock", &PyDbDynBlockReference::isDynamicBlock1, DS.CLASSARGS())
        .def("blockId", &PyDbDynBlockReference::blockId, DS.CLASSARGS())
        .def("resetBlock", &PyDbDynBlockReference::resetBlock, DS.CLASSARGS())
        .def("convertToStaticBlock", &PyDbDynBlockReference::convertToStaticBlock1)
        .def("convertToStaticBlock", &PyDbDynBlockReference::convertToStaticBlock2, DS.CLASSARGS({ "val : str=None" }))
        .def("dynamicBlockTableRecord", &PyDbDynBlockReference::dynamicBlockTableRecord, DS.CLASSARGS())
        .def("anonymousBlockTableRecord", &PyDbDynBlockReference::anonymousBlockTableRecord, DS.CLASSARGS())
        .def("getBlockProperties", &PyDbDynBlockReference::getBlockProperties, DS.CLASSARGS())
        .def("getIsDynamicBlock", &PyDbDynBlockReference::isDynamicBlock2, DS.CLASSARGSSTATIC({ "otherObject: ObjectId" })).staticmethod("getIsDynamicBlock")
        .def("className", &PyDbDynBlockReference::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        ;
}
...
void makePyDbMInsertBlockeWrapper()
{
    ...
    class_<PyDbMInsertBlock, bases<PyDbBlockReference>>("MInsertBlock")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("columns", &PyDbMInsertBlock::columns, DS.CLASSARGS())
        .def("setColumns", &PyDbMInsertBlock::setColumns, DS.CLASSARGS({ "val : int" }))
        .def("rows", &PyDbMInsertBlock::rows, DS.CLASSARGS())
        .def("setRows", &PyDbMInsertBlock::setRows, DS.CLASSARGS({ "val : int" }))
        .def("columnSpacing", &PyDbMInsertBlock::columnSpacing, DS.CLASSARGS())
        .def("setColumnSpacing", &PyDbMInsertBlock::setColumnSpacing, DS.CLASSARGS({ "val : float" }))
        .def("rowSpacing", &PyDbMInsertBlock::rowSpacing, DS.CLASSARGS())
        .def("setRowSpacing", &PyDbMInsertBlock::setRowSpacing, DS.CLASSARGS({ "val : float" }))
        .def("className", &PyDbMInsertBlock::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbMInsertBlock::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbMInsertBlock::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbMInsertBlock::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyAcDb3dPolylineVertexWrapper()
{
    ...
    class_<PyDb3dPolylineVertex, bases<PyDbVertex>>("Polyline3dVertex")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("vertexType", &PyDb3dPolylineVertex::vertexType, DS.CLASSARGS())
        .def("position", &PyDb3dPolylineVertex::position, DS.CLASSARGS())
        .def("setPosition", &PyDb3dPolylineVertex::setPosition, DS.CLASSARGS({ "val : PyGe.Point3d" }))
        .def("className", &PyDb3dPolylineVertex::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDb3dPolylineVertex::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDb3dPolylineVertex::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDb3dPolylineVertex::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyAcDbPolygonMeshVertexWrapper()
{
    ...
    class_<PyDbPolygonMeshVertex, bases<PyDbVertex>>("PolygonMeshVertex")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("vertexType", &PyDbPolygonMeshVertex::vertexType, DS.CLASSARGS())
        .def("position", &PyDbPolygonMeshVertex::position, DS.CLASSARGS())
        .def("setPosition", &PyDbPolygonMeshVertex::setPosition, DS.CLASSARGS({ "val : PyGe.Point3d" }))
        .def("className", &PyDbPolygonMeshVertex::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbPolygonMeshVertex::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbPolygonMeshVertex::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbPolygonMeshVertex::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbPolyFaceMeshVertexWrapper()
{
    ...
    class_<PyDbPolyFaceMeshVertex, bases<PyDbVertex>>("PolyFaceMeshVertex")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("position", &PyDbPolyFaceMeshVertex::position, DS.CLASSARGS())
        .def("setPosition", &PyDbPolyFaceMeshVertex::setPosition, DS.CLASSARGS({ "val : PyGe.Point3d" }))
        .def("className", &PyDbPolyFaceMeshVertex::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbPolyFaceMeshVertex::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbPolyFaceMeshVertex::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbPolyFaceMeshVertex::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyAcDbFaceRecordWrapper()
{
    ...
    class_<PyDbFaceRecord, bases<PyDbVertex>>("FaceRecord")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("getVertexAt", &PyDbFaceRecord::getVertexAt, DS.CLASSARGS({ "val : int" }))
        .def("setVertexAt", &PyDbFaceRecord::setVertexAt, DS.CLASSARGS({ "val : int",  "idx : int" }))
        .def("isEdgeVisibleAt", &PyDbFaceRecord::isEdgeVisibleAt, DS.CLASSARGS({ "val : int" }))
        .def("makeEdgeVisibleAt", &PyDbFaceRecord::makeEdgeVisibleAt, DS.CLASSARGS({ "val : int" }))
        .def("makeEdgeInvisibleAt", &PyDbFaceRecord::makeEdgeInvisibleAt, DS.CLASSARGS({ "val : int" }))
        .def("className", &PyDbFaceRecord::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbFaceRecord::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbFaceRecord::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbFaceRecord::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbPointWrapper()
{
    ...
    class_<PyDbPoint, bases<PyDbEntity>>("Point")
        ...
        .def(init<const PyDbObjectId&>())
        .def(init<const PyDbObjectId&, AcDb::OpenMode>())
        .def("position", &PyDbPoint::position, DS.CLASSARGS())
        .def("setPosition", &PyDbPoint::setPosition, DS.CLASSARGS({ "val : PyGe.Point3d" }))
        .def("thickness", &PyDbPoint::thickness, DS.CLASSARGS())
        .def("setThickness", &PyDbPoint::setThickness, DS.CLASSARGS({ "val : float" }))
        .def("normal", &PyDbPoint::normal, DS.CLASSARGS())
        .def("setNormal", &PyDbPoint::setNormal, DS.CLASSARGS({ "val : PyGe.Vector3d" }))
        .def("ecsRotation", &PyDbPoint::ecsRotation, DS.CLASSARGS())
        .def("setEcsRotation", &PyDbPoint::setEcsRotation, DS.CLASSARGS({ "val : float" }))
        .def("className", &PyDbPoint::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbPoint::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbPoint::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbPoint::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDb2dPolylineWrapper()
{
    ...
    class_<PyDb2dPolyline, bases<PyDbCurve>>("Polyline2d")
        ...
        .def("className", &PyDb2dPolyline::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDb2dPolyline::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDb2dPolyline::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDb2dPolyline::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDb3dPolylineWrapper()
{
    ...
    class_<PyDb3dPolyline, bases<PyDbCurve>>("Polyline3d")
        ...
        .def("className", &PyDb3dPolyline::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDb3dPolyline::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDb3dPolyline::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDb3dPolyline::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbArcWrapper()
{
    ...
    class_<PyDbArc, bases<PyDbCurve>>("Arc")
        ...
        .def("className", &PyDbArc::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbArc::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbArc::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbArc::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbCircleWrapper()
{
    ...
    class_<PyDbCircle, bases<PyDbCurve>>("Circle")
        ...
        .def("className", &PyDbCircle::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbCircle::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbCircle::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbCircle::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbLineWrapper()
{
    ...
    class_<PyDbLine, bases<PyDbCurve>>("Line")
        ...
        .def("className", &PyDbLine::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbLine::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbLine::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbLine::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbPolylineWrapper()
{
    ...
    class_<PyDbPolyline, bases<PyDbCurve>>("Polyline")
        ...
        .def("getEcs", &PyDbPolyline::getEcs)
        .def("className", &PyDbPolyline::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbPolyline::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbPolyline::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbPolyline::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
...
void makePyDbFaceWrapper()
{
    ...
    class_<PyDbFace, bases<PyDbEntity>>("Face")
        ...
        .def("className", &PyDbFace::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbFace::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbFace::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbFace::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
...
void makePyDbFcfWrapper()
{
    ...
    class_<PyDbFcf, bases<PyDbEntity>>("Fcf")
        ...
        .def("className", &PyDbFcf::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbFcf::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbFcf::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbFcf::cast, DS.CLASSARGSSTATIC({ "otherObject: RxObject" })).staticmethod("cast")
        ;
}
PyDbFcf::PyDbFcf()
