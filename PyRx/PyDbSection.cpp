...
void makePyDbSectionSettingsWrapper()
{
    constexpr const std::string_view resetOverloads = "Overloads:\n"
        "- None: Any\n"
        "- nSecType: PyDb.SectionSectionType\n";
    ...
    class_<PyDbSectionSettings, bases<PyDbObject>>("SectionSettings")
        ...
        .def("setCurrentSectionType", &PyDbSectionSettings::setCurrentSectionType, DS.ARGS({"nSecType: PyDb.SectionSectionType"}))
        .def("generationOptions", &PyDbSectionSettings::generationOptions, DS.ARGS({ "nSecType: PyDb.SectionSectionType" }))
        .def("setGenerationOptions", &PyDbSectionSettings::setGenerationOptions, DS.ARGS({ "nSecType: PyDb.SectionSectionType", "opts: PyDb.SectionGeneration"}))
        .def("getSourceObjects", &PyDbSectionSettings::getSourceObjects, DS.ARGS({ "nSecType: PyDb.SectionSectionType" }))
        .def("setSourceObjects", &PyDbSectionSettings::setSourceObjects, DS.ARGS({ "nSecType: PyDb.SectionSectionType","ids: list[PyDb.ObjectId]" }))
        .def("destinationBlock", &PyDbSectionSettings::destinationBlock, DS.ARGS({ "nSecType: PyDb.SectionSectionType" }))
        .def("setDestinationBlock", &PyDbSectionSettings::setDestinationBlock, DS.ARGS({ "nSecType: PyDb.SectionSectionType","id: PyDb.ObjectId" }))
        .def("destinationFile", &PyDbSectionSettings::destinationFile, DS.ARGS({ "nSecType: PyDb.SectionSectionType" }))
        .def("setDestinationFile", &PyDbSectionSettings::setDestinationFile, DS.ARGS({ "nSecType: PyDb.SectionSectionType","fileName: str" }))
        .def("visibility", &PyDbSectionSettings::visibility, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setVisibility", &PyDbSectionSettings::setVisibility, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry", "flag: bool"}))
        .def("color", &PyDbSectionSettings::color, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setColor", &PyDbSectionSettings::setColor, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","clr: PyDb.Color" }))
        .def("layer", &PyDbSectionSettings::layer, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setLayer", &PyDbSectionSettings::setLayer, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","name: str" }))
        .def("linetype", &PyDbSectionSettings::linetype, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setLinetype", &PyDbSectionSettings::setLinetype, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","lineType: str"}))
        .def("linetypeScale", &PyDbSectionSettings::linetypeScale, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setLinetypeScale", &PyDbSectionSettings::setLinetypeScale, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: float" }))
        .def("plotStyleName", &PyDbSectionSettings::plotStyleName, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setPlotStyleName", &PyDbSectionSettings::setPlotStyleName, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: str" }))
        .def("lineWeight", &PyDbSectionSettings::lineWeight, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setLineWeight", &PyDbSectionSettings::setLineWeight, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: PyDb.LineWeight" }))
        .def("faceTransparency", &PyDbSectionSettings::faceTransparency, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setFaceTransparency", &PyDbSectionSettings::setFaceTransparency, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: int" }))
        .def("edgeTransparency", &PyDbSectionSettings::edgeTransparency, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setEdgeTransparency", &PyDbSectionSettings::setEdgeTransparency, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: int" }))
        .def("hatchVisibility", &PyDbSectionSettings::hatchVisibility, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setHatchVisibility", &PyDbSectionSettings::setHatchVisibility, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: bool" }))
        .def("getHatchPattern", &PyDbSectionSettings::getHatchPattern, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setHatchPattern", &PyDbSectionSettings::setHatchPattern, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","pattern: PyDb.HatchPatternType", "name: str" }))
        .def("hatchAngle", &PyDbSectionSettings::hatchAngle, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setHatchAngle", &PyDbSectionSettings::setHatchAngle, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: float" }))
        .def("hatchSpacing", &PyDbSectionSettings::hatchSpacing, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setHatchSpacing", &PyDbSectionSettings::setHatchSpacing, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: float" }))
        .def("hatchScale", &PyDbSectionSettings::hatchScale, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setHatchScale", &PyDbSectionSettings::setHatchScale, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: float" }))
        .def("hiddenLine", &PyDbSectionSettings::hiddenLine, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setHiddenLine", &PyDbSectionSettings::setHiddenLine, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","val: bool" }))
        .def("divisionLines", &PyDbSectionSettings::divisionLines, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry" }))
        .def("setDivisionLines", &PyDbSectionSettings::setDivisionLines, DS.ARGS({ "nSecType: PyDb.SectionSectionType","nGeometry: PyDb.SectionGeometry","show: bool" }))
