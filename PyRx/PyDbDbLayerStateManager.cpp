...
void makePyDbDbLayerStateManagerWrapper()
{
    ...
    class_<PyDbDbLayerStateManager, bases<PyRxObject>>("LayerStateManager")
        .def(init<>())
        .def(init<const PyDbDatabase&>(DS.ARGS({ "db: PyDb.Database=None" }, 5738)))
        ...
        .def("saveLayerState", &PyDbDbLayerStateManager::saveLayerState2, DS.ARGS({ "sName: str", "mask: PyDb.LayerStateMask","id: PyDb.ObjectId=None" }, 5761))
        .def("restoreLayerState", &PyDbDbLayerStateManager::restoreLayerState1)
        .def("restoreLayerState", &PyDbDbLayerStateManager::restoreLayerState2, DS.ARGS({ "sName: str", "vpId: PyDb.ObjectId", "flags: int = 0", "mask: PyDb.LayerStateMask=None" }, 5760))
