...
void makePyDbSpatialFilterWrapper()
{
    ...
    class_<PyDbSpatialFilter, bases<PyDbObject>>("SpatialFilter")
        ...
        .def("queryBounds", &PyDbSpatialFilter::queryBounds2, DS.ARGS({ "ref : PyDb.BlockReference=None" }))
        .def("getVolume", &PyDbSpatialFilter::getVolume, DS.ARGS())
        .def("setDefinition", &PyDbSpatialFilter::setDefinition, DS.ARGS({ "pnt2d: list[PyGe.Point2d]","normal: PyGe.Vector3d","elev: float","frontclip: float","backclip: float","enabled: bool" }))
