...
void makePyDbSpatialFilterWrapper()
{
    ...
    class_<PyDbSpatialFilter, bases<PyDbObject>>("SpatialFilter")
        ...
        .def("indexClass", &PyDbSpatialFilter::indexClass)
        .def("queryBounds", &PyDbSpatialFilter::queryBounds1)
        .def("queryBounds", &PyDbSpatialFilter::queryBounds2)
        .def("getVolume", &PyDbSpatialFilter::getVolume)
        .def("setDefinition", &PyDbSpatialFilter::setDefinition)
        .def("getDefinition", &PyDbSpatialFilter::getDefinition)
        .def("getClipSpaceToWCSMatrix", &PyDbSpatialFilter::getClipSpaceToWCSMatrix)
        .def("getOriginalInverseBlockXform", &PyDbSpatialFilter::getOriginalInverseBlockXform)
        .def("setPerspectiveCamera", &PyDbSpatialFilter::setPerspectiveCamera)
        .def("clipVolumeIntersectsExtents", &PyDbSpatialFilter::clipVolumeIntersectsExtents)
        .def("hasPerspectiveCamera", &PyDbSpatialFilter::hasPerspectiveCamera)
        .def("isInverted", &PyDbSpatialFilter::isInverted)
        .def("setInverted", &PyDbSpatialFilter::setInverted)
