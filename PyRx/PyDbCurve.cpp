...
void makePyDbCurveWrapper()
{
    ...
    class_<PyDbCurve, bases<PyDbEntity>>("Curve", boost::python::no_init)
        ...
        .def("getPointAtParam", &PyDbCurve::getPointAtParam, DS.CLASSARGS({ "param: real" }))
        .def("getParamAtPoint", &PyDbCurve::getParamAtPoint, DS.CLASSARGS({ "point3d: PyGe.Point3d" }))
        .def("getDistAtParam", &PyDbCurve::getDistAtParam, DS.CLASSARGS({ "param: real" }))
        .def("getParamAtDist", &PyDbCurve::getParamAtDist, DS.CLASSARGS({ "dist: real" }))
        .def("getDistAtPoint", &PyDbCurve::getDistAtPoint, DS.CLASSARGS({ "point3d: PyGe.Point3d" }))
        .def("getPointAtDist", &PyDbCurve::getPointAtDist, DS.CLASSARGS({ "dist: real" }))
        .def<AcGeVector3d(PyDbCurve::*)(double)const>("getFirstDeriv", &PyDbCurve::getFirstDeriv)
        .def<AcGeVector3d(PyDbCurve::*)(const AcGePoint3d&)const>("getFirstDeriv", &PyDbCurve::getFirstDeriv, DS.CLASSARGS({ "param: real|PyGe.Point3d" }))
        .def<AcGeVector3d(PyDbCurve::*)(double)const>("getSecondDeriv", &PyDbCurve::getSecondDeriv)
        .def<AcGeVector3d(PyDbCurve::*)(const AcGePoint3d&)const>("getSecondDeriv", &PyDbCurve::getSecondDeriv, DS.CLASSARGS({ "param: real|PyGe.Point3d" }))
        .def<AcGePoint3d(PyDbCurve::*)(const AcGePoint3d&, Adesk::Boolean)const>("getClosestPointTo", &PyDbCurve::getClosestPointTo)
        .def<AcGePoint3d(PyDbCurve::*)(const AcGePoint3d& givenPnt, const AcGeVector3d& direction, Adesk::Boolean extend)const>("getClosestPointTo", &PyDbCurve::getClosestPointTo, DS.CLASSARGS({ "point3d: PyGe.Point3d","extent: bool=False" }))
        .def("getOffsetCurves", &PyDbCurve::getOffsetCurves, DS.CLASSARGS({ "dist: real" }))
        .def("getOffsetCurvesGivenPlaneNormal", &PyDbCurve::getOffsetCurvesGivenPlaneNormal, DS.CLASSARGS({ "normal: PyGe.Vector3d", "dist: real" }))
