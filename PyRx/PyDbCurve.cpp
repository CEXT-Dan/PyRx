...
void makePyDbCurveWrapper()
{
    ...
    class_<PyDbCurve, bases<PyDbEntity>>("Curve", boost::python::no_init)
        ...
        .def("getAcGeCurve", &PyDbCurve::getAcGeCurve2, DS.CLASSARGS({ "tol: Tol = default" }))
        .def("setFromAcGeCurve", &PyDbCurve::setFromAcGeCurve1)
        .def("setFromAcGeCurve", &PyDbCurve::setFromAcGeCurve2)
        .def("setFromAcGeCurve", &PyDbCurve::setFromAcGeCurve3, DS.CLASSARGS({ "curve: PyGe.Curve3d","normal: PyGe.Vector3d = kZAxis","tol: Tol = default" }))
        .def("createFromAcGeCurve", &PyDbCurve::createFromAcGeCurve1)
        .def("createFromAcGeCurve", &PyDbCurve::createFromAcGeCurve2)
        .def("createFromAcGeCurve", &PyDbCurve::createFromAcGeCurve3, DS.CLASSARGSSTATIC({ "curve: PyGe.Curve3d","normal: PyGe.Vector3d = kZAxis","tol: Tol = default" })).staticmethod("createFromAcGeCurve")
        .def("className", &PyDbCurve::className, DS.CLASSARGSSTATIC()).staticmethod("className")
        .def("desc", &PyDbCurve::desc, DS.CLASSARGSSTATIC()).staticmethod("desc")
        .def("cloneFrom", &PyDbCurve::cloneFrom, DS.CLASSARGSSTATIC({ "otherObject: PyRx.RxObject" })).staticmethod("cloneFrom")
        .def("cast", &PyDbCurve::cast, DS.CLASSARGSSTATIC({ "otherObject: PyRx.RxObject" })).staticmethod("cast")
        ;
}
