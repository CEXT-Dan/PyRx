...
void makePyGePoint2dWrapper()
{
    ...
    class_<AcGePoint2d>("Point2d")
        ...
        .def<AcGePoint2d(AcGePoint2d::*)(const AcGeVector2d&)const>("__sub__", &AcGePoint2d::operator-, DS.ARGS({ "vec: PyGe.Vector2d" }))
...
static void makePyGeMatrix2dWrapper()
{
    ...
    class_<AcGeMatrix2d>("Matrix2d")
        ...
        .def("setCoordSystem", &AcGeMatrix2d::setCoordSystem, DS.ARGS({ "or: PyGe.Point2d","e0: PyGe.Vector2d","e1: PyGe.Vector2d" }), return_self<>())
        .def("getCoordSystem", &AcGeMatrix2d::getCoordSystem, DS.ARGS({ "or: PyGe.Point2d","e0: PyGe.Vector2d","e1: PyGe.Vector2d" }))
...
static void makePyGeVector3dWrapper()
{
    ...
    class_<AcGeVector3d>("Vector3d")
        ...
        .def<double(AcGeVector3d::*)(const AcGeVector3d&, const AcGeVector3d&) const>("angleTo", &AcGeVector3d::angleTo, DS.ARGS({ "vec: PyGe.Vector3d","ref: PyGe.Vector3d=None" }, 12885))
        ...
        .def("normal", &AcGeVector3d::normal, arg("AcGeTol") = getTol(), DS.ARGS({ "tol: PyGe.Tol=None" }, 12904))
        .def("length", &AcGeVector3d::length, DS.ARGS(12900))
        .def("lengthSqrd", &AcGeVector3d::lengthSqrd, DS.ARGS(12901))
        .def("isUnitLength", &AcGeVector3d::isUnitLength, arg("AcGeTol") = getTol(), DS.ARGS({ "tol: PyGe.Tol=None" }, 12893))
        .def("isZeroLength", &AcGeVector3d::isZeroLength, arg("AcGeTol") = getTol(), DS.ARGS({ "tol: PyGe.Tol=None" }, 12894))
        .def<Adesk::Boolean(AcGeVector3d::*)(const AcGeVector3d&, const AcGeTol&) const>("isParallelTo", &AcGeVector3d::isParallelTo, arg("AcGeTol") = getTol(), DS.ARGS({ "vec: PyGe.Vector3d","tol: PyGe.Tol=None" }, 12891))
        .def<Adesk::Boolean(AcGeVector3d::*)(const AcGeVector3d&, const AcGeTol&) const>("isCodirectionalTo", &AcGeVector3d::isCodirectionalTo, arg("AcGeTol") = getTol(), DS.ARGS({ "vec: PyGe.Vector3d","tol: PyGe.Tol=None" }, 12889))
        .def<Adesk::Boolean(AcGeVector3d::*)(const AcGeVector3d&, const AcGeTol&) const>("isPerpendicularTo", &AcGeVector3d::isPerpendicularTo, arg("AcGeTol") = getTol(), DS.ARGS({ "vec: PyGe.Vector3d","tol: PyGe.Tol=None" }, 12892))
        ...
        .def<AcGeVector3d(AcGeVector3d::*)(const AcGeVector3d&, const AcGeVector3d&, const AcGeTol&, AcGeError&) const>("project", &AcGeVector3d::project, DS.ARGS({ "pln: PyGe.Vector3d","dir: PyGe.Vector3d","tol: PyGe.Tol=None" }, 12908))
        .def<AcGeVector3d(AcGeVector3d::*)(const AcGeVector3d&) const>("orthoProject", &AcGeVector3d::orthoProject)
        .def<AcGeVector3d(AcGeVector3d::*)(const AcGeVector3d&, const AcGeTol&, AcGeError&) const>("orthoProject", &AcGeVector3d::orthoProject, DS.ARGS({ "planeNormal: PyGe.Vector3d","tol: PyGe.Tol=None" }, 12906))
        .def("isEqualTo", &AcGeVector3d::isEqualTo, arg("AcGeTol") = getTol(), DS.ARGS({ "vec: PyGe.Vector3d","tol: PyGe.Tol=None" }, 12890))
...
void makePyGeMatrix3dWrapper()
{
    ...
    class_<AcGeMatrix3d>("Matrix3d")
        ...
        .def("isEqualTo", &AcGeMatrix3d::isEqualTo, DS.ARGS({ "other: PyGe.Matrix3d","tol: PyGe.Tol=None" }))
        .def("isUniScaledOrtho", &AcGeMatrix3d::isUniScaledOrtho, DS.ARGS({ "val: PyGe.Tol=None" }), arg("AcGeTol") = getTol())
        .def("isScaledOrtho", &AcGeMatrix3d::isScaledOrtho, DS.ARGS({ "val: PyGe.Tol=None" }), arg("AcGeTol") = getTol())
