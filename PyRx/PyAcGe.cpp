...
void makePyGePoint3dWrapper()
{
    ...
    class_<AcGePoint3d>("Point3d")
        ...
        .def("setToProduct", &AcGePoint3d::setToProduct, return_self<>(), DS.ARGS({ "mat: Matrix3d","pnt: Point3d" }))
        .def("transformBy", &AcGePoint3d::transformBy, return_self<>(), DS.ARGS({ "mat: Matrix3d" }))
        .def("rotateBy", &AcGePoint3d::rotateBy, arg("AcGePoint3d") = AcGePoint3dkOrigin(), return_self<>(), DS.ARGS({ "angle: float","vec: Vector3d","wrtPoint: Point3d=Point3d.kOrigin" }))
        .def("mirror", &AcGePoint3d::mirror, return_self<>(), DS.ARGS({ "pln: Plane" }))
...
void makePyGeMatrix3dWrapper()
{
    ...
    class_<AcGeMatrix3d>("Matrix3d")
        ...
        .def("isEqualTo", &AcGeMatrix3d::isEqualTo, DS.ARGS({ "val : PyGe.Matrix3d","val : PyGe.Tol=default" }))
        ...
        .def("setToRotation", &AcGeMatrix3d::setToRotation, 
            DS.ARGS({ "ang:real", "axis:PyGe.Vector3d","origin:PyGe.Point3d=kOrigin" }), return_self<>(), arg("AcGePoint3d") = AcGePoint3dkOrigin())
