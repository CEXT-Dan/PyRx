...
void makeAcGePoint3dWrapper()
{
    ...
    class_<AcGePoint3d>("Point3d")
        ...
        .def(init<double, double, double>(DS.CLASSARGS({ "x: double","y: double","z: double" })))
        ...
        .def("rotateBy", &AcGePoint3d::rotateBy, arg("AcGePoint3d") = AcGePoint3dkOrigin(), return_self<>(), DS.CLASSARGS({ "angle: double","vec: Vector3d","wrtPoint: Point3d=Point3d.kOrigin" }))
