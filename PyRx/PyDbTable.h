...
public:
    ...
    void                setGridColor2(int row, int col, AcDb::CellEdgeMask nEdges, const AcCmColor& color);
    AcDb::Visibility    gridVisibility2(int row, int col, AcDb::CellEdgeMask iEdge) const;
    void                setGridVisibility2(int row, int col, AcDb::CellEdgeMask iEdge, AcDb::Visibility value);
    AcDb::LineWeight    gridLineWeight2(int row, int col, AcDb::CellEdgeMask iEdge) const;
    void                setGridLineWeight2(int row, int col, AcDb::CellEdgeMask nEdges, AcDb::LineWeight value);
    ...
    void                setGridLineWeight3(int nRow, int nCol, AcDb::GridLineType nGridLineTypes, AcDb::LineWeight nLineWeight);
    ...
    void                setGridColor3(int nRow, int nCol, AcDb::GridLineType nGridlineTypes, const AcCmColor& color);
    AcDb::Visibility    gridVisibility3(int nRow, int nCol, AcDb::GridLineType nGridLineType) const;
    void                setGridVisibility3(int nRow, int nCol, AcDb::GridLineType nGridLineTypes, AcDb::Visibility nVisibility);
