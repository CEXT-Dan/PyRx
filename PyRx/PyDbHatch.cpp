...
void makePyDbHatchWrapper()
{
    ...
    class_<PyDbHatch, bases<PyDbEntity>>("Hatch")
        ...
        .def("setElevation", &PyDbHatch::setElevation, DS.ARGS({ "val : real" }))
        ...
        .def("setGradientAngle", &PyDbHatch::setGradientAngle, DS.ARGS({ "val : real" }))
        ...
        .def("setShadeTintValue", &PyDbHatch::setShadeTintValue, DS.ARGS({ "val : real" }))
        .def("setShadeTintValueAndColor2", &PyDbHatch::setShadeTintValueAndColor2)
        .def("gradientShift", &PyDbHatch::gradientShift, DS.ARGS())
        .def("setGradientShift", &PyDbHatch::setGradientShift, DS.ARGS({ "val : real" }))
        ...
        .def("setPatternAngle", &PyDbHatch::setPatternAngle, DS.ARGS({ "val : real" }))
        .def("patternSpace", &PyDbHatch::patternSpace, DS.ARGS())
        .def("setPatternSpace", &PyDbHatch::setPatternSpace, DS.ARGS({ "val : real" }))
        .def("patternScale", &PyDbHatch::patternScale, DS.ARGS())
        .def("setPatternScale", &PyDbHatch::setPatternScale, DS.ARGS({ "val : real" }))
        ...
        .def("evaluateHatchAllScales2", &PyDbHatch::evaluateHatchAllScales2, DS.ARGS({ "val : bool=False" }))
        ...
        .def("desc", &PyDbHatch::desc, DS.SARGS()).staticmethod("desc")
...
void makePyDbMPolygonWrapper()
{
    ...
    class_<PyDbMPolygon, bases<PyDbEntity>>("MPolygon")
        ...
        .def("setElevation", &PyDbMPolygon::setElevation, DS.ARGS({ "val : real" }))
        ...
        .def("setPatternAngle", &PyDbMPolygon::setPatternAngle, DS.ARGS({ "val : real" }))
        .def("patternSpace", &PyDbMPolygon::patternSpace, DS.ARGS())
        .def("setPatternSpace", &PyDbMPolygon::setPatternSpace, DS.ARGS({ "val : real" }))
        .def("patternScale", &PyDbMPolygon::patternScale, DS.ARGS())
        .def("setPatternScale", &PyDbMPolygon::setPatternScale, DS.ARGS({ "val : real" }))
        .def("patternDouble", &PyDbMPolygon::patternDouble, DS.ARGS())
        .def("setPatternDouble", &PyDbMPolygon::setPatternDouble, DS.ARGS({ "val : real" }))
        ...
        .def("setGradientAngle", &PyDbMPolygon::setGradientAngle, DS.ARGS({ "val : real" }))
        .def("setGradientShift", &PyDbMPolygon::setGradientShift, DS.ARGS({ "val : real" }))
        ...
        .def("isPointInsideMPolygon", &PyDbMPolygon::isPointInsideMPolygon, DS.ARGS({ "val : PyGe.Point3d","tol : real" }))
        .def("isPointOnLoopBoundary", &PyDbMPolygon::isPointOnLoopBoundary, DS.ARGS({ "val : PyGe.Point3d","loop : int", "tol : real" }))
        .def("loopCrossesItself", &PyDbMPolygon::loopCrossesItself)
        .def("selfCrosses", &PyDbMPolygon::selfCrosses)
        .def("includesTouchingLoops", &PyDbMPolygon::includesTouchingLoops, DS.ARGS({ "val : real" }))
