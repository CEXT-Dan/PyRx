...
public:
    ...
    void                    setCenter(const AcGePoint2d& cent);
    void                    setRadius(double radius);
    void                    setAngles(double startAng, double endAng);
    void                    setToComplement();
    void                    setRefVec(const AcGeVector2d& vec);
    void                    set1(const AcGePoint2d& cent, double radius);
    void                    set2(const AcGePoint2d& cent, double radius, double ang1, double ang2, const AcGeVector2d& refVec, Adesk::Boolean isClockWise);
    void                    set3(const AcGePoint2d& startPoint, const AcGePoint2d& pnt, const AcGePoint2d& endPoint);
...
public:
    ...
    void                    setAxes(const AcGeVector2d& majorAxis, const AcGeVector2d& minorAxis);
