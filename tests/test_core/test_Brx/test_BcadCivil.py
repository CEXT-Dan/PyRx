...
class TestBCadCivil:
    ...
    def test_stylemanager_getManagerId(self, db_brcivil: Db.Database):
        ...
        self.assertEqual(man.managerId(), "BSYSCV_SURFACE_ELEVATION_LABEL_STYLES")
        #
        ...
        self.assertEqual(man.managerId(), "BSYSCV_SURFACE_SLOPE_LABEL_STYLES")
        #
        ...
        self.assertEqual(man.managerId(), "BSYSCV_SURFACE_CONTOUR_LABEL_STYLES")
        #
        ...
        self.assertEqual(man.managerId(), "BSYSCV_POINT_MAIN_LABEL_STYLES")
        #
        ...
        self.assertEqual(man.managerId(), "BSYSCV_LABEL_STYLES_GENERAL_CURVE")
        #
        ...
        self.assertEqual(man.managerId(), "BSYSCV_LABEL_STYLES_GENERAL_LINE")
        #
        ...
        self.assertEqual(man.managerId(), "BSYSCV_SYMBOL_STYLES")
