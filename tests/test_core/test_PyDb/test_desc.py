...
class TestDesc:
    def test_name(self):
        ...
        assert Db.AttributeReference.desc().name() == "AcDbAttributeReference"
        ...
        assert Db.DbObject.desc().name() == "AcDbDbObject"
        assert Db.DbObjectOverrule.desc().name() == "AcDbDbObjectOverrule"
        assert Db.DbObjectReactor.desc().name() == "AcDbDbObjectReactor"
        ...
        assert Db.LineAngularDimension2.desc().name() == "AcDbLineAngularDimension2"
        ...
        assert Db.OverrulableEntity.desc().name() == "AcDbOverrulableEntity"
        ...
        assert Db.Point3AngularDimension.desc().name() == "AcDbPoint3AngularDimension"
        ...
        assert Db.Polyline2d.desc().name() == "AcDbPolyline2d"
        assert Db.Polyline3d.desc().name() == "AcDbPolyline3d"
        assert Db.Polyline3dVertex.desc().name() == "AcDbPolyline3dVertex"
        assert Db.Profile3d.desc().name() == "AcDbProfile3d"
        ...
        assert Db.Solid3d.desc().name() == "AcDbSolid3d"
        ...
        assert Db.Transaction.desc().name() == "AcDbTransaction"
        ...
        assert Db.Vertex2d.desc().name() == "AcDbVertex2d"
