...
class TestDbPolyline3d:
    ...
    def test_create_2_object_id(self):
        ...
        pline_open = Db.Polyline3d(id, Db.OpenMode.kForWrite)
    ...
    def test_append_vertex(self):
        ...
        new_vt = Db.Polyline3dVertex(new_pt)
        ...
        assert len(vtids) == 3
        last_vt = Db.Polyline3dVertex(vtids[-1])
    ...
    def test_insert_vertex_at(self):
        ...
        inserted_vt = Db.Polyline3dVertex(vtids[1])
    ...
    def test_spline_fit(self):
        ...
        assert pline_open.polyType() == Db.Poly3dType.k3dCubicSplinePoly
    ...
    def test_straighten(self):
        ...
        assert pline_open.polyType() == Db.Poly3dType.k3dSimplePoly
