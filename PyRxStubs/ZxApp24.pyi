...
class IZcadApplication(DispatchBaseClass):
    ...
    def __iter__(self): ...
    @property
    def ActiveDocument(self)-> IZcadDocument: ...
    @property
    def Application(self) -> IZcadApplication: ...
    @property
    def Caption(self): ...
    @property
    def Documents(self) -> IZcadDocuments: ...
    @property
    def FullName(self): ...
    @property
    def HWND(self): ...
    ...
    def LocaleId(self): ...
    @property
    def MenuBar(self)-> IZcadMenuBar: ...
    @property
    def MenuGroups(self) -> IZcadMenuGroups: ...
    @property
    def Name(self): ...
    @property
    def Path(self): ...
...
class IZcadBlock(DispatchBaseClass):
    CLSID: Incomplete
    coclass_clsid: Incomplete
    def Add3DFace(self, Point1=..., Point2=..., point3=..., Point4=...) -> IZcad3DFace: ...
    def Add3DMesh(self, M=..., N=..., PointsMatrix=...)->IZcadPolygonMesh: ...
    def Add3DPoly(self, PointsArray=...)->IZcad3DPolyline: ...
    def AddArc(self, Center=..., Radius=..., StartAngle=..., EndAngle=...)->IZcadArc: ...
    def AddAttribute(self, Height=..., Mode=..., Prompt=..., InsertionPoint=..., Tag=..., Value=...)->IZcadAttribute: ...
    def AddBox(self, Origin=..., Length=..., Width=..., Height=...) -> IZcad3DSolid: ...
    def AddCircle(self, Center=..., Radius=...)->IZcadCircle: ...
    def AddCone(self, Center=..., BaseRadius=..., Height=...)->IZcad3DSolid: ...
...
class IZcadDocument(DispatchBaseClass):
    ...
    def Materials(self): ...
    @property
    def ModelSpace(self) -> IZcadModelSpace: ...
    @property
    def Name(self): ...
    @property
