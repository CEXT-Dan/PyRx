...
class CvDb3dAlignment:
    def __init__ (self: CvDb3dAlignment,id: ObjectId,mode: OpenMode=kForRead,erased: bool=False)-> None :
      '''                             '''
    ...
...
class CvDbHAlignment:
    def __init__ (self: CvDbHAlignment,id: ObjectId,mode: OpenMode=kForRead,erased: bool=False)-> None :
      '''                             '''
    ...
...
class CvDbVAlignmentView:
    def __init__ (self: CvDbVAlignmentView,id: ObjectId,mode: OpenMode=kForRead,erased: bool=False)-> None :
      '''                             '''
    ...
    def addContext (self: DbObject,obj : PyDb.ObjectContext)-> None :
      '''                             '''
...
class CvDbView:
    def __init__ (self: CvDbView,id: ObjectId,mode: OpenMode=kForRead,erased: bool=False)-> None :
      '''                             '''
    ...
    def addContext (self: DbObject,obj : PyDb.ObjectContext)-> None :
      '''                             '''
